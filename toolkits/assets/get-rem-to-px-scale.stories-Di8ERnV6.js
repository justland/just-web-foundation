import{j as e,S as m,w as p,s as a,d as n}from"./iframe-BpXj-3b1.js";import{g as u}from"./get-rem-to-px-scale-CTgj4gd8.js";import{r as l}from"./rem-2-px-B1LC_HvB.js";import{d as i}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";const x=`const DEFAULT_REM_TO_PX_SCALE = 16
...
`,T={title:"units/getRemToPxScale",tags:["func","version:1.0"],parameters:n({description:{component:"Returns the current document's rem-to-px scale (the pixel value of 1rem) by reading the root element's computed font size. In non-browser environments returns 16."}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["use-case"],parameters:n({description:{story:"Read the current document rem-to-px scale (root font size)."}}),decorators:[p({content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("code",{children:"getRemToPxScale()"})," returns how many pixels 1rem equals in this document."]}),e.jsx("p",{children:"This is typically the value of the browser's default font size setting."})]})}),a({source:i`getRemToPxScale()`})],render(){const o=u();return e.jsx(m,{title:"Current rem-to-px scale",appearance:"output",children:e.jsxs("pre",{children:[o,"px per 1rem"]})})}},t={name:"With rem2px",tags:["use-case"],parameters:n({description:{story:"Use the scale as base for rem2px so conversions match the document."}}),decorators:[p(),a({source:i`
                const base = getRemToPxScale()
                rem2px(1, { base })
                rem2px(1.5, { base })
            `})],render(){const o=u(),d=[1,1.5,2,.5];return e.jsx(m,{appearance:"output",children:e.jsx("pre",{className:"text-sm",children:d.map(c=>`${c}rem → ${l(c,{base:o})}px`).join(`
