import{j as t,S as o,w as p,s as u,d as i}from"./iframe-BpXj-3b1.js";import{g as e}from"./get-css-unit-DteVD2Hc.js";import{d as c}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";import"./parse-css-value-DyiR79PK.js";const m=`import { parseCssValue } from './parse-css-value.ts'
...
`,{expect:n}=__STORYBOOK_MODULE_TEST__,S={title:"units/getCssUnit",tags:["func","version:3.1"],parameters:i({description:{component:"Extracts the unit from a CSS value string. Thin wrapper around parseCssValue(value)[1]."}}),render:()=>t.jsx(t.Fragment,{})},s={tags:["use-case"],parameters:i({description:{story:"Extract unit from CSS value strings."}}),decorators:[p(),u({source:c`
                getCssUnit('16px')   // 'px'
                getCssUnit('1rem')   // 'rem'
                getCssUnit('100%')   // '%'
                getCssUnit('0')      // undefined
                getCssUnit('2lh')    // 'lh'
            `})],render(){const l=[{input:"16px",expected:"px"},{input:"1rem",expected:"rem"},{input:"100%",expected:"%"},{input:"0",expected:void 0},{input:"2lh",expected:"lh"}];return t.jsx(o,{title:"Basic usage",appearance:"output",children:t.jsx("pre",{className:"text-sm",children:l.map(({input:d,expected:g})=>`getCssUnit('${d}') → ${e(d)??"undefined"} (expected: ${g??"undefined"})`).join(`
`)})})},play:async()=>{await n(e("16px")).toBe("px"),await n(e("1rem")).toBe("rem"),await n(e("100%")).toBe("%"),await n(e("0")).toBeUndefined(),await n(e("2lh")).toBe("lh")}},r={tags:["unit"],parameters:i({description:{story:"null and undefined are passed through as-is."}}),decorators:[p(),u({source:c`
                getCssUnit(null)      // null
                getCssUnit(undefined)  // undefined
            `})],render(){return t.jsx(o,{title:"Null/undefined pass-through",appearance:"output",children:t.jsx("pre",{className:"text-sm",children:`getCssUnit(null) → ${e(null)}
