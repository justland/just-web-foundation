import{j as r,S as o,w as c,s as u,d as a}from"./iframe-BpXj-3b1.js";import{r as s}from"./rem-2-px-B1LC_HvB.js";import{d as m}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";const S=`/**
...
`,{expect:i}=__STORYBOOK_MODULE_TEST__,B={title:"units/rem2px",tags:["func","version:3.1"],parameters:a({description:{component:'Converts rem values to pixel units. Accepts a number or string (e.g. "1rem" or "1") and optional base (default 16) and precision (default 4).'}}),render:()=>r.jsx(r.Fragment,{})},d={tags:["use-case"],parameters:a({description:{story:"Convert rem numbers to pixels using the default base (16px)."}}),decorators:[c({content:r.jsx(r.Fragment,{children:r.jsxs("p",{children:[r.jsx("code",{children:"rem2px(rem)"})," returns the pixel value. Default base is 16."]})})}),u({source:m`
                rem2px(1)    // 16
                rem2px(2)    // 32
                rem2px(0.5)  // 8
                rem2px(1.5)  // 24
            `})],render(){const t=[{input:1,expected:16},{input:2,expected:32},{input:.5,expected:8},{input:1.5,expected:24}];return r.jsx(o,{title:"Basic usage (default base: 16px)",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n})=>`rem2px(${e}) → ${s(e)}px (expected: ${n}px)`).join(`
`)})})},play:async()=>{const t=[{input:1,expected:16},{input:2,expected:32},{input:.5,expected:8},{input:1.5,expected:24}];for(const{input:e,expected:n}of t)await i(s(e)).toBe(n)}},x={tags:["use-case"],parameters:a({description:{story:'String inputs like "1rem" or "1.5" are parsed and converted.'}}),decorators:[c(),u({source:m`
                rem2px('1rem')     // 16
                rem2px('2rem')     // 32
                rem2px('1.5')      // 24
                rem2px('0.5313rem') // 8.5008
            `})],render(){const t=[{input:"1rem",expected:"16.0000"},{input:"2rem",expected:"32.0000"},{input:"1.5",expected:"24.0000"},{input:"0.5313rem",expected:"8.5008"}];return r.jsx(o,{title:"String input",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n})=>`rem2px('${e}') → ${s(e)}px (expected: ${n}px)`).join(`
`)})})},play:async()=>{const t=[{input:"1rem",expected:16},{input:"2rem",expected:32},{input:"1.5",expected:24},{input:"0.5313rem",expected:8.5008}];for(const{input:e,expected:n}of t)await i(s(e)).toBe(n)}},l={tags:["use-case"],parameters:a({description:{story:"Pass a custom base (pixels per 1rem) via options."}}),decorators:[c(),u({source:m`
                rem2px(1, { base: 20 })   // 20
                rem2px(2, { base: 20 })   // 40
                rem2px(0.5, { base: 20 }) // 10
                rem2px(1.5, { base: 20 }) // 30
            `})],render(){const t=[{input:1,base:20,expected:20},{input:2,base:20,expected:40},{input:.5,base:20,expected:10},{input:1.5,base:20,expected:30}];return r.jsx(o,{title:"Custom base (20px)",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,base:n,expected:p})=>`rem2px(${e}, { base: ${n} }) → ${s(e,{base:n})}px (expected: ${p}px)`).join(`
`)})})},play:async()=>{const t=[{input:1,base:20,expected:20},{input:2,base:20,expected:40},{input:.5,base:20,expected:10},{input:1.5,base:20,expected:30}];for(const{input:e,base:n,expected:p}of t)await i(s(e,{base:n})).toBe(p)}},b={tags:["use-case"],parameters:a({description:{story:"Control decimal places with the precision option."}}),decorators:[c(),u({source:m`
            ...
            `})],render(){const e=[0,1,2,3,4,6];return r.jsx(o,{title:"Custom precision (0.8125rem × 16px)",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:e.map(n=>`rem2px(${.8125}, { precision: ${n} }) → ${s(.8125,{precision:n})}px`).join(`
`)})})},play:async()=>{const e=[0,1,2,3,4,6],n=13;for(const p of e)await i(s(.8125,{precision:p})).toBe(n)}},f={tags:["use-case"],parameters:a({description:{story:"Combine custom base and precision."}}),decorators:[c(),u({source:m`
                rem2px(1, { base: 18, precision: 2 })
                rem2px(1.5, { base: 18, precision: 3 })
                rem2px('2rem', { base: 18, precision: 1 })
                rem2px(0.5, { base: 18, precision: 0 })
            `})],render(){const t=[{input:1,base:18,precision:2},{input:1.5,base:18,precision:3},{input:"2rem",base:18,precision:1},{input:.5,base:18,precision:0}];return r.jsx(o,{title:"Custom base and precision",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,base:n,precision:p})=>`rem2px(${typeof e=="string"?`'${e}'`:e}, { base: ${n}, precision: ${p} }) → ${s(e,{base:n,precision:p})}px`).join(`
`)})})},play:async()=>{const t=[{input:1,base:18,precision:2,expected:18},{input:1.5,base:18,precision:3,expected:27},{input:"2rem",base:18,precision:1,expected:36},{input:.5,base:18,precision:0,expected:9}];for(const{input:e,base:n,precision:p,expected:h}of t)await i(s(e,{base:n,precision:p})).toBe(h)}},y={tags:["unit"],parameters:a({description:{story:"null and undefined are passed through as-is."}}),decorators:[c()],render(){return r.jsx(o,{title:"Null/undefined pass-through",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:`rem2px(null) → ${s(null)}
rem2px(undefined) → ${s(void 0)}`})})},play:async()=>{await i(s(null)).toBe(null),await i(s(void 0)).toBe(void 0)}},g={tags:["source"],parameters:a({source:{code:S}}),decorators:[u()]};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
