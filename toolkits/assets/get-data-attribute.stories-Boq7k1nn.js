import{j as t,S as d,w as c,s as i,d as r}from"./iframe-BpXj-3b1.js";import{g as m}from"./get-data-attribute-Bl9c_7h4.js";import{d as l}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";import"./get-attribute-BI4biMNS.js";const f=`import type { DataAttribute } from './data-attribute.ts'
...
`,h={title:"attributes/getDataAttribute",tags:["func","version:1.0"],parameters:r({description:{component:"A utility function to get `data-*` attribute values from DOM element"}}),argTypes:{qualifiedName:{control:"text"},element:{control:!1}},args:{qualifiedName:"data-subject"},render:()=>t.jsx(t.Fragment,{})},n={parameters:r({description:{story:"By default, gets the value of a data attribute from document root"},source:{code:l`
                document.documentElement.setAttribute('data-theme', 'some value')
                console.log(getDataAttribute('data-theme'))
            `}}),loaders:[({args:{qualifiedName:e}})=>{document.documentElement.setAttribute(e,"some value")}],decorators:[c(),i()],render(e){const a=m(e.qualifiedName);return t.jsx(d,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(a,null,2)})})}},o={args:{qualifiedName:"data-custom"},parameters:r({description:{story:"Gets a data attribute value from a specific element"},source:{code:l`
                const element = document.createElement('div')
                element.setAttribute(qualifiedName, 'test-value')
                const value = getDataAttribute(qualifiedName, element)
            `}}),decorators:[c(),i()],render(e){const a=document.createElement("div");a.setAttribute(e.qualifiedName,"test-value");const p=m(e.qualifiedName,a);return t.jsx(d,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(p,null,2)})})}},s={tags:["unit"],args:{qualifiedName:"data-not-exist"},parameters:r({description:{story:"Returns null when trying to get a non-existent data attribute"},source:{code:l`
                console.log(getDataAttribute('data-not-exist'))
            `}}),decorators:[c(),i()],render(e){const a=m(e.qualifiedName);return t.jsx(d,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(a,null,2)})})}},u={tags:["source"],parameters:r({source:{code:f}}),decorators:[i()]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
