import{j as t,S as c,w as s,s as a,d as i}from"./iframe-BpXj-3b1.js";import{c as e}from"./convert-css-unit-CaWw9MZt.js";import{d as w}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";import"./get-rem-to-px-scale-CTgj4gd8.js";import"./parse-css-value-DyiR79PK.js";const C=`import type { Required } from 'type-plus'
...
`,{expect:n}=__STORYBOOK_MODULE_TEST__,N={title:"units/convertCssUnit",tags:["func","version:3.1"],parameters:i({description:{component:"Converts a CSS length value from one unit to another. Supports px, rem, em, vw, vh, vmin, vmax, lh, rlh, ch, %, and absolute units. Uses browser auto-detect for rootFontSize and viewport when options omitted."}}),render:()=>t.jsx(t.Fragment,{})},u={tags:["use-case"],parameters:i({description:{story:"Convert between common units. Auto-detects fromUnit from string."}}),decorators:[s(),a({source:w`
                convertCssUnit('16px', 'rem')     // 1
                convertCssUnit('1rem', 'px')      // 16
                convertCssUnit('96px', 'in')     // 1
                convertCssUnit('50%', 'px', { percentReference: 200 })  // 100
            `})],render(){const o=[{value:"16px",toUnit:"rem",opts:void 0,expected:1},{value:"1rem",toUnit:"px",opts:void 0,expected:16},{value:"96px",toUnit:"in",opts:void 0,expected:1},{value:"50%",toUnit:"px",opts:{percentReference:200},expected:100}];return t.jsx(c,{title:"Basic usage",appearance:"output",children:t.jsx("pre",{className:"text-sm",children:o.map(({value:r,toUnit:p,opts:x,expected:U})=>`convertCssUnit('${r}', '${p}'${x?`, { percentReference: ${x.percentReference} }`:""}) → ${e(r,p,x)} (expected: ${U})`).join(`
`)})})},play:async()=>{await n(e("16px","rem")).toBe(1),await n(e("1rem","px")).toBe(16),await n(e("96px","in")).toBe(1),await n(e("50%","px",{percentReference:200})).toBe(100)}},d={tags:["use-case"],parameters:i({description:{story:"Convert viewport units (vw, vh) with explicit viewport dimensions."}}),decorators:[s(),a({source:w`
                convertCssUnit('10vw', 'px', { viewportWidth: 375 })   // 37.5
                convertCssUnit('10vh', 'px', { viewportHeight: 812 }) // 81.2
            `})],render(){const o=e("10vw","px",{viewportWidth:375}),r=e("10vh","px",{viewportHeight:812});return t.jsx(c,{title:"Viewport units",appearance:"output",children:t.jsx("pre",{className:"text-sm",children:`convertCssUnit('10vw', 'px', { viewportWidth: 375 }) → ${o} (expected: 37.5)
convertCssUnit('10vh', 'px', { viewportHeight: 812 }) → ${r} (expected: 81.2)`})})},play:async()=>{await n(e("10vw","px",{viewportWidth:375})).toBe(37.5),await n(e("10vh","px",{viewportHeight:812})).toBe(81.2)}},m={tags:["use-case"],parameters:i({description:{story:"Direct rem↔em conversion (no px intermediate)."}}),decorators:[s(),a({source:w`
...
}`,...f.parameters?.docs?.source}}};const P=["BasicUsage","ViewportUnits","RemToEmDirect","NumberWithFromUnit","NullUndefinedPassThrough","ThrowsWhenContextMissing","Source"];export{u as BasicUsage,l as NullUndefinedPassThrough,v as NumberWithFromUnit,m as RemToEmDirect,f as Source,h as ThrowsWhenContextMissing,d as ViewportUnits,P as __namedExportsOrder,N as default};
