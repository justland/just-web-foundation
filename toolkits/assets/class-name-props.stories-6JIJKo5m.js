...
`,O={title:"class-name/ClassNameProps",tags:["type","version:1.0","!test"],render:()=>o.jsx(o.Fragment,{})},r={tags:["source"],parameters:a({source:{code:d}}),decorators:[t({content:o.jsxs("p",{children:[o.jsx("code",{children:"ClassNameProps"})," describes the standard type of the ",o.jsx("code",{children:"className"})," ","property."]})}),s()]},e={tags:["use-case","editor"],parameters:a({source:{code:m}}),decorators:[t({content:o.jsx("p",{children:"Use it by itself or combine with other props."})}),s()]};p(e,{availableImports:{"@just-web/toolkits":i,"@repobuddy/storybook":n,react:c},code:e.parameters?.docs?.source?.code});r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['source'],
...
}`,...e.parameters?.docs?.source}}};const T=["Specification","BasicUsage"];export{e as BasicUsage,r as Specification,T as __namedExportsOrder,O as default};
