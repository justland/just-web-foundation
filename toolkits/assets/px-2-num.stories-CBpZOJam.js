import{j as r,S as i,w as o,s as c,d as a}from"./iframe-BpXj-3b1.js";import{p}from"./parse-css-number-rqvDcBqs.js";import{d}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";import"./parse-css-value-DyiR79PK.js";const C=`/**
...
`,{expect:s}=__STORYBOOK_MODULE_TEST__,T={title:"units/px2num",tags:["func","version:3.1"],parameters:a({description:{component:'Converts pixel values to numbers. Accepts a number or string (e.g. "16px" or "16") and returns the numeric value.'}}),render:()=>r.jsx(r.Fragment,{})},l={tags:["use-case"],parameters:a({description:{story:"Convert numeric pixel values; number input is returned as-is."}}),decorators:[o({content:r.jsx(r.Fragment,{children:r.jsxs("p",{children:[r.jsx("code",{children:"px2num(px)"})," returns the numeric value. Number input is passed through."]})})}),c({source:d`
                px2num(16)  // 16
                px2num(32)  // 32
                px2num(8)   // 8
                px2num(24)  // 24
            `})],render(){const t=[{input:16,expected:16},{input:32,expected:32},{input:8,expected:8},{input:24,expected:24}];return r.jsx(i,{title:"Basic usage (number input)",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n})=>`px2num(${e}) → ${p(e)} (expected: ${n})`).join(`
`)})})},play:async()=>{const t=[{input:16,expected:16},{input:32,expected:32},{input:8,expected:8},{input:24,expected:24}];for(const{input:e,expected:n}of t)await s(p(e)).toBe(n)}},N={tags:["use-case"],parameters:a({description:{story:'String inputs like "16px" or "16" are parsed to numbers.'}}),decorators:[o(),c({source:d`
                px2num('16px')  // 16
                px2num('32px')  // 32
                px2num('24')    // 24
                px2num('8.5px') // 8.5
            `})],render(){const t=[{input:"16px",expected:16},{input:"32px",expected:32},{input:"24",expected:24},{input:"8.5px",expected:8.5}];return r.jsx(i,{title:"String input",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n})=>`px2num('${e}') → ${p(e)} (expected: ${n})`).join(`
`)})})},play:async()=>{const t=[{input:"16px",expected:16},{input:"32px",expected:32},{input:"24",expected:24},{input:"8.5px",expected:8.5}];for(const{input:e,expected:n}of t)await s(p(e)).toBe(n)}},g={tags:["use-case"],parameters:a({description:{story:"Decimal pixel values are parsed correctly."}}),decorators:[o(),c({source:d`
                px2num('12.5px')   // 12.5
                px2num('0.5px')    // 0.5
                px2num('1.75px')   // 1.75
                px2num('100.25px') // 100.25
            `})],render(){const t=[{input:"12.5px",expected:12.5},{input:"0.5px",expected:.5},{input:"1.75px",expected:1.75},{input:"100.25px",expected:100.25}];return r.jsx(i,{title:"Decimal values",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n})=>`px2num('${e}') → ${p(e)} (expected: ${n})`).join(`
`)})})},play:async()=>{const t=[{input:"12.5px",expected:12.5},{input:"0.5px",expected:.5},{input:"1.75px",expected:1.75},{input:"100.25px",expected:100.25}];for(const{input:e,expected:n}of t)await s(p(e)).toBe(n)}},f={tags:["unit"],parameters:a({description:{story:"Edge cases: zero, one, and large values."}}),decorators:[o(),c({source:d`
                px2num('0px')   // 0
                px2num(0)       // 0
                px2num('1px')   // 1
                px2num(1)       // 1
                px2num('1000px') // 1000
                px2num(1000)    // 1000
            `})],render(){const t=[{input:"0px",expected:0},{input:0,expected:0},{input:"1px",expected:1},{input:1,expected:1},{input:"1000px",expected:1e3},{input:1e3,expected:1e3}];return r.jsx(i,{title:"Edge cases",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n})=>typeof e=="string"?`px2num('${e}') → ${p(e)} (expected: ${n})`:`px2num(${e}) → ${p(e)} (expected: ${n})`).join(`
`)})})},play:async()=>{const t=[{input:"0px",expected:0},{input:0,expected:0},{input:"1px",expected:1},{input:1,expected:1},{input:"1000px",expected:1e3},{input:1e3,expected:1e3}];for(const{input:e,expected:n}of t)await s(p(e)).toBe(n)}},y={tags:["use-case"],parameters:a({description:{story:"Number and string inputs both produce the same numeric result."}}),decorators:[o(),c({source:d`
                px2num(16)      // 16  (number)
                px2num('16px')  // 16  (string with px)
                px2num('16')    // 16  (string without px)
                px2num(32.5)    // 32.5
                px2num('32.5px') // 32.5
            `})],render(){const t=[{input:16,description:"Number input",expected:16},{input:"16px",description:"String with px suffix",expected:16},{input:"16",description:"String without px suffix",expected:16},{input:32.5,description:"Decimal number",expected:32.5},{input:"32.5px",description:"Decimal string with px",expected:32.5}];return r.jsx(i,{title:"Same result from number or string",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,description:n})=>`px2num(${typeof e=="string"?`'${e}'`:e}) → ${p(e)} (${n})`).join(`
`)})})},play:async()=>{const t=[{input:16,expected:16},{input:"16px",expected:16},{input:"16",expected:16},{input:32.5,expected:32.5},{input:"32.5px",expected:32.5}];for(const{input:e,expected:n}of t)await s(p(e)).toBe(n)}},h={tags:["unit"],parameters:a({description:{story:"Validation and edge cases: empty string, non-numeric, double px, whitespace, case."}}),decorators:[o(),c({source:d`
                px2num('')        // NaN
                px2num('px')      // NaN
                px2num('16pxpx')  // 16
                px2num(' 16px ')  // 16
                px2num('16PX')    // 16
            `})],render(){const t=[{input:"",expected:Number.NaN,description:"Empty string"},{input:"px",expected:Number.NaN,description:"Only px suffix"},{input:"abc",expected:Number.NaN,description:"Non-numeric string"},{input:"16pxpx",expected:16,description:"Double px suffix"},{input:" 16px ",expected:16,description:"Whitespace around value"},{input:"16PX",expected:16,description:"Uppercase PX"}];return r.jsx(i,{title:"Validation & edge cases",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n,description:u})=>{const x=p(e),m=Number.isNaN(x)?"NaN":x,$=Number.isNaN(n)?"NaN":n;return`px2num('${e}') → ${m} (expected: ${$}, ${u})`}).join(`
`)})})},play:async()=>{await s(Number.isNaN(p(""))).toBe(!0),await s(Number.isNaN(p("px"))).toBe(!0),await s(Number.isNaN(p("abc"))).toBe(!0),await s(p("16pxpx")).toBe(16),await s(p(" 16px ")).toBe(16),await s(p("16PX")).toBe(16)}},b={name:"type validation",tags:["unit"],parameters:a({description:{story:"null and undefined are passed through as-is. Other invalid types (boolean, etc.) return NaN."}}),decorators:[o()],render(){const t=[{input:null,description:"null value (pass-through)"},{input:void 0,description:"undefined value (pass-through)"},{input:!0,description:"boolean true"},{input:!1,description:"boolean false"}];return r.jsx(i,{title:"Type validation",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,description:n})=>{const u=p(e),x=u===null?"null":u===void 0?"undefined":Number.isNaN(u)?"NaN":u;return`px2num(${e===null?"null":String(e)}) → ${x} (${n})`}).join(`
`)})})},play:async()=>{await s(p(null)).toBe(null),await s(p(void 0)).toBe(void 0),await s(Number.isNaN(p(!0))).toBe(!0),await s(Number.isNaN(p(!1))).toBe(!0)}},w={name:"performance test",tags:["unit","!test"],parameters:a({description:{story:"Rough throughput for number and string inputs."}}),decorators:[o()],render(){const t=[{count:1e3,input:"16px"},{count:1e3,input:16},{count:1e3,input:"123.456px"}];return r.jsx(i,{title:"Performance test",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({count:e,input:n})=>{const u=performance.now();for(let m=0;m<e;m++)p(n);const x=performance.now()-u;return`${e} × px2num(${typeof n=="string"?`'${n}'`:n}) → ${x.toFixed(2)}ms`}).join(`
