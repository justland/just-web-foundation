import{j as r,S as u,w as m,s as c,d as s}from"./iframe-BpXj-3b1.js";import{c as i}from"./create-css-unit-converter-B-7dzDjR.js";import{d}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";import"./convert-css-unit-CaWw9MZt.js";import"./get-rem-to-px-scale-CTgj4gd8.js";import"./parse-css-value-DyiR79PK.js";const x=`import { convertCssUnit } from './convert-css-unit.ts'
...
`,{expect:o}=__STORYBOOK_MODULE_TEST__,S={title:"units/createCssUnitConverter",tags:["func","version:3.1"],parameters:s({description:{component:"Creates a pre-configured CSS unit converter with fixed context. Configure once, then call with just value and toUnit."}}),render:()=>r.jsx(r.Fragment,{})},e={tags:["use-case"],parameters:s({description:{story:"Configure context once, convert multiple values without passing options."}}),decorators:[m(),c({source:d`
                ...
                convert('10vw', 'px')   // 37.5
                convert(16, 'rem', { fromUnit: 'px' })  // 1
            `})],render(){const n=i({rootFontSize:16,viewportWidth:375,viewportHeight:812}),a=n("1rem","px"),p=n("10vw","px"),v=n(16,"rem",{fromUnit:"px"});return r.jsx(u,{title:"Factory usage",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:`convert('1rem', 'px') → ${a}
convert('10vw', 'px') → ${p}
