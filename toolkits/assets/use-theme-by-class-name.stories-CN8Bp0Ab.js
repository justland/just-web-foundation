import{r as l,j as t,d as h,w as T,s as g,S as f}from"./iframe-C3RwOtVD.js";import{d as y}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as B}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as C}from"./theme-entry-D4S_RAMB.js";import{c as N}from"./class-name-theme-store-Czqv1IHK.js";import{B as c}from"./button-8KRCBWP5.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";import"./write-class-name-CewN__EB.js";import"./observe-attribute-CZKLLp6I.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-Dqe6gq4V.js";function k(e,s){const a=s?.element??(typeof document<"u"?document.documentElement:void 0),n=s?.defaultTheme,m=l.useMemo(()=>N(e,{element:a}),[a,e]),[x,w]=l.useState(()=>m.read()?.theme??n);l.useEffect(()=>a?E([m],n,w):void 0,[a,m,n]);const b=l.useCallback(S=>{a&&B([m],C(e,S))},[a,m,e]);return[x,b]}const j=`import { useCallback, useEffect, useMemo, useState } from 'react'
