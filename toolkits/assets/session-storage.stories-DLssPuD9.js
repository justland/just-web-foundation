import{j as t,d as n,w as i,s as c,r as _,S as A}from"./iframe-2hVe8Zfo.js";import{t as y}from"./theme-entry-D4S_RAMB.js";import{r as d,w as h}from"./write-session-storage-CmPsdO-d.js";import{d as m}from"./dedent-BuYMbVyj.js";import{B}from"./button-BgLyjgiD.js";import{T as l}from"./theme-result-card-CXos47Kq.js";import{T as H}from"./theme-store-demo-DV8KayFM.js";import"./preload-helper-PPVm8Dsz.js";import"./write-web-storage-H7mtIjJa.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-CN13v7LM.js";import"./append-id-Vsg144gU.js";const{expect:s,userEvent:C}=__STORYBOOK_MODULE_TEST__,$={title:"theme/session-storage",tags:["func","version:2.0"],parameters:n({description:{component:"Low-level functions for reading and writing theme via sessionStorage: readSessionStorage, writeSessionStorage. Persists per tab. No subscribe at function level."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},o="theme-ss-func-demo";function O(e){return{read:()=>d(r,e),write:u=>h(r,e,u),subscribe:void 0}}const S={tags:["playground"],parameters:n({description:{story:"Interactive demo: readSessionStorage, writeSessionStorage. No subscribe at function level."}}),decorators:[i(),c({source:m`
                const store = {
