import{j as e,S as n,w as d,s as a,d as s}from"./iframe-BpXj-3b1.js";import{g as l}from"./get-prefers-color-scheme-BMZwcwg-.js";import"./preload-helper-PPVm8Dsz.js";import"./get-media-feature-value-D3vhnjdc.js";const i=`import { getMediaFeatureValue } from '../_internal/media/get-media-feature-value.ts'
...
`,f={title:"color-scheme/getPrefersColorScheme",tags:["func","version:1.0"],parameters:s({description:{component:'A utility function that returns the current preferred color scheme. It can only be "light" or "dark". Note: even when the browser theme is set to "System" (e.g. in Chrome settings), the browser still resolves this to either "light" or "dark" based on the OS preference—it never returns "system" or "no-preference".'}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["use-case"],parameters:s({source:{code:'getPrefersColorScheme(): "light" | "dark"'}}),decorators:[d({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersColorScheme()"})," reads the current ",e.jsx("code",{children:"prefers-color-scheme"})," ","value."]}),e.jsxs("p",{children:["Accepts optional ",e.jsx("code",{children:"defaultColorScheme"})," (default ",e.jsx("code",{children:"'light'"}),") returned when ",e.jsx("code",{children:"matchMedia"})," is unavailable (e.g. SSR)."]}),e.jsxs("p",{children:["Use this when you need a one-off read of the user's color scheme (e.g. for initial render or non-reactive logic). For reactive updates when the preference changes, use"," ",e.jsx("code",{children:"observePrefersColorScheme"})," instead."]})]})}),a()],render:()=>{const c=l();return e.jsxs(n,{title:"Current Color Scheme Preference (prefers-color-scheme)",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:c})," mode"]})}},o={name:"defaultColorScheme",tags:["props"],parameters:s({source:{code:"getPrefersColorScheme('dark'): 'light' | 'dark'"}}),decorators:[d({content:e.jsx("div",{className:"space-y-2",children:e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersColorScheme('dark')"})," returns ",e.jsx("code",{children:"'dark'"})," when"," ",e.jsx("code",{children:"matchMedia"})," is unavailable (SSR, test env). In the browser, it returns the real system preference."]})})}),a()],render:()=>{const c=l("dark");return e.jsxs(n,{title:"With defaultColorScheme: 'dark'",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:c})," mode"]})}},t={tags:["source"],parameters:s({source:{code:i}}),decorators:[a()]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...t.parameters?.docs?.source}}};const S=["BasicUsage","WithDefaultColorScheme","Source"];export{r as BasicUsage,t as Source,o as WithDefaultColorScheme,S as __namedExportsOrder,f as default};
