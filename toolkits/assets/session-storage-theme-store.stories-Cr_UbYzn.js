import{j as t,d as l,w as h,s as m,S as D,r as u}from"./iframe-2hVe8Zfo.js";import{t as i}from"./theme-entry-D4S_RAMB.js";import{d as L}from"./dummy-theme-store-DcCfgetv.js";import{r as J,w as z}from"./write-session-storage-CmPsdO-d.js";import{d as g}from"./dedent-BuYMbVyj.js";import{B as p}from"./button-BgLyjgiD.js";import{T as y}from"./theme-result-card-CXos47Kq.js";import{T as U}from"./theme-store-demo-DV8KayFM.js";import"./preload-helper-PPVm8Dsz.js";import"./write-web-storage-H7mtIjJa.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-CN13v7LM.js";import"./append-id-Vsg144gU.js";function d(e,s){const{storageKey:n,parse:a,stringify:S,onError:Y}=s;if(!window?.sessionStorage)return L;const T=new Set;let x=G()?.theme??void 0;function G(){return J(e,n,{parse:a})}function W(){const v=G(),f=v?.theme??void 0;if(f!==x){x=f;for(const E of T)E(v)}}return{read:G,write(v){z(e,n,v,{stringify:S,onError:Y}),W()},subscribe(v){T.add(v);const f=E=>{E.key===n&&E.storageArea===window.sessionStorage&&W()};return window.addEventListener("storage",f),()=>{T.delete(v),window.removeEventListener("storage",f)}}}}const V=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
