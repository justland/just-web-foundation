import{j as a,d as i,w as m,s as f,S as x}from"./iframe-C3RwOtVD.js";import{d as h}from"./dedent-BuYMbVyj.js";import{p as t}from"./parse-css-value-DyiR79PK.js";import"./preload-helper-PPVm8Dsz.js";const v=`/**
...
parseCssValue(undefined) → [${e[0]}, ${e[1]===void 0?"undefined":`'${e[1]}'`}]`})})},play:async()=>{await u(t(null)).toEqual([null,void 0]),await u(t(void 0)).toEqual([void 0,void 0])}},l={tags:["unit"],parameters:i({description:{story:"Invalid input returns [NaN, undefined]."}}),decorators:[m()],render(){const n=["","abc","px"];return a.jsx(x,{title:"Invalid input",appearance:"output",children:a.jsx("pre",{className:"text-sm",children:n.map(e=>{const s=t(e);return`parseCssValue(${e===""?"''":`'${e}'`}) → [${Number.isNaN(s[0])?"NaN":s[0]}, undefined]`}).join(`
