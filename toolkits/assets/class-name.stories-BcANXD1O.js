import{j as t,d as u,w as n,s as o,r as i,S as h}from"./iframe-Bip_vWCg.js";import{r as y,w as m,a as k,p as F,s as V}from"./write-class-name-CewN__EB.js";import{t as r}from"./theme-entry-D4S_RAMB.js";import{d as l}from"./dedent-BuYMbVyj.js";import{B as C}from"./button-GttIahLA.js";import{T as p}from"./theme-result-card-BT21yHS8.js";import{T as $}from"./theme-store-demo-CaeEsZeY.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-CZKLLp6I.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-BKmfambj.js";import"./append-id-Vsg144gU.js";const{expect:a,userEvent:D,waitFor:A}=__STORYBOOK_MODULE_TEST__,re={title:"theme/class-name",tags:["func","version:2.0"],parameters:u({description:{component:"Low-level functions for reading and writing theme via element class names: readClassName, writeClassName, subscribeClassName, parseClassName, stringifyClassName."}}),render:()=>t.jsx(t.Fragment,{})},s={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"};function K(e=document.documentElement){return{read:()=>y(s,{element:e}),write:d=>m(s,d,{element:e}),subscribe:d=>k(s,d,{element:e})}}const x={tags:["playground"],parameters:u({description:{story:"Interactive demo: readClassName, writeClassName, subscribeClassName used together."}}),decorators:[n(),o({source:l`
                const store = {
