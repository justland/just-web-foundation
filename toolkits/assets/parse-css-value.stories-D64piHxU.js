import{j as a,S as m,w as x,s as f,d as i}from"./iframe-BpXj-3b1.js";import{p as t}from"./parse-css-value-DyiR79PK.js";import{d as h}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";const v=`/**
...
`,{expect:u}=__STORYBOOK_MODULE_TEST__,g={title:"units/parseCssValue",tags:["func","version:3.1"],parameters:i({description:{component:"Parses a CSS value in one pass and returns both the numeric part and the unit as [number, unit | undefined]."}}),render:()=>a.jsx(a.Fragment,{})},p={tags:["use-case"],parameters:i({description:{story:"Parse CSS values with various units; returns [number, unit] tuple."}}),decorators:[x(),f({source:h`
                parseCssValue('16px')   // [16, 'px']
                parseCssValue('1.5rem') // [1.5, 'rem']
                parseCssValue('100%')   // [100, '%']
                parseCssValue('0')      // [0, undefined]
                parseCssValue(16)       // [16, undefined]
            `})],render(){const n=[{input:"16px",expected:[16,"px"]},{input:"1.5rem",expected:[1.5,"rem"]},{input:"100%",expected:[100,"%"]},{input:"0",expected:[0,void 0]},{input:16,expected:[16,void 0]}];return a.jsx(m,{title:"Basic usage",appearance:"output",children:a.jsx("pre",{className:"text-sm",children:n.map(({input:e,expected:s})=>{const r=t(e),C=typeof s[1]=="string"?`[${s[0]}, '${s[1]}']`:`[${s[0]}, undefined]`;return`parseCssValue(${typeof e=="string"?`'${e}'`:e}) → [${r[0]}, ${r[1]===void 0?"undefined":`'${r[1]}'`}] (expected: ${C})`}).join(`
`)})})},play:async()=>{const n=[{input:"16px",expected:[16,"px"]},{input:"1.5rem",expected:[1.5,"rem"]},{input:"100%",expected:[100,"%"]},{input:"0",expected:[0,void 0]},{input:16,expected:[16,void 0]}];for(const{input:e,expected:s}of n){const r=t(e);await u(r[0]).toBe(s[0]),await u(r[1]).toBe(s[1])}}},d={tags:["use-case"],parameters:i({description:{story:"Supports px, rem, em, %, lh, ch, vw, vh, and other CSS units."}}),decorators:[x()],render(){const n=["0px","0rem","0em","0%","0lh","0ch","0vw","0vh","1em","2lh","50vw"];return a.jsx(m,{title:"Various units",appearance:"output",children:a.jsx("pre",{className:"text-sm",children:n.map(e=>{const[s,r]=t(e);return`parseCssValue('${e}') → [${s}, ${r===void 0?"undefined":`'${r}'`}]`}).join(`
`)})})},play:async()=>{await u(t("0px")).toEqual([0,"px"]),await u(t("0rem")).toEqual([0,"rem"]),await u(t("50vw")).toEqual([50,"vw"])}},o={tags:["unit"],parameters:i({description:{story:"null and undefined are passed through as-is in the first tuple element."}}),decorators:[x()],render(){const n=t(null),e=t(void 0);return a.jsx(m,{title:"Null/undefined pass-through",appearance:"output",children:a.jsx("pre",{className:"text-sm",children:`parseCssValue(null) → [${n[0]}, ${n[1]===void 0?"undefined":`'${n[1]}'`}]
parseCssValue(undefined) → [${e[0]}, ${e[1]===void 0?"undefined":`'${e[1]}'`}]`})})},play:async()=>{await u(t(null)).toEqual([null,void 0]),await u(t(void 0)).toEqual([void 0,void 0])}},l={tags:["unit"],parameters:i({description:{story:"Invalid input returns [NaN, undefined]."}}),decorators:[x()],render(){const n=["","abc","px"];return a.jsx(m,{title:"Invalid input",appearance:"output",children:a.jsx("pre",{className:"text-sm",children:n.map(e=>{const s=t(e);return`parseCssValue(${e===""?"''":`'${e}'`}) → [${Number.isNaN(s[0])?"NaN":s[0]}, undefined]`}).join(`
`)})})},play:async()=>{const n=t("abc");await u(Number.isNaN(n[0])).toBe(!0),await u(n[1]).toBeUndefined()}},c={tags:["source"],parameters:i({source:{code:v}}),decorators:[f()]};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...c.parameters?.docs?.source}}};const w=["BasicUsage","VariousUnits","NullUndefinedPassThrough","InvalidInput","Source"];export{p as BasicUsage,l as InvalidInput,o as NullUndefinedPassThrough,c as Source,d as VariousUnits,w as __namedExportsOrder,g as default};
