import{j as t,w as m,s as d,d as u,S as A,r as g}from"./iframe-BpXj-3b1.js";import{t as i}from"./theme-entry-D4S_RAMB.js";import{l}from"./local-storage-theme-store-CQ0vNisZ.js";import{d as h}from"./dedent-D4JfOF0A.js";import{B as p}from"./button-CGZNSIHq.js";import{T as y}from"./theme-result-card-DQkyr6Gh.js";import{T as L}from"./theme-store-demo-Dl8Ng1NL.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";import"./write-local-storage-CE6rqo_l.js";import"./write-web-storage-H7mtIjJa.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-CqQ4XPfR.js";import"./append-id-Vsg144gU.js";const J=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
...
`,{expect:a,userEvent:v,waitFor:T}=__STORYBOOK_MODULE_TEST__,ce={title:"theme/theme-store/localStorageThemeStore",tags:["func","version:2.0"],parameters:u({description:{component:"Theme store backed by localStorage. Persists across sessions; cross-tab sync via StorageEvent. Bakes themes at creation."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},c="theme-ls-demo",S={tags:["playground"],parameters:u({description:{story:"Interactive demo: Read theme, write themes via buttons, and observe subscribe updates."}}),decorators:[m(),d({source:h`
            ...
            `})],loaders:[()=>{window.localStorage.removeItem(w);const e=l(r,{storageKey:w});return e.write(i(r,"current")),{store:e}}],render:(e,{loaded:{store:s}})=>{const n=s.read();return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(y,{title:"store.read() result","data-testid":"store-read-result",result:n??{theme:"current",value:r.current}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},_={current:"theme-current",grayscale:["theme-grayscale","app:bg-gray-100"],"high-contrast":"theme-high-contrast"},K={name:"themes: array values",tags:["props"],parameters:u({description:{story:"themes values can be string[]. Stored and retrieved value is the full array."}}),decorators:[m({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"string[]"}),". ",t.jsx("code",{children:"ThemeResult.value"})," persists the full array."]})}),d({source:h`
                ...
                const store = localStorageThemeStore(themes, { storageKey: 'theme' })
            `})],loaders:[()=>{window.localStorage.removeItem(w);const e=l(_,{storageKey:w});return e.write(i(_,"grayscale")),{store:e}}],render:(e,{loaded:{store:s}})=>{const n=s.read();return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(y,{title:"store.read() result","data-testid":"store-read-result",result:n??{theme:"grayscale",value:_.grayscale}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: [theme-grayscale, app:bg-gray-100]")}},G={light:"theme-light",dark:{themeValue:"theme-dark",contrast:"high"}},C={name:"themes: object value",tags:["props"],parameters:u({description:{story:"themes values can be { themeValue: string | string[] }. Extra props (e.g. contrast) are preserved when read from storage."}}),decorators:[m({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"{ themeValue, ...extra }"}),". Stored and retrieved value preserves extra props for user metadata."]})}),d({source:h`
                const themes = {
                    light: 'theme-light',
