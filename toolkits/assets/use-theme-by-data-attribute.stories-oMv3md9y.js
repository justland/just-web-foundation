import{r as h,j as t,S as T,w as b,s as g,d}from"./iframe-BpXj-3b1.js";import{o as B}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as N}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as C}from"./theme-entry-D4S_RAMB.js";import{d as D}from"./data-attribute-theme-store-Buf9c4Ks.js";import{d as f}from"./dedent-D4JfOF0A.js";import{B as i}from"./button-CGZNSIHq.js";import"./preload-helper-PPVm8Dsz.js";import"./write-data-attribute-C1LlvwO1.js";import"./get-data-attribute-Bl9c_7h4.js";import"./get-attribute-BI4biMNS.js";import"./observe-data-attribute-ioQK7DCF.js";import"./observe-attribute-CZKLLp6I.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-CqQ4XPfR.js";function y(e,a){const n=a.element??(typeof document<"u"?document.documentElement:void 0),r=a.defaultTheme,v=a.attributeName,m=h.useMemo(()=>D(e,{attributeName:v,element:n}),[n,e,v]),[x,w]=h.useState(()=>m.read()?.theme??r);h.useEffect(()=>n?B([m],r,w):void 0,[n,m,r]);const E=h.useCallback(S=>{n&&N([m],C(e,S))},[n,m,e]);return[x,E]}const A=`import { useCallback, useEffect, useMemo, useState } from 'react'
...
`,{expect:s,userEvent:o}=__STORYBOOK_MODULE_TEST__,k={light:"theme-light",dark:"theme-dark"},z={title:"react/hooks/useThemeByDataAttribute",tags:["func","version:1.0"],parameters:d({description:{component:"React hook that returns the current theme (from element data attribute) and a setter. Subscribes to data attribute changes on the element so the returned theme stays in sync."}}),render:()=>t.jsx(t.Fragment,{})},u={parameters:d({description:{story:"Observe and set theme by data attribute on document.documentElement. The hook reads the matching theme from the attribute and setTheme updates the element attribute."},source:{code:f`
            ...
            `}}),decorators:[b(),g()],render:()=>{const[e]=y(k,{attributeName:"data-theme",defaultTheme:"light"}),a=()=>{const n=document.documentElement;n.getAttribute("data-theme")==="theme-dark"?n.setAttribute("data-theme","theme-light"):n.setAttribute("data-theme","theme-dark")};return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsx(i,{onPress:a,children:"Toggle theme via setAttribute (external)"}),t.jsxs(T,{appearance:"output",children:[t.jsx("p",{className:"mb-2",children:"Hook value (updates when attribute changes elsewhere):"}),t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})]})]})},play:async({canvas:e})=>{const a=e.getByRole("button",{name:/Toggle theme via setAttribute/});await o.click(a),await s(e.getByTestId("current-theme")).toHaveTextContent("dark"),await o.click(a),await s(e.getByTestId("current-theme")).toHaveTextContent("light")}},p={tags:["source"],parameters:d({source:{code:A}}),decorators:[g()]};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
