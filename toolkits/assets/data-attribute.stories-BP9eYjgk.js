import{j as t,S as g,w as i,s as d,r as v,d as l}from"./iframe-BpXj-3b1.js";import{t as m}from"./theme-entry-D4S_RAMB.js";import{r as h,w as p,p as k,s as W,a as O}from"./write-data-attribute-C1LlvwO1.js";import{d as c}from"./dedent-D4JfOF0A.js";import{B as F}from"./button-CGZNSIHq.js";import{T as y}from"./theme-result-card-DQkyr6Gh.js";import{T as V}from"./theme-store-demo-Dl8Ng1NL.js";import"./preload-helper-PPVm8Dsz.js";import"./get-data-attribute-Bl9c_7h4.js";import"./get-attribute-BI4biMNS.js";import"./observe-data-attribute-ioQK7DCF.js";import"./observe-attribute-CZKLLp6I.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-CqQ4XPfR.js";import"./append-id-Vsg144gU.js";const{expect:n,userEvent:L,waitFor:M}=__STORYBOOK_MODULE_TEST__,ue={title:"theme/data-attribute",tags:["func","version:2.0"],parameters:l({description:{component:"Low-level functions for reading and writing theme via data attributes: readDataAttribute, writeDataAttribute, subscribeDataAttribute, parseDataAttribute, stringifyDataAttribute."}}),render:()=>t.jsx(t.Fragment,{})},a={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},r="data-theme";function K(e=document.documentElement,o=r){return{read:()=>h(a,o,{element:e}),write:s=>p(a,o,s,{element:e}),subscribe:s=>O(a,o,s,{element:e})}}const f={tags:["playground"],parameters:l({description:{story:"Interactive demo: readDataAttribute, writeDataAttribute, subscribeDataAttribute used together."}}),decorators:[i(),d({source:c`
                const store = {
