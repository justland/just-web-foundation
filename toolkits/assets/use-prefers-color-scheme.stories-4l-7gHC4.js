import{r as d,j as e,S as m,w as l,s as a,d as c}from"./iframe-BpXj-3b1.js";import{g as h}from"./get-prefers-color-scheme-BMZwcwg-.js";import{o as f}from"./observe-prefers-color-scheme-Cpw9ndla.js";import{d as i}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";import"./get-media-feature-value-D3vhnjdc.js";import"./observe-media-feature-value--S6jnvF8.js";function u(r="light"){const[p,n]=d.useState(()=>h(r));return d.useEffect(()=>(n(h()),f(n)),[]),p}const S=`import { useEffect, useState } from 'react'
...
`,w={title:"react/hooks/usePrefersColorScheme",tags:["func","version:1.0"],parameters:c({description:{component:"React hook that returns the current system color scheme preference and re-renders when it changes."}}),render:()=>e.jsx(e.Fragment,{})},s={parameters:c({source:{code:i`
                const scheme = usePrefersColorScheme()
                return <span>System prefers: \${scheme}</span>
            `}}),decorators:[l({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"usePrefersColorScheme()"})," returns the current prefers-color-scheme value."]}),e.jsx("p",{children:"Re-renders when the user changes their OS or browser light/dark setting. Change your system theme to verify."}),e.jsxs("p",{children:["Accepts optional ",e.jsx("code",{children:"defaultColorScheme"})," (default ",e.jsx("code",{children:"'light'"}),") used when ",e.jsx("code",{children:"matchMedia"})," is unavailable (e.g. SSR). On the client, reads the real value immediately to avoid flicker."]})]})}),a()],render:()=>{const r=u();return e.jsx(m,{title:"Current Color Scheme Preference (prefers-color-scheme)",appearance:"output",children:e.jsx("pre",{"data-testid":"current-scheme",className:"font-mono",children:r})})}},o={name:"defaultColorScheme",tags:["props"],parameters:c({source:{code:i`
                const scheme = usePrefersColorScheme('dark')
                return <span>System prefers: \${scheme}</span>
            `}}),decorators:[l({content:e.jsx("div",{className:"space-y-2",children:e.jsxs("p",{children:[e.jsx("code",{children:"usePrefersColorScheme('dark')"})," uses ",e.jsx("code",{children:"'dark'"})," when"," ",e.jsx("code",{children:"matchMedia"})," is unavailable (SSR). When your app defaults to dark theme, pass"," ",e.jsx("code",{children:"'dark'"})," so the initial render matches and avoids a flash of light."]})})}),a()],render:()=>{const r=u("dark");return e.jsx(m,{title:"With defaultColorScheme: 'dark'",appearance:"output",children:e.jsx("pre",{"data-testid":"current-scheme",className:"font-mono",children:r})})}},t={tags:["source"],parameters:c({source:{code:S}}),decorators:[a()]};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
}`,...t.parameters?.docs?.source}}};const j=["BasicUsage","WithDefaultColorScheme","Source"];export{s as BasicUsage,t as Source,o as WithDefaultColorScheme,j as __namedExportsOrder,w as default};
