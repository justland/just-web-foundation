import{r as h,j as t,S as g,w as f,s as b,d as l}from"./iframe-BpXj-3b1.js";import{o as w}from"./observe-attribute-CZKLLp6I.js";import{d as y}from"./dedent-D4JfOF0A.js";import{B as n}from"./button-CGZNSIHq.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-class-name-CqQ4XPfR.js";function x(e,a=typeof document<"u"?document.documentElement:void 0){const[o,u]=h.useState(()=>a?.getAttribute(e)??void 0);h.useEffect(()=>{if(a)return u(a.getAttribute(e)??void 0),w({[e]:i=>{u(i??void 0)}},a)},[a,e]);const T=h.useCallback(i=>{a&&(i==null?a.removeAttribute(e):a.setAttribute(e,i))},[a,e]);return[o,T]}const E=`import { useCallback, useEffect, useState } from 'react'
...
`,{expect:s,userEvent:r}=__STORYBOOK_MODULE_TEST__,N={title:"react/hooks/useAttribute",tags:["func","version:2.1"],parameters:l({description:{component:"React hook that returns the current value of an attribute on a target element and a setter to update it. Stays in sync when the attribute changes elsewhere."}}),render:()=>t.jsx(t.Fragment,{})},c="data-theme",d={parameters:l({description:{story:"Observe and set an attribute on document.documentElement. Pass null to setValue to remove the attribute."},source:{code:y`
            ...
            `}}),decorators:[f(),b()],render:()=>{const[e]=x(c),a=()=>{const o=document.documentElement.getAttribute(c)==="synced"?null:"synced";o===null?document.documentElement.removeAttribute(c):document.documentElement.setAttribute(c,o)};return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsx(n,{onPress:a,children:"Toggle via setAttribute (external)"}),t.jsxs(g,{appearance:"output",children:[t.jsx("p",{className:"mb-2",children:"Hook value (updates when attribute changes elsewhere):"}),t.jsx("pre",{"data-testid":"current-value",className:"font-mono",children:e??"(not set)"})]})]})},play:async({canvas:e})=>{const a=e.getByRole("button",{name:/Toggle via setAttribute/});await r.click(a),await s(e.getByTestId("current-value")).toHaveTextContent("synced"),await r.click(a),await s(e.getByTestId("current-value")).toHaveTextContent("(not set)")}},p={tags:["source"],parameters:l({source:{code:E}}),decorators:[b()]};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
}`,...p.parameters?.docs?.source}}};const j=["BasicUsage","CustomElement","SyncFromElsewhere","Source"];export{d as BasicUsage,m as CustomElement,p as Source,v as SyncFromElsewhere,j as __namedExportsOrder,N as default};
