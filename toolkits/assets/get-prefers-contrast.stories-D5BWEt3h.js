import{j as e,S as c,w as d,s as n,d as a}from"./iframe-BpXj-3b1.js";import{g as i}from"./get-prefers-contrast-DyhaFsxO.js";import"./preload-helper-PPVm8Dsz.js";import"./get-media-feature-value-D3vhnjdc.js";const u=`import { getMediaFeatureValue } from '../_internal/media/get-media-feature-value.ts'
...
`,h={title:"contrast/getPrefersContrast",tags:["func","version:3.5"],parameters:a({description:{component:'A utility function that returns the current preferred contrast. It can be "no-preference", "less", "more" or "custom". Unlike `getPrefersColorScheme`, `no-preference` is a real state and is returned as such, not collapsed into a default.'}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["use-case"],parameters:a({source:{code:'getPrefersContrast(): "no-preference" | "less" | "more" | "custom"'}}),decorators:[d({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersContrast()"})," reads the current ",e.jsx("code",{children:"prefers-contrast"})," value."]}),e.jsxs("p",{children:["Accepts optional ",e.jsx("code",{children:"defaultContrast"})," (default ",e.jsx("code",{children:"'no-preference'"}),") returned when ",e.jsx("code",{children:"matchMedia"})," is unavailable (e.g. SSR)."]}),e.jsxs("p",{children:["Use this when you need a one-off read of the user's contrast preference (e.g. for initial render or non-reactive logic). For reactive updates when the preference changes, use ",e.jsx("code",{children:"observePrefersContrast"})," instead."]})]})}),n()],render:()=>{const o=i();return e.jsxs(c,{title:"Current Contrast Preference (prefers-contrast)",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:o})]})}},t={name:"defaultContrast",tags:["props"],parameters:a({source:{code:"getPrefersContrast('more'): 'no-preference' | 'less' | 'more' | 'custom'"}}),decorators:[d({content:e.jsx("div",{className:"space-y-2",children:e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersContrast('more')"})," returns ",e.jsx("code",{children:"'more'"})," when"," ",e.jsx("code",{children:"matchMedia"})," is unavailable (SSR, test env). In the browser, it returns the real system preference."]})})}),n()],render:()=>{const o=i("more");return e.jsxs(c,{title:"With defaultContrast: 'more'",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:o})]})}},s={tags:["source"],parameters:a({source:{code:u}}),decorators:[n()]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
