import{j as r,d as l,w,s as h,r as x}from"./iframe-7ZNQ_6ea.js";import{t as u}from"./theme-entry-D4S_RAMB.js";import{r as n,w as S}from"./write-web-storage-H7mtIjJa.js";import{d as y}from"./dedent-BuYMbVyj.js";import{B as E}from"./button-CHwHYE9P.js";import{T as d}from"./theme-result-card-CFNpKtMB.js";import"./preload-helper-PPVm8Dsz.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-2frVWK5S.js";import"./append-id-Vsg144gU.js";const{expect:o,userEvent:W}=__STORYBOOK_MODULE_TEST__,G={title:"theme/web-storage",tags:["func","version:2.0"],parameters:l({description:{component:"Generic low-level functions for reading and writing theme via any Storage (localStorage or sessionStorage): readWebStorage, writeWebStorage. Requires options.storage."}}),render:()=>r.jsx(r.Fragment,{})},t={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},a="theme-ws-func-demo",v="theme-ws-func-local",T="theme-ws-func-session",i={name:"readWebStorage",tags:["props"],parameters:l({description:{story:"readWebStorage(themes, storageKey, { storage }) reads the current theme from the given Storage."}}),decorators:[w(),h({source:y`
