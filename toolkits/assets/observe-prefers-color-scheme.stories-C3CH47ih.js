import{j as e,d as o,w as l,s as t,r as c,S as h}from"./iframe-BF2V-t9M.js";import{g as m}from"./get-prefers-color-scheme-BMZwcwg-.js";import{o as d}from"./observe-prefers-color-scheme-Cpw9ndla.js";import"./preload-helper-PPVm8Dsz.js";import"./get-media-feature-value-D3vhnjdc.js";import"./observe-media-feature-value--S6jnvF8.js";const u=`import { observeMediaFeatureValue } from '../_internal/media/observe-media-feature-value.ts'
...
`,b={title:"color-scheme/observePrefersColorScheme",tags:["func","version:1.0"],parameters:o({description:{component:'A utility function that observes system color scheme preferences and triggers callbacks when changes occur. Even when the browser theme is set to "System" (e.g. in Chrome), it still reports either "light" or "dark" based on the OS—never "system" or "no-preference".'}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["use-case"],parameters:o({description:{story:"Observe `prefers-color-scheme` changes."},source:{code:"observePrefersColorScheme((value) => { ... }): () => void"}}),decorators:[l({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"observePrefersColorScheme(callback)"})," subscribes to"," ",e.jsx("code",{children:"prefers-color-scheme"})," changes and runs your callback when the preference changes."]}),e.jsxs("p",{children:["Use this when you need reactive updates (e.g. UI that follows the system theme). For a one-off read, use ",e.jsx("code",{children:"getPrefersColorScheme"})," instead."]}),e.jsx("p",{children:"You should call the returned cleanup function to stop observing when you no longer need it."})]})}),t()],render:()=>{const[n,a]=c.useState(m());return c.useEffect(()=>d(a),[]),e.jsxs(h,{title:"Current Color Scheme Preference (prefers-color-scheme)",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:n})," mode"]})}},s={tags:["source"],parameters:o({source:{code:u}}),decorators:[t()]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
