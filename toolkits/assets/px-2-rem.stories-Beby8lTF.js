import{j as r,S as o,w as c,s as u,d as a}from"./iframe-BpXj-3b1.js";import{p}from"./px-2-rem-CPoMxM9B.js";import{d}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";const S=`/**
...
`,{expect:i}=__STORYBOOK_MODULE_TEST__,B={title:"units/px2rem",tags:["func","version:3.1"],parameters:a({description:{component:'Converts pixel values to rem units. Accepts a number or string (e.g. "16px" or "16") and optional base (default 16) and precision (default 4).'}}),render:()=>r.jsx(r.Fragment,{})},x={tags:["use-case"],parameters:a({description:{story:"Convert pixel numbers to rem using the default base (16px)."}}),decorators:[c({content:r.jsx(r.Fragment,{children:r.jsxs("p",{children:[r.jsx("code",{children:"px2rem(px)"})," returns the rem value. Default base is 16."]})})}),u({source:d`
                px2rem(16)  // 1
                px2rem(32)  // 2
                px2rem(8)   // 0.5
                px2rem(24)  // 1.5
            `})],render(){const t=[{input:16,expected:1},{input:32,expected:2},{input:8,expected:.5},{input:24,expected:1.5}];return r.jsx(o,{title:"Basic usage (default base: 16px)",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n})=>`px2rem(${e}) → ${p(e)}rem (expected: ${n}rem)`).join(`
`)})})},play:async()=>{const t=[{input:16,expected:1},{input:32,expected:2},{input:8,expected:.5},{input:24,expected:1.5}];for(const{input:e,expected:n}of t)await i(p(e)).toBe(n)}},m={tags:["use-case"],parameters:a({description:{story:'String inputs like "16px" or "16" are parsed and converted.'}}),decorators:[c(),u({source:d`
                px2rem('16px')  // 1
                px2rem('32px')  // 2
                px2rem('24')    // 1.5
                px2rem('8.5px') // 0.5313
            `})],render(){const t=[{input:"16px",expected:1},{input:"32px",expected:2},{input:"24",expected:1.5},{input:"8.5px",expected:.5313}];return r.jsx(o,{title:"String input",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,expected:n})=>`px2rem('${e}') → ${p(e)}rem (expected: ${n}rem)`).join(`
`)})})},play:async()=>{const t=[{input:"16px",expected:1},{input:"32px",expected:2},{input:"24",expected:1.5},{input:"8.5px",expected:.5313}];for(const{input:e,expected:n}of t)await i(p(e)).toBe(n)}},l={tags:["use-case"],parameters:a({description:{story:"Pass a custom base (pixels per 1rem) via options."}}),decorators:[c(),u({source:d`
                px2rem(20, { base: 20 })  // 1
                px2rem(40, { base: 20 })  // 2
                px2rem(10, { base: 20 })  // 0.5
                px2rem(30, { base: 20 })  // 1.5
            `})],render(){const t=[{input:20,base:20,expected:1},{input:40,base:20,expected:2},{input:10,base:20,expected:.5},{input:30,base:20,expected:1.5}];return r.jsx(o,{title:"Custom base (20px)",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:t.map(({input:e,base:n,expected:s})=>`px2rem(${e}, { base: ${n} }) → ${p(e,{base:n})}rem (expected: ${s}rem)`).join(`
`)})})},play:async()=>{const t=[{input:20,base:20,expected:1},{input:40,base:20,expected:2},{input:10,base:20,expected:.5},{input:30,base:20,expected:1.5}];for(const{input:e,base:n,expected:s}of t)await i(p(e,{base:n})).toBe(s)}},b={tags:["use-case"],parameters:a({description:{story:"Control decimal places with the precision option."}}),decorators:[c(),u({source:d`
                px2rem(13, { precision: 0 }) // 1
                px2rem(13, { precision: 1 }) // 0.8
                px2rem(13, { precision: 2 }) // 0.81
                px2rem(13, { precision: 4 }) // 0.8125
            `})],render(){const e=[0,1,2,3,4,6];return r.jsx(o,{title:"Custom precision (13px ÷ 16px)",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:e.map(n=>`px2rem(13, { precision: ${n} }) → ${p(13,{precision:n})}rem`).join(`
`)})})},play:async()=>{const e=[1,.8,.81,.813,.8125,.8125],n=[0,1,2,3,4,6];for(let s=0;s<n.length;s++)await i(p(13,{precision:n[s]})).toBe(e[s])}},f={tags:["use-case"],parameters:a({description:{story:"Combine custom base and precision."}}),decorators:[c(),u({source:d`
...
`)})})},play:async()=>{const t=[{input:18,base:18,precision:2,expected:1},{input:27,base:18,precision:3,expected:1.5},{input:"36px",base:18,precision:1,expected:2},{input:9,base:18,precision:0,expected:1}];for(const{input:e,base:n,precision:s,expected:h}of t)await i(p(e,{base:n,precision:s})).toBe(h)}},y={tags:["unit"],parameters:a({description:{story:"null and undefined are passed through as-is."}}),decorators:[c()],render(){return r.jsx(o,{title:"Null/undefined pass-through",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:`px2rem(null) → ${p(null)}
px2rem(undefined) → ${p(void 0)}`})})},play:async()=>{await i(p(null)).toBe(null),await i(p(void 0)).toBe(void 0)}},g={tags:["source"],parameters:a({source:{code:S}}),decorators:[u()]};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
