import{j as e,S as t,w as o,s as d,d as c}from"./iframe-BpXj-3b1.js";import{g as u}from"./get-prefers-reduced-transparency-JPUbF0w7.js";import"./preload-helper-PPVm8Dsz.js";import"./get-media-feature-value-D3vhnjdc.js";const p=`import { getMediaFeatureValue } from '../_internal/media/get-media-feature-value.ts'
...
`,h={title:"reduced-transparency/getPrefersReducedTransparency",tags:["func","version:3.5"],parameters:c({description:{component:'A utility function that returns the current preferred reduced transparency setting. It can be "no-preference" or "reduce". Unlike `getPrefersColorScheme`, `no-preference` is a real state and is returned as such, not collapsed into a default.'}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["use-case"],parameters:c({source:{code:'getPrefersReducedTransparency(): "no-preference" | "reduce"'}}),decorators:[o({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersReducedTransparency()"})," reads the current"," ",e.jsx("code",{children:"prefers-reduced-transparency"})," value."]}),e.jsxs("p",{children:["Accepts optional ",e.jsx("code",{children:"defaultReducedTransparency"})," (default"," ",e.jsx("code",{children:"'no-preference'"}),") returned when ",e.jsx("code",{children:"matchMedia"})," is unavailable (e.g. SSR)."]}),e.jsxs("p",{children:["Use this when you need a one-off read of the user's reduced transparency preference (e.g. for initial render or non-reactive logic). For reactive updates when the preference changes, use ",e.jsx("code",{children:"observePrefersReducedTransparency"})," instead."]})]})}),d()],render:()=>{const s=u();return e.jsxs(t,{title:"Current Reduced Transparency Preference (prefers-reduced-transparency)",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:s})]})}},a={name:"defaultReducedTransparency",tags:["props"],parameters:c({source:{code:"getPrefersReducedTransparency('reduce'): 'no-preference' | 'reduce'"}}),decorators:[o({content:e.jsx("div",{className:"space-y-2",children:e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersReducedTransparency('reduce')"})," returns ",e.jsx("code",{children:"'reduce'"})," when"," ",e.jsx("code",{children:"matchMedia"})," is unavailable (SSR, test env). In the browser, it returns the real system preference."]})})}),d()],render:()=>{const s=u("reduce");return e.jsxs(t,{title:"With defaultReducedTransparency: 'reduce'",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:s})]})}},n={tags:["source"],parameters:c({source:{code:p}}),decorators:[d()]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
