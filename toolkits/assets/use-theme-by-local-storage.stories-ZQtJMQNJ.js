import{r as o,j as t,d as l,w as S,s as g,S as d}from"./iframe-BF2V-t9M.js";import{o as b}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as B}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as K}from"./theme-entry-D4S_RAMB.js";import{l as C}from"./local-storage-theme-store-CQ0vNisZ.js";import{d as f}from"./dedent-BuYMbVyj.js";import{B as h}from"./button-DjzPnT5f.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";import"./write-local-storage-CE6rqo_l.js";import"./write-web-storage-H7mtIjJa.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-BFxr49ng.js";function k(e,r){const{storageKey:y,defaultTheme:i}=r,a=o.useMemo(()=>C(e,{storageKey:y}),[e,y]),[v,w]=o.useState(()=>a.read()?.theme??i);o.useEffect(()=>b([a],i,w),[a,i]);const E=o.useCallback(T=>{B([a],K(e,T))},[a,e]);return[v,E]}const j=`import { useCallback, useEffect, useMemo, useState } from 'react'
