import{j as s,S as i,w as d,s as o,d as p}from"./iframe-BpXj-3b1.js";import{p as e}from"./parse-css-number-rqvDcBqs.js";import{d as c}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";import"./parse-css-value-DyiR79PK.js";const C=`import { parseCssValue } from './parse-css-value.ts'
...
`,{expect:r}=__STORYBOOK_MODULE_TEST__,g={title:"units/parseCssNumber",tags:["func","version:3.1"],parameters:p({description:{component:"Extracts the numeric part from any CSS length/percentage value. Thin wrapper around parseCssValue(value)[0]."}}),render:()=>s.jsx(s.Fragment,{})},a={tags:["use-case"],parameters:p({description:{story:"Extract numeric value from CSS strings with various units."}}),decorators:[d(),o({source:c`
                parseCssNumber('16px')   // 16
                parseCssNumber('1.5rem') // 1.5
                parseCssNumber('100%')   // 100
                parseCssNumber('0lh')    // 0
                parseCssNumber(16)       // 16
            `})],render(){const m=[{input:"16px",expected:16},{input:"1.5rem",expected:1.5},{input:"100%",expected:100},{input:"0lh",expected:0},{input:16,expected:16}];return s.jsx(i,{title:"Basic usage",appearance:"output",children:s.jsx("pre",{className:"text-sm",children:m.map(({input:n,expected:l})=>`parseCssNumber(${typeof n=="string"?`'${n}'`:n}) → ${e(n)} (expected: ${l})`).join(`
`)})})},play:async()=>{await r(e("16px")).toBe(16),await r(e("1.5rem")).toBe(1.5),await r(e("100%")).toBe(100),await r(e("0lh")).toBe(0),await r(e(16)).toBe(16)}},t={tags:["unit"],parameters:p({description:{story:"null and undefined are passed through as-is."}}),decorators:[d(),o({source:c`
                parseCssNumber(null)      // null
                parseCssNumber(undefined)  // undefined
            `})],render(){return s.jsx(i,{title:"Null/undefined pass-through",appearance:"output",children:s.jsx("pre",{className:"text-sm",children:`parseCssNumber(null) → ${e(null)}
