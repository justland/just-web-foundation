import{j as t,d as r,w as c,s as i,S as m}from"./iframe-7ZNQ_6ea.js";import{g as d}from"./get-attribute-BI4biMNS.js";import{d as l}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";const f=`/**
...
`,N={title:"attributes/getAttribute",tags:["func","version:1.0"],parameters:r({description:{component:"A utility function to get attribute values from DOM element"}}),argTypes:{qualifiedName:{control:"text"},element:{control:!1}},args:{qualifiedName:"data-subject"},render:()=>t.jsx(t.Fragment,{})},a={parameters:r({description:{story:"By default, gets the value of an attribute from document root"},source:{code:l`
                document.documentElement.setAttribute('data-theme', 'some value')
                console.log(getAttribute('data-theme'))
                `}}),loaders:[({args:{qualifiedName:e}})=>{document.documentElement.setAttribute(e,"some value")}],decorators:[c(),i()],render(e){const n=d(e.qualifiedName);return t.jsx(m,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(n,null,2)})})}},o={args:{qualifiedName:"data-custom"},parameters:r({description:{story:"Gets an attribute value from a specific element"},source:{code:l`
                const element = document.createElement('div')
                element.setAttribute(qualifiedName, 'test-value')
                const value = getAttribute(qualifiedName, element)
            `}}),decorators:[c(),i()],render(e){const n=document.createElement("div");n.setAttribute(e.qualifiedName,"test-value");const p=d(e.qualifiedName,n);return t.jsx(m,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(p,null,2)})})}},s={tags:["unit"],args:{qualifiedName:"data-not-exist"},parameters:r({description:{story:"Returns null when trying to get a non-existent attribute"},source:{code:l`
                console.log(getAttribute('data-not-exist'))
            `}}),decorators:[c(),i()],render(e){const n=d(e.qualifiedName);return t.jsx(m,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(n,null,2)})})}},u={tags:["source"],parameters:r({source:{code:f}}),decorators:[i()]};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
