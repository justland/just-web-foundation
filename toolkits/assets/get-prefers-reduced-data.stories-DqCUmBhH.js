import{j as e,S as n,w as o,s,d}from"./iframe-BpXj-3b1.js";import{g as u}from"./get-prefers-reduced-data-Cqj8l0v_.js";import"./preload-helper-PPVm8Dsz.js";import"./get-media-feature-value-D3vhnjdc.js";const i=`import { getMediaFeatureValue } from '../_internal/media/get-media-feature-value.ts'
...
`,m={title:"reduced-data/getPrefersReducedData",tags:["func","version:3.5"],parameters:d({description:{component:'A utility function that returns the current preferred reduced data setting. It can be "no-preference" or "reduce". Unlike `getPrefersColorScheme`, `no-preference` is a real state and is returned as such, not collapsed into a default.'}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["use-case"],parameters:d({source:{code:'getPrefersReducedData(): "no-preference" | "reduce"'}}),decorators:[o({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersReducedData()"})," reads the current ",e.jsx("code",{children:"prefers-reduced-data"})," ","value."]}),e.jsxs("p",{children:["Accepts optional ",e.jsx("code",{children:"defaultReducedData"})," (default ",e.jsx("code",{children:"'no-preference'"}),") returned when ",e.jsx("code",{children:"matchMedia"})," is unavailable (e.g. SSR)."]}),e.jsxs("p",{children:["Use this when you need a one-off read of the user's reduced data preference (e.g. for initial render or non-reactive logic). For reactive updates when the preference changes, use ",e.jsx("code",{children:"observePrefersReducedData"})," instead."]})]})}),s()],render:()=>{const c=u();return e.jsxs(n,{title:"Current Reduced Data Preference (prefers-reduced-data)",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:c})]})}},a={name:"defaultReducedData",tags:["props"],parameters:d({source:{code:"getPrefersReducedData('reduce'): 'no-preference' | 'reduce'"}}),decorators:[o({content:e.jsx("div",{className:"space-y-2",children:e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersReducedData('reduce')"})," returns ",e.jsx("code",{children:"'reduce'"})," when"," ",e.jsx("code",{children:"matchMedia"})," is unavailable (SSR, test env). In the browser, it returns the real system preference."]})})}),s()],render:()=>{const c=u("reduce");return e.jsxs(n,{title:"With defaultReducedData: 'reduce'",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:c})]})}},t={tags:["source"],parameters:d({source:{code:i}}),decorators:[s()]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
