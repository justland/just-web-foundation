import{j as t,w as n,s as c,d as l,S as B,r as H}from"./iframe-BpXj-3b1.js";import{t as p}from"./theme-entry-D4S_RAMB.js";import{r as d,w as h}from"./write-local-storage-CE6rqo_l.js";import{d as m}from"./dedent-D4JfOF0A.js";import{B as j}from"./button-CGZNSIHq.js";import{T as u}from"./theme-result-card-DQkyr6Gh.js";import{T as k}from"./theme-store-demo-Dl8Ng1NL.js";import"./preload-helper-PPVm8Dsz.js";import"./write-web-storage-H7mtIjJa.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-CqQ4XPfR.js";import"./append-id-Vsg144gU.js";const{expect:a,userEvent:A}=__STORYBOOK_MODULE_TEST__,Q={title:"theme/local-storage",tags:["func","version:2.0"],parameters:l({description:{component:"Low-level functions for reading and writing theme via localStorage: readLocalStorage, writeLocalStorage. No subscribe at function level (store uses StorageEvent)."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},o="theme-ls-func-demo";function P(e){return{read:()=>d(r,e),write:g=>h(r,e,g),subscribe:void 0}}const y={tags:["playground"],parameters:l({description:{story:"Interactive demo: readLocalStorage, writeLocalStorage. No subscribe (StorageEvent is at store level)."}}),decorators:[n(),c({source:m`
                const store = {
            ...
            `})],loaders:[()=>(window.localStorage.removeItem(o),{})],render:()=>{const e=P(o);return t.jsx(k,{store:e,themes:r})},play:async({canvas:e})=>{await A.click(e.getByTestId("theme-store-demo-btn-write-grayscale")),await A.click(e.getByTestId("theme-store-demo-btn-read")),await a(e.getByTestId("theme-store-demo-read")).toHaveTextContent("grayscale")}},S={name:"readLocalStorage",tags:["props"],parameters:l({description:{story:"readLocalStorage(themes, storageKey, options?) reads the current theme from localStorage."}}),decorators:[n(),c({source:m`
                const result = readLocalStorage(themes, storageKey)
            `})],loaders:[()=>(h(r,o,p(r,"grayscale")),{})],render:()=>{const e=d(r,o);return t.jsx(u,{title:"readLocalStorage() result","data-testid":"store-read-result",result:e??{theme:"grayscale",value:r.grayscale}})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-grayscale")}},v={name:"readLocalStorage: undefined when empty",tags:["props"],parameters:l({description:{story:"When nothing is stored at the key, readLocalStorage returns undefined."}}),decorators:[n(),c({source:m`
                const result = readLocalStorage(themes, storageKey)
                // undefined when empty
            `})],loaders:[()=>(window.localStorage.removeItem(o),{})],render:()=>{const e=d(r,o);return t.jsx(u,{title:"readLocalStorage() result","data-testid":"store-read-result",result:e!==void 0?e:{theme:void 0,value:void 0}})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("(undefined)")}},w={name:"writeLocalStorage",tags:["props"],parameters:l({description:{story:"writeLocalStorage(themes, storageKey, entry) persists the theme to localStorage."}}),decorators:[n(),c({source:m`
                writeLocalStorage(themes, storageKey, themeEntry(themes, 'high-contrast'))
            `})],loaders:[()=>(window.localStorage.removeItem(o),{})],render:()=>{const[e,g]=H.useState(()=>d(r,o)?.theme??null);return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsx("div",{className:"flex flex-wrap gap-2",children:Object.keys(r).map(s=>t.jsxs(j,{"data-testid":`write-${s}`,onPress:()=>{h(r,o,p(r,s)),g(s)},children:["write(",s,")"]},s))}),t.jsx(u,{title:"readLocalStorage() after write","data-testid":"store-write-result",result:e?{theme:e,value:r[e]}:{theme:"current",value:r.current}})]})},play:async({canvas:e})=>{await A.click(e.getByTestId("write-grayscale")),await a(e.getByTestId("store-write-result")).toHaveTextContent("theme: grayscale"),await a(e.getByTestId("store-write-result")).toHaveTextContent("value: theme-grayscale")}},_="theme-ls-func-validation",T={name:"Stored Validation: legacy format returns undefined",tags:["integration"],parameters:l({description:{story:"Strict validation: when stored JSON has no value field (legacy format), readLocalStorage returns undefined."}}),decorators:[n({content:t.jsxs("p",{children:["Pre-seeded localStorage with legacy format ",t.jsx("code",{children:'{ theme: "dark" }'})," (no value). readLocalStorage returns undefined."]})}),c({source:m`
                // Legacy storage: { theme: "dark" } - no value field
                // readLocalStorage(themes, key) returns undefined (strict validation)
            `})],loaders:[()=>(window.localStorage.setItem(_,JSON.stringify({theme:"dark"})),{})],render:()=>{const e=d(r,_);return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(u,{title:"readLocalStorage() result","data-testid":"store-read-result",result:e!==void 0?e:{theme:void 0,value:void 0}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("(undefined)")}},R="theme-ls-func-parse";function b(e,g){let s;try{s=g?JSON.parse(g):void 0}catch{return}if(!s?.theme||typeof s.theme!="string"||!(s.theme in e))return;const O=s.theme;return{theme:O,value:e[O]}}const x={name:"options.parse",tags:["props","use-case"],parameters:l({description:{story:"The options.parse allows you to provide a custom parse function. Use it when migrating from legacy formats. This example accepts legacy format { theme } (no value field)."}}),decorators:[n({content:t.jsxs("p",{children:["Pre-seeded localStorage with legacy format ",t.jsx("code",{children:'{ theme: "grayscale" }'})," (no value)."]})}),c({source:m`
                const result = readLocalStorage(themes, storageKey, { parse: customParse })
            `})],loaders:[()=>(window.localStorage.setItem(R,JSON.stringify({theme:"grayscale"})),{})],render:()=>{const e=d(r,R,{parse:b});return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(u,{title:"readLocalStorage() with custom parse","data-testid":"store-read-result",result:e??{theme:"grayscale",value:r.grayscale}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-grayscale")}},f={name:"storageKey",tags:["props"],decorators:[n({content:t.jsxs("p",{children:["Pass ",t.jsx("code",{children:"storageKey"})," to determine the localStorage key used for persistence."]})}),c({source:m`
                readLocalStorage(themes, storageKey)
                writeLocalStorage(themes, storageKey, themeEntry(themes, 'current'))
            `})],loaders:[()=>(h(r,o,p(r,"current")),{})],render:()=>{const e=d(r,o);return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsx(B,{title:"localStorage key",appearance:"output",children:t.jsx("code",{children:o})}),t.jsx(u,{title:"readLocalStorage() result","data-testid":"store-read-result",result:e??{theme:"current",value:r.current}})]})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},i="theme-ls-func-thememap",E={name:"themes: string value",tags:["props"],parameters:l({description:{story:"themes values can be a single string per theme."}}),decorators:[n({content:t.jsx("p",{children:"Each theme maps to one string value."})}),c({source:m`
                readLocalStorage(themes, storageKey)
                writeLocalStorage(themes, storageKey, themeEntry(themes, 'current'))
            `})],loaders:[()=>(window.localStorage.removeItem(i),h(r,i,p(r,"current")),{})],render:()=>{const e=d(r,i);return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(u,{title:"readLocalStorage() result","data-testid":"store-read-result",result:e??{theme:"current",value:r.current}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},L={current:"theme-current",grayscale:["theme-grayscale","app:bg-gray-100"],"high-contrast":"theme-high-contrast"},I={name:"themes: array values",tags:["props"],parameters:l({description:{story:"themes values can be string[]. Stored and retrieved value is the full array."}}),decorators:[n({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"string[]"}),". ",t.jsx("code",{children:"ThemeResult.value"})," persists the full array."]})}),c({source:m`
                const themes = {
            ...
            `})],loaders:[()=>(window.localStorage.removeItem(i),h(L,i,p(L,"grayscale")),{})],render:()=>{const e=d(L,i);return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(u,{title:"readLocalStorage() result","data-testid":"store-read-result",result:e??{theme:"grayscale",value:L.grayscale}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: [theme-grayscale, app:bg-gray-100]")}},C={light:"theme-light",dark:{themeValue:"theme-dark",contrast:"high"}},K={name:"themes: object value",tags:["props"],parameters:l({description:{story:"themes values can be { themeValue: string | string[] }. Extra props (e.g. contrast) are preserved when read from storage."}}),decorators:[n({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"{ themeValue, ...extra }"}),". Stored and retrieved value preserves extra props for user metadata."]})}),c({source:m`
                const themes = {
                    light: 'theme-light',
...
}`,...K.parameters?.docs?.source}}};const X=["Playground","Read","ReadWhenEmpty","Write","StoredValidationShapeMismatch","ParseOption","StorageKey","ThemeMapStringValue","ThemeMapArrayValues","ThemeMapObjectValue"];export{x as ParseOption,y as Playground,S as Read,v as ReadWhenEmpty,f as StorageKey,T as StoredValidationShapeMismatch,I as ThemeMapArrayValues,K as ThemeMapObjectValue,E as ThemeMapStringValue,w as Write,X as __namedExportsOrder,Q as default};
