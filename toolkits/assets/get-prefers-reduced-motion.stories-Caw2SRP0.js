import{j as e,d,w as s,s as c,S as a}from"./iframe-BF2V-t9M.js";import{g as u}from"./get-prefers-reduced-motion-D4GvVdcy.js";import"./preload-helper-PPVm8Dsz.js";import"./get-media-feature-value-D3vhnjdc.js";const i=`import { getMediaFeatureValue } from '../_internal/media/get-media-feature-value.ts'
...
`,h={title:"reduced-motion/getPrefersReducedMotion",tags:["func","version:3.5"],parameters:d({description:{component:'A utility function that returns the current preferred reduced motion setting. It can be "no-preference" or "reduce". Unlike `getPrefersColorScheme`, `no-preference` is a real state and is returned as such, not collapsed into a default.'}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["use-case"],parameters:d({source:{code:'getPrefersReducedMotion(): "no-preference" | "reduce"'}}),decorators:[s({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersReducedMotion()"})," reads the current"," ",e.jsx("code",{children:"prefers-reduced-motion"})," value."]}),e.jsxs("p",{children:["Accepts optional ",e.jsx("code",{children:"defaultReducedMotion"})," (default ",e.jsx("code",{children:"'no-preference'"}),") returned when ",e.jsx("code",{children:"matchMedia"})," is unavailable (e.g. SSR)."]}),e.jsxs("p",{children:["Use this when you need a one-off read of the user's reduced motion preference (e.g. for initial render or non-reactive logic). For reactive updates when the preference changes, use ",e.jsx("code",{children:"observePrefersReducedMotion"})," instead."]})]})}),c()],render:()=>{const n=u();return e.jsxs(a,{title:"Current Reduced Motion Preference (prefers-reduced-motion)",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:n})]})}},o={name:"defaultReducedMotion",tags:["props"],parameters:d({source:{code:"getPrefersReducedMotion('reduce'): 'no-preference' | 'reduce'"}}),decorators:[s({content:e.jsx("div",{className:"space-y-2",children:e.jsxs("p",{children:[e.jsx("code",{children:"getPrefersReducedMotion('reduce')"})," returns ",e.jsx("code",{children:"'reduce'"})," when"," ",e.jsx("code",{children:"matchMedia"})," is unavailable (SSR, test env). In the browser, it returns the real system preference."]})})}),c()],render:()=>{const n=u("reduce");return e.jsxs(a,{title:"With defaultReducedMotion: 'reduce'",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:n})]})}},t={tags:["source"],parameters:d({source:{code:i}}),decorators:[c()]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
