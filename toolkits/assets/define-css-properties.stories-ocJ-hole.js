import{j as e,d as n,w as i,s as c,S as a}from"./iframe-Bip_vWCg.js";import{d as s}from"./define-css-properties-Dh8E5HRZ.js";import{d as p}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";const d=`import type { CSSProperties } from './css-properties.ts'
...
`,{expect:S}=__STORYBOOK_MODULE_TEST__,y={title:"style/defineCSSProperties",tags:["func","version:1.0"],parameters:n({description:{component:"Helper function to define CSS properties with type checking, including custom properties (--*)."}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["source"],parameters:n({source:{code:d}}),decorators:[i({content:e.jsxs("p",{children:[e.jsx("code",{children:"defineCSSProperties"})," is a helper function to define ",e.jsx("code",{children:"CSSProperties"})]})}),c()]},o={tags:["use-case"],parameters:n({source:{code:p`const style = defineCSSProperties({
                color: 'red',
                fontSize: '16px',
                '--custom-property': '10px'
            })`}}),decorators:[i({content:e.jsxs("p",{children:["A helper function to define ",e.jsx("code",{children:"CSSProperties"})," with custom properties."]})}),c({source:p`const style = defineCSSProperties({
                color: 'red',
                fontSize: '16px',
                '--custom-property': '10px'
            })`})],render(){const t=s({color:"red",fontSize:"16px","--custom-property":"10px"});return e.jsx(a,{appearance:"output",children:JSON.stringify(t,null,2)})},play:async()=>{const t=s({color:"red",fontSize:"16px","--custom-property":"10px"});await S(t).toEqual({color:"red",fontSize:"16px","--custom-property":"10px"})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['source'],
