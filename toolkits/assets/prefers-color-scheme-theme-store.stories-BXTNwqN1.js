import{j as r,w as u,s as n,d as p,r as m}from"./iframe-BpXj-3b1.js";import{t as y}from"./theme-entry-D4S_RAMB.js";import{c as b}from"./compose-theme-stores-CD86eyKP.js";import{g as C}from"./get-prefers-color-scheme-BMZwcwg-.js";import{o as k}from"./observe-prefers-color-scheme-Cpw9ndla.js";import{d as S}from"./dedent-D4JfOF0A.js";import{T as g}from"./theme-result-card-DQkyr6Gh.js";import{T as v}from"./theme-store-demo-Dl8Ng1NL.js";import"./preload-helper-PPVm8Dsz.js";import"./set-theme-to-stores-C1AbMsOJ.js";import"./get-media-feature-value-D3vhnjdc.js";import"./observe-media-feature-value--S6jnvF8.js";import"./append-id-Vsg144gU.js";import"./button-CGZNSIHq.js";import"./resolve-class-name-CqQ4XPfR.js";function w(e,t){const c=C("light");return y(e,c)}function x(e,t){return k(o=>t(y(e,o)))}function T(e){return{read(){return w(e)},subscribe(t){return x(e,t)}}}const P=`import type { RequiredPick } from 'type-plus'
...
`,{expect:f,userEvent:R}=__STORYBOOK_MODULE_TEST__,L={title:"theme/theme-store/prefersColorSchemeThemeStore",tags:["func","version:2.0"],render:()=>r.jsx(r.Fragment,{})},s={light:"theme-light",dark:"theme-dark"},h={tags:["playground"],decorators:[u({content:r.jsxs("p",{children:[r.jsx("code",{children:"prefersColorSchemeThemeStore"})," is a read-only theme store for color-scheme only. Themes must include only ",r.jsx("code",{children:"light"})," and ",r.jsx("code",{children:"dark"})," keys—mirrors"," ",r.jsx("code",{children:"prefers-color-scheme"}),". Returns ",r.jsx("code",{children:"ThemeEntry"})," for ",r.jsx("code",{children:"light"})," ","or ",r.jsx("code",{children:"dark"})," based on system preference. No write method."]})}),n({source:S`
            ...
            `})],render:()=>{const e=m.useMemo(()=>b(s,[T(s)],{defaultTheme:"light"}),[]),[t,o]=m.useState(void 0);return m.useEffect(()=>(Promise.resolve(e.read()).then(c=>o(c??void 0)),e.subscribe?.(c=>o(c??void 0))),[e]),r.jsx(g,{title:"Composed store (prefers-color-scheme as only source)","data-testid":"composed-store-result",result:t??{theme:"light",value:s.light}})},play:async({canvas:e})=>{await f(e.getByTestId("composed-store-result")).toHaveTextContent(/\b(light|dark)\b/)}},i={tags:["source"],parameters:p({source:{code:P}}),decorators:[n()]};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  tags: ['playground'],
...
}`,...i.parameters?.docs?.source}}};const Y=["Playground","Read","Subscribe","WithComposeThemeStores","Source"];export{h as Playground,a as Read,i as Source,l as Subscribe,d as WithComposeThemeStores,Y as __namedExportsOrder,L as default};
