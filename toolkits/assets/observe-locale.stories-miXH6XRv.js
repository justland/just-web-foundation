import{r as s,j as e,S as i,w as d,s as c,d as n}from"./iframe-BpXj-3b1.js";import{g as u}from"./get-locale-BBBiBIN1.js";import{o as p}from"./observe-locale-Mz7zmLKX.js";import{s as m}from"./set-locale-CqhIGKJQ.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-CZKLLp6I.js";const h=`import { observeAttributes } from '../attributes/observe-attribute.ts'
...
`,L={title:"locale/observeLocale",tags:["func","version:3.4"],parameters:n({description:{component:"Observes changes to the `lang` attribute on an element and calls the callback when it changes. Returns a cleanup function to stop observing. Uses MutationObserver under the hood."}}),render:()=>e.jsx(e.Fragment,{})},o={tags:["use-case"],parameters:n({description:{story:"Observe `lang` attribute changes on `document.documentElement`."},source:{code:"observeLocale((locale) => { ... }): () => void"}}),decorators:[d({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"observeLocale(callback)"})," subscribes to ",e.jsx("code",{children:"lang"})," attribute changes and runs your callback with the new locale value."]}),e.jsxs("p",{children:["Use this for reactive updates (e.g. UI that follows the document locale). For a one-off read, use ",e.jsx("code",{children:"getLocale"})," instead."]}),e.jsx("p",{children:"Call the returned cleanup function to stop observing."})]})}),c()],render:()=>{const[r,l]=s.useState(u());return s.useEffect(()=>p(l),[]),e.jsx(i,{title:"Current Locale (Reactive)",appearance:"output",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.5rem"},children:[e.jsxs("div",{children:["Current locale: ",e.jsx("strong",{children:r})]}),e.jsx("div",{style:{display:"flex",gap:"0.5rem"},children:["en","en-US","ja","zh-Hans","fr"].map(t=>e.jsx("button",{type:"button",onClick:()=>m(t),style:{padding:"0.25rem 0.5rem",border:"1px solid currentColor",borderRadius:"0.25rem",cursor:"pointer",background:r===t?"#0066cc":"transparent",color:r===t?"white":"inherit"},children:t},t))})]})})}},a={tags:["source"],parameters:n({source:{code:h}}),decorators:[c()]};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
