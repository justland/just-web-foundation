import{j as t,d as n,w as c,s as l,r as B,S as H}from"./iframe-2hVe8Zfo.js";import{t as p}from"./theme-entry-D4S_RAMB.js";import{r as d,w as h}from"./write-local-storage-CE6rqo_l.js";import{d as m}from"./dedent-BuYMbVyj.js";import{B as j}from"./button-BgLyjgiD.js";import{T as u}from"./theme-result-card-CXos47Kq.js";import{T as k}from"./theme-store-demo-DV8KayFM.js";import"./preload-helper-PPVm8Dsz.js";import"./write-web-storage-H7mtIjJa.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-CN13v7LM.js";import"./append-id-Vsg144gU.js";const{expect:a,userEvent:A}=__STORYBOOK_MODULE_TEST__,Q={title:"theme/local-storage",tags:["func","version:2.0"],parameters:n({description:{component:"Low-level functions for reading and writing theme via localStorage: readLocalStorage, writeLocalStorage. No subscribe at function level (store uses StorageEvent)."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},o="theme-ls-func-demo";function P(e){return{read:()=>d(r,e),write:g=>h(r,e,g),subscribe:void 0}}const y={tags:["playground"],parameters:n({description:{story:"Interactive demo: readLocalStorage, writeLocalStorage. No subscribe (StorageEvent is at store level)."}}),decorators:[c(),l({source:m`
                const store = {
