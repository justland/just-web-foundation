import{j as t,w as n,s as i,d as c,S as _,r as A}from"./iframe-BpXj-3b1.js";import{t as y}from"./theme-entry-D4S_RAMB.js";import{r as d,w as h}from"./write-session-storage-CmPsdO-d.js";import{d as m}from"./dedent-D4JfOF0A.js";import{B}from"./button-CGZNSIHq.js";import{T as l}from"./theme-result-card-DQkyr6Gh.js";import{T as H}from"./theme-store-demo-Dl8Ng1NL.js";import"./preload-helper-PPVm8Dsz.js";import"./write-web-storage-H7mtIjJa.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-CqQ4XPfR.js";import"./append-id-Vsg144gU.js";const{expect:s,userEvent:C}=__STORYBOOK_MODULE_TEST__,$={title:"theme/session-storage",tags:["func","version:2.0"],parameters:c({description:{component:"Low-level functions for reading and writing theme via sessionStorage: readSessionStorage, writeSessionStorage. Persists per tab. No subscribe at function level."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},o="theme-ss-func-demo";function O(e){return{read:()=>d(r,e),write:u=>h(r,e,u),subscribe:void 0}}const S={tags:["playground"],parameters:c({description:{story:"Interactive demo: readSessionStorage, writeSessionStorage. No subscribe at function level."}}),decorators:[n(),i({source:m`
                const store = {
            ...
            `})],loaders:[()=>(window.sessionStorage.removeItem(o),{})],render:()=>{const e=O(o);return t.jsx(H,{store:e,themes:r})},play:async({canvas:e})=>{await C.click(e.getByTestId("theme-store-demo-btn-write-grayscale")),await C.click(e.getByTestId("theme-store-demo-btn-read")),await s(e.getByTestId("theme-store-demo-read")).toHaveTextContent("grayscale")}},p={name:"readSessionStorage",tags:["props"],parameters:c({description:{story:"readSessionStorage(themes, storageKey, options?) reads the current theme from sessionStorage."}}),decorators:[n(),i({source:m`
                const result = readSessionStorage(themes, storageKey)
            `})],loaders:[()=>(h(r,o,y(r,"grayscale")),{})],render:()=>{const e=d(r,o);return t.jsx(l,{title:"readSessionStorage() result","data-testid":"store-read-result",result:e??{theme:"grayscale",value:r.grayscale}})},play:async({canvas:e})=>{await s(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await s(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-grayscale")}},v={name:"readSessionStorage: undefined when empty",tags:["props"],parameters:c({description:{story:"When nothing is stored at the key, readSessionStorage returns undefined."}}),decorators:[n(),i({source:m`
                const result = readSessionStorage(themes, storageKey)
                // undefined when empty
            `})],loaders:[()=>(window.sessionStorage.removeItem(o),{})],render:()=>{const e=d(r,o);return t.jsx(l,{title:"readSessionStorage() result","data-testid":"store-read-result",result:e!==void 0?e:{theme:void 0,value:void 0}})},play:async({canvas:e})=>{await s(e.getByTestId("store-read-result")).toHaveTextContent("(undefined)")}},w={name:"writeSessionStorage",tags:["props"],parameters:c({description:{story:"writeSessionStorage(themes, storageKey, entry) persists the theme to sessionStorage."}}),decorators:[n(),i({source:m`
                writeSessionStorage(themes, storageKey, themeEntry(themes, 'high-contrast'))
            `})],loaders:[()=>(window.sessionStorage.removeItem(o),{})],render:()=>{const[e,u]=A.useState(()=>d(r,o)?.theme??null);return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsx("div",{className:"flex flex-wrap gap-2",children:Object.keys(r).map(a=>t.jsxs(B,{"data-testid":`write-${a}`,onPress:()=>{h(r,o,y(r,a)),u(a)},children:["write(",a,")"]},a))}),t.jsx(l,{title:"readSessionStorage() after write","data-testid":"store-write-result",result:e?{theme:e,value:r[e]}:{theme:"current",value:r.current}})]})},play:async({canvas:e})=>{await C.click(e.getByTestId("write-grayscale")),await s(e.getByTestId("store-write-result")).toHaveTextContent("theme: grayscale"),await s(e.getByTestId("store-write-result")).toHaveTextContent("value: theme-grayscale")}},R="theme-ss-func-parse";function P(e,u){let a;try{a=u?JSON.parse(u):void 0}catch{return}if(!a?.theme||typeof a.theme!="string"||!(a.theme in e))return;const I=a.theme;return{theme:I,value:e[I]}}const T={name:"options.parse",tags:["props","use-case"],parameters:c({description:{story:"The options.parse allows you to provide a custom parse function. Use it when migrating from legacy formats."}}),decorators:[n({content:t.jsxs("p",{children:["Pre-seeded sessionStorage with legacy format ",t.jsx("code",{children:'{ theme: "grayscale" }'})," (no value)."]})}),i({source:m`
                const result = readSessionStorage(themes, storageKey, { parse: customParse })
            `})],loaders:[()=>(window.sessionStorage.setItem(R,JSON.stringify({theme:"grayscale"})),{})],render:()=>{const e=d(r,R,{parse:P});return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(l,{title:"readSessionStorage() with custom parse","data-testid":"store-read-result",result:e??{theme:"grayscale",value:r.grayscale}})})},play:async({canvas:e})=>{await s(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await s(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-grayscale")}},x={name:"storageKey",tags:["props"],decorators:[n({content:t.jsxs("p",{children:["Pass ",t.jsx("code",{children:"storageKey"})," to determine the sessionStorage key used for persistence."]})}),i({source:m`
                readSessionStorage(themes, storageKey)
                writeSessionStorage(themes, storageKey, themeEntry(themes, 'current'))
            `})],loaders:[()=>(h(r,o,y(r,"current")),{})],render:()=>{const e=d(r,o);return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsx(_,{title:"sessionStorage key",appearance:"output",children:t.jsx("code",{children:o})}),t.jsx(l,{title:"readSessionStorage() result","data-testid":"store-read-result",result:e??{theme:"current",value:r.current}})]})},play:async({canvas:e})=>{await s(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await s(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},g="theme-ss-func-thememap",E={name:"themes: string value",tags:["props"],parameters:c({description:{story:"themes values can be a single string per theme."}}),decorators:[n({content:t.jsx("p",{children:"Each theme maps to one string value."})}),i({source:m`
                readSessionStorage(themes, storageKey)
                writeSessionStorage(themes, storageKey, themeEntry(themes, 'current'))
            `})],loaders:[()=>(window.sessionStorage.removeItem(g),h(r,g,y(r,"current")),{})],render:()=>{const e=d(r,g);return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(l,{title:"readSessionStorage() result","data-testid":"store-read-result",result:e??{theme:"current",value:r.current}})})},play:async({canvas:e})=>{await s(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await s(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},f={current:"theme-current",grayscale:["theme-grayscale","app:bg-gray-100"],"high-contrast":"theme-high-contrast"},K={name:"themes: array values",tags:["props"],parameters:c({description:{story:"themes values can be string[]. Stored and retrieved value is the full array."}}),decorators:[n({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"string[]"}),". ",t.jsx("code",{children:"ThemeResult.value"})," persists the full array."]})}),i({source:m`
                const themes = {
