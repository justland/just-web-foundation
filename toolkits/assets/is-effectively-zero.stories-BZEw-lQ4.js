import{j as r,d as i,w as f,s as y,S as d}from"./iframe-Bip_vWCg.js";import{i as e}from"./is-effectively-zero-CoUoHep5.js";import{d as E}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";import"./parse-css-number-rqvDcBqs.js";import"./parse-css-value-DyiR79PK.js";const Z=`import { parseCssNumber } from './parse-css-number.ts'
...
`,{expect:n}=__STORYBOOK_MODULE_TEST__,C={title:"units/isEffectivelyZero",tags:["func","version:3.1"],parameters:i({description:{component:"Determines if a CSS value is effectively 0 regardless of unit. Uses default epsilon 1e-10 for floating-point safety."}}),render:()=>r.jsx(r.Fragment,{})},o={tags:["use-case"],parameters:i({description:{story:"Zero values in any unit return true."}}),decorators:[f(),y({source:E`
            ...
            `})],render(){const a=[0,"0","0px","0rem","0em","0%","0lh","0ch","0vw","0vh"],s=["16px","1rem","100%",1,-1];return r.jsx(d,{title:"Basic usage",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:[...a.map(t=>`isEffectivelyZero(${typeof t=="string"?`'${t}'`:t}) → ${e(t)} (expected: true)`),...s.map(t=>`isEffectivelyZero(${typeof t=="string"?`'${t}'`:t}) → ${e(t)} (expected: false)`)].join(`
`)})})},play:async()=>{await n(e(0)).toBe(!0),await n(e("0")).toBe(!0),await n(e("0px")).toBe(!0),await n(e("0rem")).toBe(!0),await n(e("0%")).toBe(!0),await n(e("16px")).toBe(!1),await n(e("1rem")).toBe(!1)}},l={tags:["use-case"],parameters:i({description:{story:"Optional epsilon for floating-point tolerance. Default 1e-10 treats tiny values as zero."}}),decorators:[f()],render(){const a=[{value:1e-4,epsilon:void 0,expected:!1},{value:1e-11,epsilon:void 0,expected:!0},{value:1e-4,epsilon:.001,expected:!0}];return r.jsx(d,{title:"Epsilon option",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:a.map(({value:s,epsilon:t,expected:v})=>{const m=t!==void 0?`{ epsilon: ${t} }`:void 0,x=e(s,m?{epsilon:t}:void 0);return`isEffectivelyZero(${s}${m?`, ${m}`:""}) → ${x} (expected: ${v})`}).join(`
`)})})},play:async()=>{await n(e(1e-4)).toBe(!1),await n(e(1e-11)).toBe(!0),await n(e(1e-4,{epsilon:.001})).toBe(!0)}},p={tags:["unit"],parameters:i({description:{story:"null and undefined are passed through as-is."}}),decorators:[f()],render(){return r.jsx(d,{title:"Null/undefined pass-through",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:`isEffectivelyZero(null) → ${e(null)}
isEffectivelyZero(undefined) → ${e(void 0)}`})})},play:async()=>{await n(e(null)).toBe(null),await n(e(void 0)).toBe(void 0)}},c={tags:["unit"],parameters:i({description:{story:"Invalid input (empty string, non-numeric) returns false."}}),decorators:[f()],render(){const a=["","abc"];return r.jsx(d,{title:"Invalid input",appearance:"output",children:r.jsx("pre",{className:"text-sm",children:a.map(s=>`isEffectivelyZero(${s===""?"''":`'${s}'`}) → ${e(s)} (expected: false)`).join(`
