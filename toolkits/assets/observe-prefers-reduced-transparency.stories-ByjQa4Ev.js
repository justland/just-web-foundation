import{j as e,d as n,w as d,s as c,r as a,S as u}from"./iframe-BF2V-t9M.js";import{g as p}from"./get-prefers-reduced-transparency-JPUbF0w7.js";import{o as i}from"./observe-prefers-reduced-transparency-r0yFSKKP.js";import"./preload-helper-PPVm8Dsz.js";import"./get-media-feature-value-D3vhnjdc.js";import"./observe-media-feature-value--S6jnvF8.js";const l=`import { observeMediaFeatureValue } from '../_internal/media/observe-media-feature-value.ts'
...
`,b={title:"reduced-transparency/observePrefersReducedTransparency",tags:["func","version:3.5"],parameters:n({description:{component:'A utility function that observes system reduced transparency preferences and triggers callbacks when changes occur. Reports "no-preference" or "reduce" as reported by the `prefers-reduced-transparency` media feature.'}}),render:()=>e.jsx(e.Fragment,{})},r={tags:["use-case"],parameters:n({description:{story:"Observe `prefers-reduced-transparency` changes."},source:{code:"observePrefersReducedTransparency((value) => { ... }): () => void"}}),decorators:[d({content:e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{children:[e.jsx("code",{children:"observePrefersReducedTransparency(callback)"})," subscribes to"," ",e.jsx("code",{children:"prefers-reduced-transparency"})," changes and runs your callback when the preference changes."]}),e.jsxs("p",{children:["Use this when you need reactive updates (e.g. UI that follows the system reduced transparency preference). For a one-off read, use"," ",e.jsx("code",{children:"getPrefersReducedTransparency"})," instead."]}),e.jsx("p",{children:"You should call the returned cleanup function to stop observing when you no longer need it."})]})}),c()],render:()=>{const[t,o]=a.useState(p());return a.useEffect(()=>i(o),[]),e.jsxs(u,{title:"Current Reduced Transparency Preference (prefers-reduced-transparency)",appearance:"output",children:["Your system is currently set to: ",e.jsx("strong",{children:t})]})}},s={tags:["source"],parameters:n({source:{code:l}}),decorators:[c()]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
