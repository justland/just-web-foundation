import{j as t,w as m,s as i,d as u,r as h,S as k}from"./iframe-BpXj-3b1.js";import{t as c}from"./theme-entry-D4S_RAMB.js";import{i as l}from"./in-memory-theme-store-CtdmAzEM.js";import{d}from"./dedent-D4JfOF0A.js";import{B as g}from"./button-CGZNSIHq.js";import{T as y}from"./theme-result-card-DQkyr6Gh.js";import{T as j}from"./theme-store-demo-Dl8Ng1NL.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-class-name-CqQ4XPfR.js";import"./append-id-Vsg144gU.js";const H=`import { themeEntry } from '../../theme-entry.ts'
...
`,{expect:a,userEvent:p,waitFor:I}=__STORYBOOK_MODULE_TEST__,z={title:"theme/theme-store/inMemoryThemeStore",tags:["func","version:1.0"],parameters:u({description:{component:"In-memory theme store. Transient state; no persistence. Bakes themes at creation; read/write/subscribe use theme keys only."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},T={tags:["playground"],parameters:u({description:{story:"Interactive demo: Read theme, write themes via buttons, and observe subscribe updates."}}),decorators:[m(),i({source:d`
            ...
            `})],loaders:[()=>{const e=l(r);return e.write(c(r,"current")),{store:e}}],render:(e,{loaded:{store:s}})=>{const o=s.read();return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(k,{title:"store.read() after write",appearance:"output",children:t.jsx(y,{title:"store.read() result","data-testid":"store-read-result",result:o??{theme:"current",value:r.current}})})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},v={name:"themes: string value",tags:["use-case","props"],parameters:u({description:{story:"themes values can be a single string per theme."}}),decorators:[m({content:t.jsx("p",{children:"Each theme maps to one string value."})}),i({source:d`
                ...
                const store = inMemoryThemeStore(themes)
            `})],loaders:[()=>{const e=l(r);return e.write(c(r,"current")),{store:e}}],render:(e,{loaded:{store:s}})=>{const o=s.read();return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(y,{title:"store.read() result","data-testid":"store-read-result",result:o??{theme:"current",value:r.current}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},E={current:"theme-current",grayscale:["theme-grayscale","app:bg-gray-100"],"high-contrast":"theme-high-contrast"},f={name:"themes: array values",tags:["use-case","props"],parameters:u({description:{story:"themes values can be string[] for multiple tokens. ThemeResult.value stores the full array."}}),decorators:[m({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"string[]"}),". ",t.jsx("code",{children:"ThemeResult.value"})," is the full array."]})}),i({source:d`
                const themes = {
                    current: 'theme-current',
