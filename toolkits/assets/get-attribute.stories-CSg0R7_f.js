import{j as t,S as c,w as m,s as i,d as r}from"./iframe-BpXj-3b1.js";import{g as d}from"./get-attribute-BI4biMNS.js";import{d as l}from"./dedent-D4JfOF0A.js";import"./preload-helper-PPVm8Dsz.js";const f=`/**
...
`,N={title:"attributes/getAttribute",tags:["func","version:1.0"],parameters:r({description:{component:"A utility function to get attribute values from DOM element"}}),argTypes:{qualifiedName:{control:"text"},element:{control:!1}},args:{qualifiedName:"data-subject"},render:()=>t.jsx(t.Fragment,{})},a={parameters:r({description:{story:"By default, gets the value of an attribute from document root"},source:{code:l`
            ...
            `}}),decorators:[m(),i()],render(e){const n=d(e.qualifiedName);return t.jsx(c,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(n,null,2)})})}},u={tags:["source"],parameters:r({source:{code:f}}),decorators:[i()]};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
