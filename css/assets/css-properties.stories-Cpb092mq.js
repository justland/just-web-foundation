import{j as o}from"./jsx-dev-runtime-DF-ftqEI.js";import{s as p,d as t}from"./iframe-D9d09le6.js";import{d as s,a as c}from"./dedent-BEojnTFe.js";import"./preload-helper-PPVm8Dsz.js";const{expect:i}=__STORYBOOK_MODULE_TEST__,S={title:"CSS Properties/CSSProperties",tags:["autodocs","code-only","new","version:1.0"],decorators:[p()],render:()=>o.jsxDEV(o.Fragment,{},void 0,!1,{fileName:"/home/runner/work/just-web-foundation/just-web-foundation/libs/css/src/css-properties/css-properties.stories.tsx",lineNumber:10,columnNumber:17},void 0)},e={tags:["!test"],parameters:t({description:{story:"Extends CSS properties to support custom properties."},source:{code:s`let style: CSSProperties = {
                color: 'red',
...
}`,...r.parameters?.docs?.source}}};const l=["TypeUsage","DefineFunction"];export{r as DefineFunction,e as TypeUsage,l as __namedExportsOrder,S as default};
