import{j as o}from"./iframe-CKVYuos1.js";import{s as S}from"./show_doc_source-DVUKVyw5.js";import{d as a}from"./define_docs_param-lmgaBKCF.js";import{d,a as u}from"./dedent-CN-vuQb3.js";const{expect:l}=__STORYBOOK_MODULE_TEST__,P={title:"CSS Properties/CSSProperties",tags:["autodocs","code-only","new","version:1.0"],decorators:[S()],render:()=>o.jsx(o.Fragment,{})},e={tags:["!test"],parameters:a({description:{story:"Extends CSS properties to support custom properties."},source:{code:d`let style: CSSProperties = {
                color: 'red',
...
}`,...(i=(c=r.parameters)==null?void 0:c.docs)==null?void 0:i.source}}};const g=["TypeUsage","DefineFunction"];export{r as DefineFunction,e as TypeUsage,g as __namedExportsOrder,P as default};
