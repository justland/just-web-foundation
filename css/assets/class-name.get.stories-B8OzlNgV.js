import{r as m,j as t}from"./iframe-CKVYuos1.js";import{d as o}from"./define_docs_param-lmgaBKCF.js";import{g as p}from"./class-name-k9bs-u1H.js";import{L as P}from"./log-panel-BNB6yPiP.js";import"./globals.ctx-DOXvZQDb.js";import"./attribute-BU07dUZA.js";import"./findKey-D_Zca1Sl.js";const{expect:u,userEvent:T}=__STORYBOOK_MODULE_TEST__,K={title:"theme/getThemeByClassName",tags:["autodocs","new","version:1.0.0"],parameters:o({description:{component:"A utility function that determines the current theme based on element class name."}})},c={parameters:o({description:{story:"Demonstrates how `getThemeByClassName` gets the current theme based on class names."}}),render:()=>{const[e,a]=m.useState(),s={light:"light",dark:"dark"};m.useEffect(()=>{const n=p({themes:s,defaultTheme:"dark"});a(n)},[]);const g=n=>{for(const[f,r]of Object.entries(s))f===n?document.documentElement.classList.add(r):document.documentElement.classList.remove(r);a(n)};return t.jsxs("div",{className:"p-4",children:[t.jsxs("div",{className:"mb-4 font-medium",children:[t.jsx("span",{className:"font-bold",children:"Current Theme:"})," ",t.jsx("span",{"data-testid":"current-theme",children:e})]}),t.jsx("div",{className:"flex gap-2",children:Object.keys(s).map(n=>t.jsx(_,{theme:n,onChange:g,currentTheme:e},n))})]})},play:async({canvas:e,step:a})=>{const s=e.getByRole("button",{name:"light"});await a("light",async()=>{await T.click(s),await u(e.getByTestId("current-theme")).toHaveTextContent("light")})}},l={parameters:o({description:{story:"Falls back to default theme when class name is not found."}}),loaders:[()=>(document.documentElement.classList.remove("light","dark"),{theme:p({themes:h,defaultTheme:"dark"})})],render:(e,{loaded:{theme:a}})=>{const s=document.documentElement.className;return t.jsxs("div",{className:"font-sans",children:[t.jsxs("p",{children:["Current theme: ",t.jsx("span",{"data-testid":"current-theme",children:a===void 0?"(undefined)":a})]}),t.jsxs("p",{children:["Class name: ",s===""?"(empty)":s]})]})},play:async({canvas:e})=>{await u(e.getByTestId("current-theme")).toHaveTextContent("dark")}},d={parameters:o({description:{story:"Gets theme from specific element."}}),render:()=>{const[e,a]=m.useState([]),[s,g]=m.useState(),n=m.useRef(null),f=m.useCallback(r=>{var b,k;if(!n.current)return;for(const[y,x]of Object.entries(h))y===r?(b=n.current)==null||b.classList.add(x):(k=n.current)==null||k.classList.remove(x);const v=p({themes:h,defaultTheme:"dark",element:n.current});g(v),a(y=>[...y,`theme: ${v}`])},[n.current]);return t.jsxs("div",{className:"font-sans",children:[t.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:Object.keys(h).map(r=>t.jsx(_,{theme:r,onChange:f,currentTheme:s},r))}),t.jsx("div",{ref:n,className:"p-4 border border-gray-300 mb-4",children:"Custom Element to observe"}),t.jsx(P,{title:"Theme by className",log:e})]})},play:async({canvas:e,step:a})=>{await a("light",async()=>{const s=e.getByRole("button",{name:"light"});await T.click(s),await u(e.getByText("theme: light")).toBeInTheDocument()}),await a("dark",async()=>{const s=e.getByRole("button",{name:"dark"});await T.click(s),await u(e.getByText("theme: dark")).toBeInTheDocument()})}},i={tags:["unit"],parameters:o({description:{story:"Falls back to default theme when class name is not found."}}),render:()=>{const e=p({themes:{light:"not-exist-theme-light",dark:"not-exist-theme-dark"},defaultTheme:"dark"});return t.jsxs("div",{children:["Current theme: ",e]})}},h={light:"light-theme",dark:"dark-theme"};function _({theme:e,onChange:a,currentTheme:s}){return t.jsx("button",{onClick:()=>a(e),className:`
                                px-4 py-2
                                rounded
                                font-medium
                                transition-colors
                                ${s===e?"bg-blue-600 text-white hover:bg-blue-700":"bg-gray-200 text-gray-800 hover:bg-gray-300"}
                            `,children:e})}var C,B,E;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(E=(B=c.parameters)==null?void 0:B.docs)==null?void 0:E.source}}};var w,N,j;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: defineDocsParam({
    description: {
...
}`,...(j=(N=l.parameters)==null?void 0:N.docs)==null?void 0:j.source}}};var L,R,D;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`{
  parameters: defineDocsParam({
    description: {
...
}`,...(D=(R=d.parameters)==null?void 0:R.docs)==null?void 0:D.source}}};var O,S,I;i.parameters={...i.parameters,docs:{...(O=i.parameters)==null?void 0:O.docs,source:{originalSource:`{
  tags: ['unit'],
  parameters: defineDocsParam({
    description: {
      story: 'Falls back to default theme when class name is not found.'
...
}`,...(I=(S=i.parameters)==null?void 0:S.docs)==null?void 0:I.source}}};const Y=["BasicUsage","DefaultTheme","CustomElement","InvalidTheme"];export{c as BasicUsage,d as CustomElement,l as DefaultTheme,i as InvalidTheme,Y as __namedExportsOrder,K as default};
