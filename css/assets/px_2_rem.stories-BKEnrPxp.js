...
}`,...(l=(x=r.parameters)==null?void 0:x.docs)==null?void 0:l.source}}};var u,N,g;p.parameters={...p.parameters,docs:{...(u=p.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render() {
    const examples = [{
      input: '16px',
      expected: '1.0000'
...
}`,...(g=(N=p.parameters)==null?void 0:N.docs)==null?void 0:g.source}}};var h,b,y;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render() {
    const examples = [{
      input: 20,
      base: 20,
