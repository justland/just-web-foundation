import{j as t}from"./iframe-CNjwlHfP.js";import{d as s,a as o}from"./dedent-qYDPJrKz.js";import"./preload-helper-Dp1pzeXC.js";function n(){return(A,{parameters:P})=>{var i,c;return t.jsxs("section",{style:{display:"flex",flexDirection:"column",gap:"1rem"},children:[t.jsx("pre",{children:(c=(i=P.docs)==null?void 0:i.source)==null?void 0:c.code}),t.jsx(A,{})]})}}const x={title:"Types/DataAttributeProps",tags:["code-only"],render:()=>t.jsx(t.Fragment,{})},e={parameters:s({description:{story:"Basic usage of DataAttributeProps with predefined attributes."},source:{code:o`
  ...
  decorators: [showDocSource()]
}`,...(D=(y=a.parameters)==null?void 0:y.docs)==null?void 0:D.source}}};const h=["BasicUsage","CustomDataAttributes","OptionalAttributes"];export{e as BasicUsage,r as CustomDataAttributes,a as OptionalAttributes,h as __namedExportsOrder,x as default};
