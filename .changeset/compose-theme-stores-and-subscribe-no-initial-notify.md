...
Add `composeThemeStores(stores, themes, defaultTheme)` for composing multiple theme stores into one. Waterfall read (first non-empty value), write-to-all, no initial notify on subscribe.
