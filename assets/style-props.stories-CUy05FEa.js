...
`,$={title:"style/StyleProps",tags:["type","version:next","!test"],render:()=>r.jsx(r.Fragment,{})},t={tags:["source"],parameters:p({source:{code:d}}),decorators:[e({content:r.jsxs("p",{children:[r.jsx("code",{children:"StyleProps"})," describes the standard type of the ",r.jsx("code",{children:"style"})," property."]})}),s()]},o={tags:["use-case","editor"],parameters:p({source:{code:m}}),decorators:[e({content:r.jsx("p",{children:"Use it by itself or combine with other props."})}),s()]};a(o,{availableImports:{"@just-web/toolkits":c,"@repobuddy/storybook":n,react:i},code:o.parameters?.docs?.source?.code});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  tags: ['source'],
...
}`,...o.parameters?.docs?.source}}};const oo=["Specification","BasicUsage"];export{o as BasicUsage,t as Specification,oo as __namedExportsOrder,$ as default};
