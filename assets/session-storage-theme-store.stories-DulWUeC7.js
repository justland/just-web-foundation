import{j as t,d as l,w as g,s as h,S as Y,r as m}from"./iframe-C_kByFhJ.js";import{d as y}from"./dedent-BuYMbVyj.js";import{t as i}from"./theme-entry-D4S_RAMB.js";import{d as G}from"./dummy-theme-store-DcCfgetv.js";import{p as M}from"./parse-stored-theme-Dj4VCwi6.js";import{B as p}from"./button-BMv5qOnG.js";import{T as v}from"./theme-result-card-_xtJMcHJ.js";import{T as D}from"./theme-store-demo-D-sqTBR_.js";import"./preload-helper-PPVm8Dsz.js";function u(e,s){const{storageKey:c}=s;if(typeof window>"u"||!window.sessionStorage)return G;const a=new Set;let T=S()?.theme??void 0;function S(){const d=M(e,window.sessionStorage.getItem(c));if(d!==void 0)return i(e,d)}function x(){const d=S(),b=d?.theme??void 0;if(b!==T){T=b;for(const E of a)E(d)}}return{read:S,write(d){try{d===void 0?window.sessionStorage.removeItem(c):window.sessionStorage.setItem(c,JSON.stringify(d)),x()}catch{}},subscribe(d){a.add(d);const b=E=>{E.key===c&&E.storageArea===window.sessionStorage&&x()};return window.addEventListener("storage",b),()=>{a.delete(d),window.removeEventListener("storage",b)}}}}const W=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
...
`,{expect:o,userEvent:w,waitFor:f}=__STORYBOOK_MODULE_TEST__,X={title:"theme/theme-store/sessionStorageThemeStore",tags:["func","version:next"],parameters:l({description:{component:"Theme store backed by sessionStorage. Persists per tab. Bakes themes at creation."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},n="theme-ss-demo",K={tags:["playground"],parameters:l({description:{story:"Interactive demo: Read theme, write themes via buttons, and observe subscribe updates."}}),decorators:[g(),h({source:y`
            ...
            `})],loaders:[()=>(window.sessionStorage.removeItem(n),{})],render:()=>{const e=m.useMemo(()=>u(r,{storageKey:n}),[]),[s,c]=m.useState(0),[a,T]=m.useState(null);m.useEffect(()=>e.subscribe(x=>{c(d=>d+1),T(x)}),[e]);const S=a?.theme??"(none)";return t.jsxs("div",{className:"flex flex-col gap-4","data-testid":"subscribe-only-when-theme-changes",children:[t.jsx(Y,{title:"Handler invocations",appearance:"output",children:t.jsx("pre",{"data-testid":"invocation-count",className:"font-mono",children:s})}),t.jsx(Y,{title:"Observed theme",appearance:"output",children:t.jsx("pre",{"data-testid":"observed-theme",className:"font-mono",children:S})}),t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(p,{"data-testid":"write-grayscale-twice",onPress:()=>{e.write(i(r,"grayscale")),e.write(i(r,"grayscale"))},children:"write(grayscale) twice"}),t.jsx(p,{"data-testid":"write-high-contrast",onPress:()=>e.write(i(r,"high-contrast")),children:"write(high-contrast)"})]})]})},play:async({canvas:e})=>{await o(e.getByTestId("invocation-count")).toHaveTextContent("0"),await w.click(e.getByTestId("write-grayscale-twice")),await f(()=>o(e.getByTestId("invocation-count")).toHaveTextContent("1")),await o(e.getByTestId("observed-theme")).toHaveTextContent("grayscale")}},_={name:"subscribe: unsubscribe",tags:["props"],parameters:l({description:{story:"After calling the function returned by subscribe(), further write() calls do not invoke the handler."}}),decorators:[g(),h({source:y`
                const store = sessionStorageThemeStore(themes, { storageKey: 'theme' })
                const unsubscribe = store.subscribe((theme) => console.log(theme))
                store.write(themeEntry(themes, 'grayscale'))
                unsubscribe()
                store.write(themeEntry(themes, 'current')) // handler not called
            `})],loaders:[()=>(window.sessionStorage.removeItem(n),{})],render:()=>{const e=m.useMemo(()=>u(r,{storageKey:n}),[]),[s,c]=m.useState(void 0),a=m.useRef(null);m.useEffect(()=>{if(!a.current)return a.current=e.subscribe(c),()=>{a.current?.(),a.current=null}},[e]);const T=s?.theme??"current";return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(p,{"data-testid":"write-grayscale",onPress:()=>e.write(i(r,"grayscale")),children:"write('grayscale')"}),t.jsx(p,{"data-testid":"write-current",onPress:()=>e.write(i(r,"current")),children:"write('current')"}),t.jsx(p,{"data-testid":"unsubscribe",onPress:()=>{a.current?.(),a.current=null},children:"unsubscribe()"})]}),t.jsx(v,{title:"store.subscribe() receives (frozen after unsubscribe)","data-testid":"store-subscribe-result",result:i(r,T)})]})},play:async({canvas:e})=>{await w.click(e.getByTestId("write-grayscale")),await f(()=>o(e.getByTestId("store-subscribe-result")).toHaveTextContent("grayscale")),await w.click(e.getByTestId("unsubscribe")),await w.click(e.getByTestId("write-current")),await o(e.getByTestId("store-subscribe-result")).toHaveTextContent("grayscale")}},A={tags:["source"],parameters:l({source:{code:W}}),decorators:[h()]};K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  tags: ['playground'],
