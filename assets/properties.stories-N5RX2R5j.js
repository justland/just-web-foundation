import{j as o}from"./jsx-dev-runtime-DF-ftqEI.js";import{d as p}from"./properties-Dh8E5HRZ.js";import{s as c,d as t}from"./iframe-C5Vrn5k7.js";import{d as s}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";const{expect:i}=__STORYBOOK_MODULE_TEST__,f={title:"Properties/Properties",tags:["autodocs","code-only","new","version:next"],decorators:[c()],render:()=>o.jsxDEV(o.Fragment,{},void 0,!1,{fileName:"/home/runner/work/just-web-foundation/just-web-foundation/libs/css/src/properties/properties.stories.tsx",lineNumber:10,columnNumber:17},void 0)},e={tags:["!test"],parameters:t({description:{story:"Extends CSS properties to support custom properties."},source:{code:s`let style: Properties = {
                color: 'red',
            ...
            `}})},r={parameters:t({description:{story:"Helper function to define CSS properties with type checking."},source:{code:s`const style = defineProperties({
                ...
                fontSize: '16px',
                '--custom-property': '10px'
            })`}}),play:async()=>{const n=p({color:"red",fontSize:"16px","--custom-property":"10px"});await i(n).toEqual({color:"red",fontSize:"16px","--custom-property":"10px"})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  tags: ['!test'],
