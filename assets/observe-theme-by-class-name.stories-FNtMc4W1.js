import{j as e,d as v,w as f,s as T,r as o,S as l}from"./iframe-DpiIn1Pa.js";import{d as k}from"./dedent-BuYMbVyj.js";import{o as x}from"./observe-theme-by-class-name-kXOk-X-U.js";import{s as w}from"./set-theme-by-class-name-Bavj7Osw.js";import{u as C}from"./use-attribute-av9Vq1Nf.js";import{B as g}from"./button-DwHF6N6V.js";import"./preload-helper-PPVm8Dsz.js";import"./class-name-theme-store-IC1hzE--.js";import"./observe-attribute-DJMrXwPX.js";import"./findKey-BZZwGHNT.js";import"./resolve-class-name-ma8rMboq.js";const B=`import { classNameThemeStore } from './class-name-theme-store.ts'
...
`,{expect:c,userEvent:m}=__STORYBOOK_MODULE_TEST__,y={light:["your-light-class","app:text-black","app:bg-white"],dark:["your-dark-class","app:text-white","app:bg-black"]},d={light:"your-light-class",dark:"your-dark-class"},D={title:"theme/observeThemeByClassName",tags:["func","version:next"],parameters:v({description:{component:"Observes element class changes and invokes a handler when the theme (by class) changes."}}),render:()=>e.jsx(e.Fragment,{})},h={tags:["use-case"],decorators:[f({content:e.jsxs("p",{children:["Observe theme changes on ",e.jsx("code",{children:"document.documentElement.className"}),"."]})}),T({source:k`
                observeThemeByClassName({
                  themes: { light: 'your-light-class', dark: 'your-dark-class' },
                  handler: (value) => setTheme(value)
                })
            `})],render:()=>{const[t,s]=o.useState(),[a,r]=o.useState();return o.useEffect(()=>{const n=x({themes:{light:"your-light-class",dark:"your-dark-class"},handler:b=>{s(b),r(document.documentElement.className)}});return()=>n.disconnect()},[]),e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex gap-2",children:Object.keys(d).map(n=>e.jsx(g,{onPress:()=>w({themes:d,theme:n}),children:n},n))}),e.jsx(l,{title:"Theme",appearance:"output",children:e.jsx("code",{"data-testid":"theme",children:t??"(empty)"})}),e.jsx(l,{title:"documentElement.className",appearance:"output",children:e.jsx("code",{"data-testid":"document-class-name",children:a??"(empty)"})})]})},play:async({canvas:t,step:s})=>{await s("(empty) -> light",async()=>{const a=t.getByRole("button",{name:"light"});await m.click(a),await c(t.getByTestId("theme")).toHaveTextContent("light")}),await s("light -> dark",async()=>{const a=t.getByRole("button",{name:"dark"});await m.click(a),await c(t.getByTestId("theme")).toHaveTextContent("dark")})}},i={tags:["use-case"],parameters:v({description:{story:"Theme keys can map to different class values (e.g. your-light-theme, your-dark-theme)."}}),decorators:[f({content:e.jsxs("p",{children:["When a theme value is an array, only the ",e.jsx("strong",{children:"first"})," value is used to determine the theme."]})}),T({source:k`
                observeThemeByClassName({
                    themes: {
            ...
            `})],render:()=>{const[t,s]=o.useState(),[a,r]=o.useState();return o.useEffect(()=>{const n=x({themes:y,handler:b=>{s(b),r(document.documentElement.className)}});return()=>n.disconnect()},[]),e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex gap-2",children:Object.keys(y).map(n=>e.jsx(g,{onPress:()=>w({themes:y,theme:n}),children:n},n))}),e.jsx(l,{title:"Theme",appearance:"output",children:e.jsx("code",{"data-testid":"theme",children:t??"(empty)"})}),e.jsx(l,{title:"documentElement.className",appearance:"output",children:e.jsx("code",{"data-testid":"document-class-name",children:a??"(empty)"})})]})},play:async({canvas:t,step:s})=>{await s("(empty) -> light",async()=>{const a=t.getByRole("button",{name:"light"});await m.click(a),await c(t.getByTestId("theme")).toHaveTextContent("light")}),await s("light -> dark",async()=>{const a=t.getByRole("button",{name:"dark"});await m.click(a),await c(t.getByTestId("theme")).toHaveTextContent("dark")})}},u={name:"With defaultTheme",tags:["use-case"],parameters:v({description:{story:"When class is cleared, handler receives defaultTheme instead of undefined."}}),decorators:[f(),T({source:k`
                observeThemeByClassName({
                  themes: { light: 'your-light-class', dark: 'your-dark-class' },
                  handler: (value) => setTheme(value),
                  defaultTheme: 'light',
                })
            `})],render:()=>{const[t,s]=o.useState(),[a]=C("class");return o.useEffect(()=>{const r=x({defaultTheme:"unset",themes:d,handler:n=>{s(n)}});return()=>r.disconnect()},[]),e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsxs("div",{className:"flex gap-2",children:[Object.keys(y).map(r=>e.jsx(g,{onPress:()=>w({themes:d,theme:r}),children:r},r)),e.jsx(g,{onPress:()=>{document.documentElement.classList.remove(...Object.values(d))},children:"Clear"})]}),e.jsx(l,{title:"Theme",appearance:"output",children:e.jsx("code",{"data-testid":"theme",children:t??"(empty)"})}),e.jsx(l,{title:"documentElement.className",appearance:"output",children:e.jsx("code",{"data-testid":"document-class-name",children:a??"(empty)"})})]})},play:async({canvas:t,step:s})=>{await s("(empty) -> light",async()=>{const a=t.getByRole("button",{name:"light"});await m.click(a),await c(t.getByTestId("theme")).toHaveTextContent("light")}),await s("light -> dark",async()=>{const a=t.getByRole("button",{name:"dark"});await m.click(a),await c(t.getByTestId("theme")).toHaveTextContent("dark")}),await s("dark -> unset (defaultTheme)",async()=>{const a=t.getByRole("button",{name:"Clear"});await m.click(a),await c(t.getByTestId("theme")).toHaveTextContent("unset")})}},p={tags:["source"],parameters:v({source:{code:B}}),decorators:[T()]};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...p.parameters?.docs?.source}}};const A=["BasicUsage","WithThemeArray","WithDefaultTheme","Source"];export{h as BasicUsage,p as Source,u as WithDefaultTheme,i as WithThemeArray,A as __namedExportsOrder,D as default};
