import{r as o,j as t,d as l,w as T,s as g,S as d}from"./iframe-C_U-moo6.js";import{d as S}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as B}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as b}from"./theme-entry-D4S_RAMB.js";import{l as K}from"./local-storage-theme-store-CJ-Q1lx0.js";import{B as h}from"./button-DneSEyY1.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-theme-map-value-6BKppRxh.js";import"./parse-stored-theme-CqNOdFO7.js";function f(e,a){const{storageKey:y,defaultTheme:i}=a,r=o.useMemo(()=>K(e,{storageKey:y}),[e,y]),[x,v]=o.useState(()=>r.read()?.theme??i);return o.useEffect(()=>E([r],i,v),[r,i]),[x,o.useCallback(w=>{B([r],b(e,w))},[r,e])]}const C=`import { useCallback, useEffect, useMemo, useState } from 'react'
...
`,{expect:u,userEvent:p}=__STORYBOOK_MODULE_TEST__,s="use-theme-by-local-storage-story",k={light:"theme-light",dark:"theme-dark"},Y={title:"react/hooks/useThemeByLocalStorage",tags:["func","version:1.0"],parameters:l({description:{component:"React hook that returns the current theme (from localStorage) and a setter. Subscribes to storage changes so the returned theme stays in sync across tabs."}}),render:()=>t.jsx(t.Fragment,{})},n={parameters:l({description:{story:"Observe and set theme from localStorage. The theme persists across page reloads and stays in sync across browser tabs via StorageEvent."},source:{code:S`
                ...
                setTheme('dark')
                setTheme('light')
            `}}),decorators:[T(),g()],render:()=>{const[e,a]=f(k,{storageKey:s,defaultTheme:"light"});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(h,{onPress:()=>a("light"),children:"Set light"}),t.jsx(h,{onPress:()=>a("dark"),children:"Set dark"})]}),t.jsx(d,{title:"Current theme (from localStorage)",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})]})},afterEach:()=>{window.localStorage.removeItem(s)},play:async({canvas:e,step:a})=>{await a("Set dark",async()=>{await p.click(e.getByRole("button",{name:"Set dark"})),await u(e.getByTestId("current-theme")).toHaveTextContent("dark")}),await a("Set light",async()=>{await p.click(e.getByRole("button",{name:"Set light"})),await u(e.getByTestId("current-theme")).toHaveTextContent("light")})}},m={parameters:l({description:{story:"Pass options.storageKey to control the localStorage key used for persistence."},source:{code:S`
                const [theme, setTheme] = useThemeByLocalStorage(themes, {
                    storageKey: 'my-app-theme',
                    defaultTheme: 'light'
                })
            `}}),decorators:[T(),g()],render:()=>{const[e,a]=f(k,{storageKey:s,defaultTheme:"light"});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(h,{onPress:()=>a("light"),children:"Set light"}),t.jsx(h,{onPress:()=>a("dark"),children:"Set dark"})]}),t.jsx(d,{title:"localStorage key",appearance:"output",children:t.jsx("pre",{"data-testid":"storage-key",className:"font-mono",children:s})}),t.jsx(d,{title:"Current theme",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})]})},afterEach:()=>{window.localStorage.removeItem(s)},play:async({canvas:e})=>{await p.click(e.getByRole("button",{name:"Set dark"})),await u(e.getByTestId("current-theme")).toHaveTextContent("dark")}},c={tags:["source"],parameters:l({source:{code:C}}),decorators:[g()]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...c.parameters?.docs?.source}}};const A=["BasicUsage","StorageKey","Source"];export{n as BasicUsage,c as Source,m as StorageKey,A as __namedExportsOrder,Y as default};
