import{r as h,j as t,d as l,w as g,s as b,S as y}from"./iframe-Bfba1fzs.js";import{d as x}from"./dedent-BuYMbVyj.js";import{o as w}from"./observe-attribute-DJMrXwPX.js";import{B as n}from"./button-BhNVXRt-.js";import"./preload-helper-PPVm8Dsz.js";function f(e,a=typeof document<"u"?document.documentElement:void 0){const[o,u]=h.useState(()=>a?.getAttribute(e)??null);return h.useEffect(()=>{if(!a)return;u(a.getAttribute(e));const i=w({[e]:T=>{u(T)}},a);return()=>i.disconnect()},[a,e]),[o,h.useCallback(i=>{a&&(i===null?a.removeAttribute(e):a.setAttribute(e,i))},[a,e])]}const E=`import { useCallback, useEffect, useState } from 'react'
