import{j as e,w as t,s as o,d as i,S as d,c as l}from"./iframe-DMM-er1z.js";import{d as c}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";const v={title:"class-name/clsx",tags:["func","version:next"],render:()=>e.jsx(e.Fragment,{})},s={decorators:[t({content:e.jsx(e.Fragment,{children:e.jsxs("p",{children:["Re-export of the"," ",e.jsx("code",{children:e.jsx("a",{href:"https://github.com/lukeed/clsx",target:"_blank",rel:"noopener noreferrer",children:"clsx"})})," ","package, adjusted to work better in ESM environments. Use it to construct"," ",e.jsx("code",{children:"className"})," strings conditionally from strings, objects, and arrays."]})})}),o({source:c`function clsx(...inputs: ClassValue[]): string`})]},r={tags:["use-case"],parameters:i({description:{story:"Combine multiple class name strings. Falsy values are ignored."}}),decorators:[t(),o({source:c`clsx('base', 'active', 'rounded')`})],render(){return e.jsx(d,{appearance:"output",children:e.jsxs("div",{children:["Result: ",e.jsx("code",{children:l("base","active","rounded")})]})})}},a={name:"conditional classes",tags:["use-case"],parameters:i({description:{story:"Use objects for conditional classes: keys are class names, values are conditions. Only truthy values are included."}}),decorators:[t(),o({source:c`clsx('btn', {
        'btn-active': isActive,
