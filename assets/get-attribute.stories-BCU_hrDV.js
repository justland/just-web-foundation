import{j as t,d as n,w as m,s as i,S as c}from"./iframe-OsVFjRjO.js";import{d}from"./dedent-BuYMbVyj.js";import{g as l}from"./get-attribute-BI4biMNS.js";import"./preload-helper-PPVm8Dsz.js";const f=`/**
...
`,N={title:"attributes/getAttribute",tags:["func","version:next"],parameters:n({description:{component:"A utility function to get attribute values from DOM element"}}),argTypes:{qualifiedName:{control:"text"},element:{control:!1}},args:{qualifiedName:"data-subject"},render:()=>t.jsx(t.Fragment,{})},a={parameters:n({description:{story:"By default, gets the value of an attribute from document root"},source:{code:d`
                document.documentElement.setAttribute('data-theme', 'some value')
                console.log(getAttribute('data-theme'))
                `}}),loaders:[({args:{qualifiedName:e}})=>{document.documentElement.setAttribute(e,"some value")}],decorators:[m(),i()],render(e){const r=l(e.qualifiedName);return t.jsx(c,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(r,null,2)})})}},o={args:{qualifiedName:"data-custom"},parameters:n({description:{story:"Gets an attribute value from a specific element"},source:{code:d`
                const element = document.createElement('div')
                element.setAttribute(qualifiedName, 'test-value')
                const value = getAttribute(qualifiedName, element)
            `}}),decorators:[m(),i()],render(e){const r=document.createElement("div");r.setAttribute(e.qualifiedName,"test-value");const p=l(e.qualifiedName,r);return t.jsx(c,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(p,null,2)})})}},s={tags:["unit"],args:{qualifiedName:"data-not-exist"},parameters:n({description:{story:"Returns null when trying to get a non-existent attribute"},source:{code:d`
                console.log(getAttribute('data-not-exist'))
            `}}),decorators:[m(),i()],render(e){const r=l(e.qualifiedName);return t.jsx(c,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(r,null,2)})})}},u={tags:["source"],parameters:n({source:{code:f}}),decorators:[i()]};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
