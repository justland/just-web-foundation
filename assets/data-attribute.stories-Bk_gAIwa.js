import{j as t,d as l,w as i,s as d,r as v,S as g}from"./iframe-Ds1H5bIE.js";import{d as c}from"./dedent-BuYMbVyj.js";import{t as m}from"./theme-entry-D4S_RAMB.js";import{r as h,w as p,a as O,p as k,s as W}from"./write-data-attribute-CRBlNUMN.js";import{B as F}from"./button-DN0NMyAj.js";import{T as y}from"./theme-result-card-s1nzIxT7.js";import{T as V}from"./theme-store-demo-CKiy_IMv.js";import"./preload-helper-PPVm8Dsz.js";import"./get-data-attribute-Bl9c_7h4.js";import"./get-attribute-BI4biMNS.js";import"./observe-data-attribute-CrIGpGqK.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-BZZwGHNT.js";const{expect:n,userEvent:L,waitFor:M}=__STORYBOOK_MODULE_TEST__,ne={title:"theme/data-attribute",tags:["func","version:1.0"],parameters:l({description:{component:"Low-level functions for reading and writing theme via data attributes: readDataAttribute, writeDataAttribute, subscribeDataAttribute, parseDataAttribute, stringifyDataAttribute."}}),render:()=>t.jsx(t.Fragment,{})},a={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},r="data-theme";function K(e=document.documentElement,o=r){return{read:()=>h(a,o,{element:e}),write:s=>p(a,o,s,{element:e}),subscribe:s=>O(a,o,s,{element:e})}}const f={tags:["playground"],parameters:l({description:{story:"Interactive demo: readDataAttribute, writeDataAttribute, subscribeDataAttribute used together."}}),decorators:[i(),d({source:c`
                const store = {
