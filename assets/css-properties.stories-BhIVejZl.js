import{j as o,s as p,d as t}from"./iframe-BBwWFqlk.js";import{d as s}from"./dedent-BuYMbVyj.js";import{d as c}from"./css-properties-Dh8E5HRZ.js";import"./preload-helper-PPVm8Dsz.js";const{expect:i}=__STORYBOOK_MODULE_TEST__,u={title:"CSS Properties/CSSProperties",tags:["autodocs","code-only","new","version:1.0"],decorators:[p()],render:()=>o.jsx(o.Fragment,{})},e={tags:["!test"],parameters:t({description:{story:"Extends CSS properties to support custom properties."},source:{code:s`let style: CSSProperties = {
                color: 'red',
...
}`,...r.parameters?.docs?.source}}};const l=["TypeUsage","DefineFunction"];export{r as DefineFunction,e as TypeUsage,l as __namedExportsOrder,u as default};
