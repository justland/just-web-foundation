import{r as i,j as t,d as m,w as d,s as c,S as l}from"./iframe-C_U-moo6.js";import{d as u}from"./dedent-BuYMbVyj.js";import{t as b}from"./theme-entry-D4S_RAMB.js";import{c as j}from"./class-name-theme-store-ByoKXHZe.js";import{l as E}from"./local-storage-theme-store-CJ-Q1lx0.js";import{c as H}from"./create-theme-hook-BSNQew6H.js";import{i as f}from"./in-memory-theme-store-fTg_sUo_.js";import{B as n}from"./button-DneSEyY1.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-theme-map-value-6BKppRxh.js";import"./findKey-BZZwGHNT.js";import"./parse-stored-theme-CqNOdFO7.js";import"./compose-theme-stores-CD86eyKP.js";import"./set-theme-to-stores-C1AbMsOJ.js";function p(e,r,o){return H(e,i.useMemo(()=>typeof r=="function"?r():r,[]),o)(o?.defaultTheme)}const M=`import { useMemo } from 'react'
import type {
...
`,{expect:a,userEvent:y,waitFor:h}=__STORYBOOK_MODULE_TEST__,s={light:"theme-light",dark:"theme-dark",system:"theme-system"},Q={title:"react/hooks/useThemeStores",tags:["func","version:1.0"],parameters:m({description:{component:"React hook that returns the current theme and a setter for composed theme stores. Delegates to createThemeHook internally. Simpler API than createThemeHook—pass themes, stores, and options once.\n\n**stores** can be a factory `() => [store1, ...]` (recommended, no memoization needed) or an array `[store1, ...]` (must be memoized or ref-stable; recreating the array each render breaks subscriptions)."}}),render:()=>t.jsx(t.Fragment,{})},S={tags:["use-case"],parameters:m({description:{story:"With an in-memory store and defaultTheme, useThemeStores returns [theme, setTheme]. setTheme updates the store and the returned theme stays in sync. Uses the factory form so no memoization is needed."},source:{code:u`
                ...
                setTheme('dark')
            `}}),decorators:[d(),c()],render:()=>{const[e,r]=p(s,()=>[f(s)],{defaultTheme:"light"});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:()=>r("light"),children:"Set light"}),t.jsx(n,{onPress:()=>r("dark"),children:"Set dark"}),t.jsx(n,{onPress:()=>r("system"),children:"Set system"})]}),t.jsx(l,{title:"Current theme",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})]})},play:async({canvas:e,step:r})=>{await r("Initial state is defaultTheme",async()=>{await a(e.getByTestId("current-theme")).toHaveTextContent("light")}),await r("Set dark",async()=>{await y.click(e.getByRole("button",{name:"Set dark"})),await h(()=>a(e.getByTestId("current-theme")).toHaveTextContent("dark"),{timeout:2e3})}),await r("Set system",async()=>{await y.click(e.getByRole("button",{name:"Set system"})),await h(()=>a(e.getByTestId("current-theme")).toHaveTextContent("system"),{timeout:2e3})})}},P=i.createContext(null);function I({children:e,initialTheme:r}){const o=i.useMemo(()=>{const T=f(s);return r!==void 0&&T.write?.(b(s,r)),T},[r]);return t.jsx(P.Provider,{value:o,children:e})}function N(){const e=i.useContext(P);if(!e)throw new Error("ThemeProvider required");const[r,o]=p(s,()=>[e],{defaultTheme:"light"}),T=i.useCallback(()=>o("light"),[o]),F=i.useCallback(()=>o("dark"),[o]);return t.jsxs(l,{title:"Theme from store in Context","data-testid":"store-from-context-demo",appearance:"output",children:[t.jsxs("p",{children:["theme:"," ",t.jsx("span",{"data-testid":"store-from-context-theme",children:r===void 0?"(undefined)":String(r)})]}),t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:T,"data-testid":"store-from-context-btn-light",children:"Set light"}),t.jsx(n,{onPress:F,"data-testid":"store-from-context-btn-dark",children:"Set dark"})]})]})}const g={name:"React Context theme store",tags:["use-case"],parameters:m({description:{story:"Context provides the store instance (e.g. inMemoryThemeStore) for subtree scoping. Each ThemeProvider creates its own store; descendants get it via useContext and pass to useThemeStores. Simpler than implementing a ThemeStore with Context as the storage backend."},source:{code:u`
            ...
            `}}),decorators:[d(),c()],render:()=>t.jsx(I,{initialTheme:"dark",children:t.jsx(N,{})}),play:async({canvas:e})=>{const r=()=>e.getByTestId("store-from-context-theme"),o=()=>e.getByTestId("store-from-context-btn-light"),T=()=>e.getByTestId("store-from-context-btn-dark");await h(async()=>{await a(r()).toHaveTextContent("dark")},{timeout:2e3}),await y.click(o()),await h(async()=>{await a(r()).toHaveTextContent("light")},{timeout:2e3}),await y.click(T()),await h(async()=>{await a(r()).toHaveTextContent("dark")},{timeout:2e3})}},x={name:"store with initial value",tags:["props"],parameters:m({description:{story:"When the store already has a value, the hook returns it on first render."},source:{code:u`
