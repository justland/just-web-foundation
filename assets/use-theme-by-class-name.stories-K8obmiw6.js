import{r as u,j as s,d as l,w as f,s as p,S as y}from"./iframe-DMM-er1z.js";import{d as k}from"./dedent-BuYMbVyj.js";import{o as b}from"./observe-attribute-DJMrXwPX.js";import{g as T}from"./get-theme-by-class-name--buxm-w-.js";import{s as B}from"./set-theme-by-class-name-BC2y_ikC.js";import{B as o}from"./button-DdvamnXn.js";import"./preload-helper-PPVm8Dsz.js";import"./findKey-BZZwGHNT.js";import"./resolve-class-name-kQ6qcblf.js";function v(e){const t=e.element??(typeof document<"u"?document.documentElement:void 0),[a,n]=u.useState(()=>t?T({themes:e.themes,defaultTheme:e.defaultTheme,element:t}):e.defaultTheme);u.useEffect(()=>{if(!t)return;n(T({themes:e.themes,defaultTheme:e.defaultTheme,element:t}));const g=b({class:()=>{n(T({themes:e.themes,defaultTheme:e.defaultTheme,element:t}))}},t);return()=>g.disconnect()},[t,e.themes,e.defaultTheme]);const S=u.useCallback(g=>{t&&B({themes:e.themes,theme:g,element:t})},[t,e.themes]);return[a,S]}const C=`import { useCallback, useEffect, useState } from 'react'
...
}`,...i.parameters?.docs?.source}}};const M=["BasicUsage","CustomElement","SyncFromElsewhere","Source"];export{h as BasicUsage,c as CustomElement,i as Source,d as SyncFromElsewhere,M as __namedExportsOrder,I as default};
