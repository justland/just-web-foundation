import{j as t,d as l,w as h,s as m,S as M,r as u}from"./iframe-C_U-moo6.js";import{d as g}from"./dedent-BuYMbVyj.js";import{t as i}from"./theme-entry-D4S_RAMB.js";import{d as W}from"./resolve-theme-map-value-6BKppRxh.js";import{p as F}from"./parse-stored-theme-CqNOdFO7.js";import{B as w}from"./button-DneSEyY1.js";import{T as y}from"./theme-result-card-B1AduhOD.js";import{T as J}from"./theme-store-demo-Dk8oBi7r.js";import"./preload-helper-PPVm8Dsz.js";function d(e,s){const{storageKey:a,parse:o=F}=s;if(typeof window>"u"||!window.sessionStorage)return W;const T=new Set;let x=S()?.theme??void 0;function S(){return o(e,window.sessionStorage.getItem(a)??void 0)}function E(){const p=S(),f=p?.theme??void 0;if(f!==x){x=f;for(const K of T)K(p)}}return{read:S,write(p){try{p===void 0?window.sessionStorage.removeItem(a):window.sessionStorage.setItem(a,JSON.stringify(p)),E()}catch{}},subscribe(p){T.add(p);const f=K=>{K.key===a&&K.storageArea===window.sessionStorage&&E()};return window.addEventListener("storage",f),()=>{T.delete(p),window.removeEventListener("storage",f)}}}}const L=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
...
`,{expect:n,userEvent:v,waitFor:b}=__STORYBOOK_MODULE_TEST__,re={title:"theme/theme-store/sessionStorageThemeStore",tags:["func","version:1.0"],parameters:l({description:{component:"Theme store backed by sessionStorage. Persists per tab. Bakes themes at creation."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},c="theme-ss-demo",I={tags:["playground"],parameters:l({description:{story:"Interactive demo: Read theme, write themes via buttons, and observe subscribe updates."}}),decorators:[h(),m({source:g`
            ...
            `})],loaders:[()=>{window.sessionStorage.removeItem(Y);const e=d(r,{storageKey:Y});return e.write(i(r,"current")),{store:e}}],render:(e,{loaded:{store:s}})=>{const a=s.read();return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(y,{title:"store.read() result","data-testid":"store-read-result",result:a??{theme:"current",value:r.current}})})},play:async({canvas:e})=>{await n(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await n(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},G={current:"theme-current",grayscale:["theme-grayscale","app:bg-gray-100"],"high-contrast":"theme-high-contrast"},O={name:"themes: array values",tags:["use-case","props"],parameters:l({description:{story:"themes values can be string[]. Stored and retrieved value is the full array."}}),decorators:[h({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"string[]"}),". ",t.jsx("code",{children:"ThemeResult.value"})," persists the full array."]})}),m({source:g`
                ...
                const store = sessionStorageThemeStore(themes, { storageKey: 'theme' })
            `})],loaders:[()=>{window.sessionStorage.removeItem(Y);const e=d(G,{storageKey:Y});return e.write(i(G,"grayscale")),{store:e}}],render:(e,{loaded:{store:s}})=>{const a=s.read();return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(y,{title:"store.read() result","data-testid":"store-read-result",result:a??{theme:"grayscale",value:G.grayscale}})})},play:async({canvas:e})=>{await n(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await n(e.getByTestId("store-read-result")).toHaveTextContent("value: [theme-grayscale, app:bg-gray-100]")}},j={name:"read",tags:["props"],parameters:l({description:{story:"store.read() reads the current theme from sessionStorage."}}),decorators:[h(),m({source:g`
                const store = sessionStorageThemeStore(themes, { storageKey: 'theme' })
            ...
            `})],loaders:[()=>(window.sessionStorage.removeItem(c),{})],render:()=>{const e=u.useMemo(()=>d(r,{storageKey:c}),[]),[s,a]=u.useState(void 0),o=u.useRef(null);u.useEffect(()=>{if(!o.current)return o.current=e.subscribe(a),()=>{o.current?.(),o.current=null}},[e]);const T=s?.theme??"current";return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(w,{"data-testid":"write-grayscale",onPress:()=>e.write(i(r,"grayscale")),children:"write('grayscale')"}),t.jsx(w,{"data-testid":"write-current",onPress:()=>e.write(i(r,"current")),children:"write('current')"}),t.jsx(w,{"data-testid":"unsubscribe",onPress:()=>{o.current?.(),o.current=null},children:"unsubscribe()"})]}),t.jsx(y,{title:"store.subscribe() receives (frozen after unsubscribe)","data-testid":"store-subscribe-result",result:i(r,T)})]})},play:async({canvas:e})=>{await v.click(e.getByTestId("write-grayscale")),await b(()=>n(e.getByTestId("store-subscribe-result")).toHaveTextContent("grayscale")),await v.click(e.getByTestId("unsubscribe")),await v.click(e.getByTestId("write-current")),await n(e.getByTestId("store-subscribe-result")).toHaveTextContent("grayscale")}},k={tags:["source"],parameters:l({source:{code:L}}),decorators:[m()]};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  tags: ['playground'],
