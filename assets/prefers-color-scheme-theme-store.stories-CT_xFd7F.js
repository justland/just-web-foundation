import{j as r,w as u,s as n,d as p,r as c}from"./iframe-BIKclg0F.js";import{d as S}from"./dedent-BuYMbVyj.js";import{t as y}from"./theme-entry-D4S_RAMB.js";import{c as b}from"./compose-theme-stores-CD86eyKP.js";import{g as k}from"./get-prefers-color-scheme-C16oSBYU.js";import{o as C}from"./observe-prefers-color-scheme-DjdBdD7G.js";import{T as g}from"./theme-result-card-DV_WU9Fr.js";import{T as v}from"./theme-store-demo-H6CJd2XO.js";import"./preload-helper-PPVm8Dsz.js";import"./set-theme-to-stores-C1AbMsOJ.js";import"./button-Cg48NM-D.js";function w(e,t){return y(e,k("light"))}function x(e,t){return C(o=>t(y(e,o)))}function T(e){return{read(){return w(e)},subscribe(t){return x(e,t)}}}const P=`import type { RequiredPick } from 'type-plus'
...
`,{expect:f,userEvent:R}=__STORYBOOK_MODULE_TEST__,U={title:"theme/theme-store/prefersColorSchemeThemeStore",tags:["func","version:2.0"],render:()=>r.jsx(r.Fragment,{})},s={light:"theme-light",dark:"theme-dark"},h={tags:["playground"],decorators:[u({content:r.jsxs("p",{children:[r.jsx("code",{children:"prefersColorSchemeThemeStore"})," is a read-only theme store for color-scheme only. Themes must include only ",r.jsx("code",{children:"light"})," and ",r.jsx("code",{children:"dark"})," keys—mirrors"," ",r.jsx("code",{children:"prefers-color-scheme"}),". Returns ",r.jsx("code",{children:"ThemeEntry"})," for ",r.jsx("code",{children:"light"})," ","or ",r.jsx("code",{children:"dark"})," based on system preference. No write method."]})}),n({source:S`
