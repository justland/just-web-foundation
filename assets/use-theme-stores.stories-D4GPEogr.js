import{r as i,j as t,d as m,w as d,s as c,S as l}from"./iframe-y78tOg11.js";import{d as u}from"./dedent-BuYMbVyj.js";import{t as b}from"./theme-entry-D4S_RAMB.js";import{c as j}from"./class-name-theme-store-DrsKnZEX.js";import{l as E}from"./local-storage-theme-store-DfrGUHsD.js";import{c as H}from"./create-theme-hook-QgrBHX58.js";import{i as f}from"./in-memory-theme-store-CtdmAzEM.js";import{B as n}from"./button-DtUQWtfd.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";import"./write-class-name-Dm6FqN7r.js";import"./observe-attribute-CZKLLp6I.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-BZZwGHNT.js";import"./write-local-storage-CF1YWIKZ.js";import"./write-web-storage-DRJlRT-M.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./compose-theme-stores-CD86eyKP.js";import"./set-theme-to-stores-C1AbMsOJ.js";function p(e,r,s){return H(e,i.useMemo(()=>typeof r=="function"?r():r,[]),s)(s?.defaultTheme)}const M=`import { useMemo } from 'react'
import type {
...
`,{expect:a,userEvent:y,waitFor:h}=__STORYBOOK_MODULE_TEST__,o={light:"theme-light",dark:"theme-dark",system:"theme-system"},ee={title:"react/hooks/useThemeStores",tags:["func","version:1.0"],parameters:m({description:{component:"React hook that returns the current theme and a setter for composed theme stores. Delegates to createThemeHook internally. Simpler API than createThemeHook—pass themes, stores, and options once.\n\n**stores** can be a factory `() => [store1, ...]` (recommended, no memoization needed) or an array `[store1, ...]` (must be memoized or ref-stable; recreating the array each render breaks subscriptions)."}}),render:()=>t.jsx(t.Fragment,{})},S={tags:["use-case"],parameters:m({description:{story:"With an in-memory store and defaultTheme, useThemeStores returns [theme, setTheme]. setTheme updates the store and the returned theme stays in sync. Uses the factory form so no memoization is needed."},source:{code:u`
                ...
                setTheme('dark')
            `}}),decorators:[d(),c()],render:()=>{const[e,r]=p(o,()=>[f(o)],{defaultTheme:"light"});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:()=>r("light"),children:"Set light"}),t.jsx(n,{onPress:()=>r("dark"),children:"Set dark"}),t.jsx(n,{onPress:()=>r("system"),children:"Set system"})]}),t.jsx(l,{title:"Current theme",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})]})},play:async({canvas:e,step:r})=>{await r("Initial state is defaultTheme",async()=>{await a(e.getByTestId("current-theme")).toHaveTextContent("light")}),await r("Set dark",async()=>{await y.click(e.getByRole("button",{name:"Set dark"})),await h(()=>a(e.getByTestId("current-theme")).toHaveTextContent("dark"),{timeout:2e3})}),await r("Set system",async()=>{await y.click(e.getByRole("button",{name:"Set system"})),await h(()=>a(e.getByTestId("current-theme")).toHaveTextContent("system"),{timeout:2e3})})}},P=i.createContext(null);function I({children:e,initialTheme:r}){const s=i.useMemo(()=>{const T=f(o);return r!==void 0&&T.write?.(b(o,r)),T},[r]);return t.jsx(P.Provider,{value:s,children:e})}function N(){const e=i.useContext(P);if(!e)throw new Error("ThemeProvider required");const[r,s]=p(o,()=>[e],{defaultTheme:"light"}),T=i.useCallback(()=>s("light"),[s]),F=i.useCallback(()=>s("dark"),[s]);return t.jsxs(l,{title:"Theme from store in Context","data-testid":"store-from-context-demo",appearance:"output",children:[t.jsxs("p",{children:["theme:"," ",t.jsx("span",{"data-testid":"store-from-context-theme",children:r===void 0?"(undefined)":String(r)})]}),t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:T,"data-testid":"store-from-context-btn-light",children:"Set light"}),t.jsx(n,{onPress:F,"data-testid":"store-from-context-btn-dark",children:"Set dark"})]})]})}const g={name:"React Context theme store",tags:["use-case"],parameters:m({description:{story:"Context provides the store instance (e.g. inMemoryThemeStore) for subtree scoping. Each ThemeProvider creates its own store; descendants get it via useContext and pass to useThemeStores. Simpler than implementing a ThemeStore with Context as the storage backend."},source:{code:u`
            ...
            `}}),decorators:[d(),c()],render:()=>t.jsx(I,{initialTheme:"dark",children:t.jsx(N,{})}),play:async({canvas:e})=>{const r=()=>e.getByTestId("store-from-context-theme"),s=()=>e.getByTestId("store-from-context-btn-light"),T=()=>e.getByTestId("store-from-context-btn-dark");await h(async()=>{await a(r()).toHaveTextContent("dark")},{timeout:2e3}),await y.click(s()),await h(async()=>{await a(r()).toHaveTextContent("light")},{timeout:2e3}),await y.click(T()),await h(async()=>{await a(r()).toHaveTextContent("dark")},{timeout:2e3})}},x={name:"store with initial value",tags:["props"],parameters:m({description:{story:"When the store already has a value, the hook returns it on first render."},source:{code:u`
                ...
                // theme === 'dark'
            `}}),decorators:[d(),c()],render:()=>{const[e]=p(o,()=>{const r=f(o);return r.write?.(b(o,"dark")),[r]},{defaultTheme:"light"});return t.jsx(l,{title:"Theme from store with value",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})},play:async({canvas:e})=>{await h(()=>a(e.getByTestId("current-theme")).toHaveTextContent("dark"),{timeout:3e3})}},v={name:"stores: concrete stores",tags:["props"],parameters:m({description:{story:"Accepts concrete theme stores such as inMemoryThemeStore and localStorageThemeStore. Uses factory form for inline store creation."},source:{code:u`
                useThemeStores(themes, () => [
                    inMemoryThemeStore(themes),
                    localStorageThemeStore(themes, { storageKey: 'app-theme' })
                ], { defaultTheme: 'light' })
            `}}),beforeEach:()=>{localStorage.removeItem("use-theme-stores-story")},decorators:[d(),c()],render:()=>{const[e,r]=p(o,()=>[f(o),E(o,{storageKey:"use-theme-stores-story"})],{defaultTheme:"light"});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:()=>r("light"),children:"Set light"}),t.jsx(n,{onPress:()=>r("dark"),children:"Set dark"})]}),t.jsx(l,{title:"Theme from className + localStorage",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})]})},play:async({canvas:e})=>{await a(e.getByTestId("current-theme")).toHaveTextContent("light"),await y.click(e.getByRole("button",{name:"Set dark"})),await h(()=>a(e.getByTestId("current-theme")).toHaveTextContent("dark"),{timeout:2e3})},afterEach:()=>{localStorage.removeItem("use-theme-stores-story")}},k={name:"stores: factory tuples",tags:["props"],parameters:m({description:{story:"Accepts store factory tuples [factory] or [factory, options]. Same pattern as createThemeHook and composeThemeStores. Uses factory form so the tuple array is created once."},source:{code:u`
                useThemeStores(themes, () => [
                    [classNameThemeStore],
                    [localStorageThemeStore, { storageKey: 'app-theme' }]
                ], { defaultTheme: 'light' })
            `}}),decorators:[d(),c()],render:()=>{const[e,r]=p(o,()=>[[j],[E,{storageKey:"use-theme-stores-factory-story"}]],{defaultTheme:"light"});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:()=>r("light"),children:"Set light"}),t.jsx(n,{onPress:()=>r("dark"),children:"Set dark"})]}),t.jsx(l,{title:"Theme from factory tuples",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})]})},play:async({canvas:e})=>{await a(e.getByTestId("current-theme")).toHaveTextContent("light")},afterEach:()=>{document.documentElement.classList.remove("theme-light","theme-dark"),localStorage.removeItem("use-theme-stores-factory-story")}},w={name:"stores: array form",tags:["props"],parameters:m({description:{story:"When using the array form (not a factory), the stores array must be memoized or ref-stable. Recreating the array each render breaks internal caching and subscriptions."},source:{code:u`
                // Required: memoize so the array reference is stable
                const stores = useMemo(() => [inMemoryThemeStore(themes)] as const, [])
                const [theme, setTheme] = useThemeStores(themes, stores, { defaultTheme: 'light' })
            `}}),decorators:[d(),c()],render:()=>{const e=i.useMemo(()=>[f(o)],[]),[r,s]=p(o,e,{defaultTheme:"light"});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:()=>s("light"),children:"Set light"}),t.jsx(n,{onPress:()=>s("dark"),children:"Set dark"})]}),t.jsx(l,{title:"Array form (memoized)",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:r??"(none)"})})]})},play:async({canvas:e})=>{await a(e.getByTestId("current-theme")).toHaveTextContent("light"),await y.click(e.getByRole("button",{name:"Set dark"})),await h(()=>a(e.getByTestId("current-theme")).toHaveTextContent("dark"),{timeout:2e3})}},C={name:"options.defaultTheme",tags:["props"],parameters:m({description:{story:"When stores are empty, the hook returns defaultTheme. The default is also used for SSR."},source:{code:u`
                useThemeStores(themes, () => [inMemoryThemeStore(themes)], { defaultTheme: 'dark' })
            `}}),decorators:[d(),c()],render:()=>{const[e]=p(o,()=>[f(o)],{defaultTheme:"dark"});return t.jsx(l,{title:"Theme with defaultTheme: 'dark'",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})},play:async({canvas:e})=>{await a(e.getByTestId("current-theme")).toHaveTextContent("dark")}},B={tags:["source"],parameters:m({source:{code:M}}),decorators:[c()]};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...B.parameters?.docs?.source}}};const te=["BasicUsage","FromReactContext","StoreWithInitialValue","ConcreteStores","FactoryTuplePattern","ArrayForm","WithDefaultTheme","Source"];export{w as ArrayForm,S as BasicUsage,v as ConcreteStores,k as FactoryTuplePattern,g as FromReactContext,B as Source,x as StoreWithInitialValue,C as WithDefaultTheme,te as __namedExportsOrder,ee as default};
