import{r as n,j as t,d,w as y,s as S,S as u}from"./iframe-WGM8CAeG.js";import{d as T}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as B}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as b}from"./theme-entry-D4S_RAMB.js";import{p as K}from"./parse-stored-theme-Dj4VCwi6.js";import{l as C}from"./local-storage-theme-store-DEFWor3J.js";import{B as l}from"./button-CyKNudt_.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";function f(e,r){const{storageKey:i,defaultTheme:o}=r,s=n.useMemo(()=>C(e,{storageKey:i}),[e,i]),[w,x]=n.useState(()=>typeof window<"u"&&window.localStorage?K(e,window.localStorage.getItem(i))??o:o);return n.useEffect(()=>E([s],o,x),[s,o]),[w,n.useCallback(v=>{B([s],b(e,v))},[s,e])]}const j=`import { useCallback, useEffect, useMemo, useState } from 'react'
