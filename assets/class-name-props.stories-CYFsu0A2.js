...
`,B={title:"class-name/ClassNameProps",tags:["type","version:next","!test"],render:()=>o.jsx(o.Fragment,{})},r={tags:["source"],parameters:a({source:{code:d}}),decorators:[s({content:o.jsxs("p",{children:[o.jsx("code",{children:"ClassNameProps"})," describes the standard type of the ",o.jsx("code",{children:"className"})," ","property."]})}),t()]},e={tags:["use-case","editor"],parameters:a({source:{code:m}}),decorators:[s({content:o.jsx("p",{children:"Use it by itself or combine with other props."})}),t()]};p(e,{availableImports:{"@just-web/toolkits":i,"@repobuddy/storybook":n,react:c},code:e.parameters?.docs?.source?.code});r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  tags: ['source'],
