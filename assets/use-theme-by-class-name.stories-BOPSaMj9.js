import{r as m,j as t,d as c,w as T,s as g,S as f}from"./iframe-WGM8CAeG.js";import{d as y}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as b}from"./set-theme-to-stores-C1AbMsOJ.js";import{c as C,r as B}from"./class-name-theme-store-D3ainCTa.js";import{t as N}from"./theme-entry-D4S_RAMB.js";import{B as l}from"./button-CyKNudt_.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-DJMrXwPX.js";import"./findKey-BZZwGHNT.js";import"./dummy-theme-store-DcCfgetv.js";function v(e,s){const a=s?.element??(typeof document<"u"?document.documentElement:void 0),n=s?.defaultTheme,h=m.useMemo(()=>C(e,{element:a}),[a,e]),[S,x]=m.useState(()=>a?B(e,a.className)??n:n);return m.useEffect(()=>{if(a)return E([h],n,x)},[a,h,n]),[S,m.useCallback(w=>{a&&b([h],N(e,w))},[a,h,e])]}const j=`import { useCallback, useEffect, useMemo, useState } from 'react'
...
`,{expect:r,userEvent:o}=__STORYBOOK_MODULE_TEST__,k={light:"theme-light",dark:"theme-dark"},U={title:"react/hooks/useThemeByClassName",tags:["func","version:next"],parameters:c({description:{component:"React hook that returns the current theme (from element class) and a setter. Subscribes to class changes on the element so the returned theme stays in sync."}}),render:()=>t.jsx(t.Fragment,{})},i={parameters:c({description:{story:"Observe and set theme by class name on document.documentElement. The hook reads the first matching theme class and setTheme updates the element class list."},source:{code:y`
            ...
            `}}),decorators:[T(),g()],render:()=>{const[e,s]=m.useState(null),[a,n]=v(k,{defaultTheme:"light",element:e??void 0});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsx("div",{ref:s,className:"rounded border border-gray-300 p-4","data-testid":"target-element",children:"Target element (theme class is observed here)"}),t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(l,{onPress:()=>n("light"),children:"Set light"}),t.jsx(l,{onPress:()=>n("dark"),children:"Set dark"})]}),t.jsx(f,{title:"Current theme on target",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:a??"(none)"})})]})},play:async({canvas:e,step:s})=>{await s("Set dark",async()=>{await o.click(e.getByRole("button",{name:"Set dark"})),await r(e.getByTestId("current-theme")).toHaveTextContent("dark")}),await s("Set light",async()=>{await o.click(e.getByRole("button",{name:"Set light"})),await r(e.getByTestId("current-theme")).toHaveTextContent("light")})}},u={parameters:c({description:{story:"The hook stays in sync when the element class is changed outside of setTheme (e.g. by another component or direct DOM mutation)."},source:{code:y`
            ...
            `}}),decorators:[T(),g()],render:()=>{const[e]=v(k,{defaultTheme:"light"}),s=()=>{const a=document.documentElement;a.classList.contains("theme-dark")?(a.classList.remove("theme-dark"),a.classList.add("theme-light")):(a.classList.remove("theme-light"),a.classList.add("theme-dark"))};return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsx(l,{onPress:s,children:"Toggle theme via classList (external)"}),t.jsxs(f,{appearance:"output",children:[t.jsx("p",{className:"mb-2",children:"Hook value (updates when class changes elsewhere):"}),t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})]})]})},play:async({canvas:e})=>{const s=e.getByRole("button",{name:/Toggle theme via classList/});await o.click(s),await r(e.getByTestId("current-theme")).toHaveTextContent("dark"),await o.click(s),await r(e.getByTestId("current-theme")).toHaveTextContent("light")}},p={tags:["source"],parameters:c({source:{code:j}}),decorators:[g()]};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
...
}`,...p.parameters?.docs?.source}}};const W=["BasicUsage","CustomElement","SyncFromElsewhere","Source"];export{i as BasicUsage,d as CustomElement,p as Source,u as SyncFromElsewhere,W as __namedExportsOrder,U as default};
