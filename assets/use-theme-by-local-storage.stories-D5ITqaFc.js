import{r as o,j as t,d as l,w as T,s as g,S as d}from"./iframe-BIKclg0F.js";import{d as S}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as B}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as b}from"./theme-entry-D4S_RAMB.js";import{l as K}from"./local-storage-theme-store-DfrGUHsD.js";import{B as h}from"./button-Cg48NM-D.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";import"./write-local-storage-CF1YWIKZ.js";import"./write-web-storage-DRJlRT-M.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";function f(e,r){const{storageKey:y,defaultTheme:i}=r,a=o.useMemo(()=>K(e,{storageKey:y}),[e,y]),[x,v]=o.useState(()=>a.read()?.theme??i);return o.useEffect(()=>E([a],i,v),[a,i]),[x,o.useCallback(w=>{B([a],b(e,w))},[a,e])]}const C=`import { useCallback, useEffect, useMemo, useState } from 'react'
