import{j as r,w as u,s as n,d as p,r as c}from"./iframe-C_kByFhJ.js";import{d as S}from"./dedent-BuYMbVyj.js";import{t as g}from"./theme-entry-D4S_RAMB.js";import{c as b}from"./compose-theme-stores-CD86eyKP.js";import{g as k}from"./get-prefers-color-scheme-C16oSBYU.js";import{o as C}from"./observe-prefers-color-scheme-DjdBdD7G.js";import{T as f}from"./theme-result-card-_xtJMcHJ.js";import{T as v}from"./theme-store-demo-D-sqTBR_.js";import"./preload-helper-PPVm8Dsz.js";import"./set-theme-to-stores-C1AbMsOJ.js";import"./button-BMv5qOnG.js";function y(e){return{read(){return g(e,k())},subscribe(s){return C(o=>s(g(e,o)))}}}const w=`import type { RequiredPick } from 'type-plus'
...
`,{expect:T,userEvent:x}=__STORYBOOK_MODULE_TEST__,M={title:"theme/theme-store/prefersColorSchemeThemeStore",tags:["func","version:next"],render:()=>r.jsx(r.Fragment,{})},t={light:"theme-light",dark:"theme-dark"},h={tags:["playground"],decorators:[u({content:r.jsxs("p",{children:[r.jsx("code",{children:"prefersColorSchemeThemeStore"})," is a read-only theme store for color-scheme only. Themes must include only ",r.jsx("code",{children:"light"})," and ",r.jsx("code",{children:"dark"})," keys—mirrors"," ",r.jsx("code",{children:"prefers-color-scheme"}),". Returns ",r.jsx("code",{children:"ThemeEntry"})," for ",r.jsx("code",{children:"light"})," ","or ",r.jsx("code",{children:"dark"})," based on system preference. No write method."]})}),n({source:S`
...
}`,...i.parameters?.docs?.source}}};const N=["Playground","Read","Subscribe","WithComposeThemeStores","Source"];export{h as Playground,a as Read,i as Source,l as Subscribe,d as WithComposeThemeStores,N as __namedExportsOrder,M as default};
