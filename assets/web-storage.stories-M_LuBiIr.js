import{j as r,d as l,w,s as h,r as x}from"./iframe-6HRzXnzl.js";import{d as y}from"./dedent-BuYMbVyj.js";import{t as u}from"./theme-entry-D4S_RAMB.js";import{r as n,w as S}from"./write-web-storage-DRJlRT-M.js";import{B as E}from"./button-Dhsg6uJP.js";import{T as d}from"./theme-result-card-XuOZGWKk.js";import"./preload-helper-PPVm8Dsz.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";const{expect:s,userEvent:W}=__STORYBOOK_MODULE_TEST__,j={title:"theme/web-storage",tags:["func","version:1.0"],parameters:l({description:{component:"Generic low-level functions for reading and writing theme via any Storage (localStorage or sessionStorage): readWebStorage, writeWebStorage. Requires options.storage."}}),render:()=>r.jsx(r.Fragment,{})},t={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},a="theme-ws-func-demo",v="theme-ws-func-local",T="theme-ws-func-session",c={name:"readWebStorage",tags:["props"],parameters:l({description:{story:"readWebStorage(themes, storageKey, { storage }) reads the current theme from the given Storage."}}),decorators:[w(),h({source:y`
