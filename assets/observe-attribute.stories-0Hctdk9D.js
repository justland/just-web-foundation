import{j as a,d as i,w as h,s as v,r as c}from"./iframe-CBCqNwbj.js";import{d as p}from"./dedent-BuYMbVyj.js";import{o as y}from"./observe-attribute-DyUhIkyT.js";import{L as f}from"./log-panel-BoijEelM.js";import"./preload-helper-PPVm8Dsz.js";const T=`/**
...
`,{expect:o,userEvent:l}=__STORYBOOK_MODULE_TEST__,S={title:"attributes/observeAttributes",tags:["func","autodocs","version:next"],parameters:i({description:{component:"Observes attribute changes on an element and calls corresponding handlers."}}),argTypes:{element:{control:!1}},render:()=>a.jsx(a.Fragment,{})},u={parameters:i({description:{story:"Observes a single attribute change on the document root element."},source:{code:p`
            ...
            `}}),decorators:[h(),v({placement:"before"})],render:()=>{const[e,t]=c.useState([]);return c.useEffect(()=>{const n=y({"data-theme":s=>{t(r=>[...r,`data-theme: ${s}`])},"aria-label":s=>{t(r=>[...r,`aria-label: ${s}`])}});return()=>n.disconnect()},[]),a.jsxs("div",{className:"font-sans",children:[a.jsxs("div",{className:"flex flex-wrap gap-2 mb-4",children:[a.jsx(g,{attribute:"data-theme"}),a.jsx(g,{attribute:"aria-label"})]}),a.jsx(f,{title:"Attribute Changes:",log:e})]})},play:async({canvas:e,step:t})=>{const n=e.getByRole("button",{name:"Toggle data-theme"});await t("data-theme",async()=>{await l.click(n),await o(e.getByText("data-theme: test-value")).toBeInTheDocument(),await l.click(n),await o(e.getByText("data-theme: null")).toBeInTheDocument()}),await t("aria-label",async()=>{const s=e.getByRole("button",{name:"Toggle aria-label"});await l.click(s),await l.click(s),await o(e.getByText("aria-label: test-value")).toBeInTheDocument(),await o(e.getByText("aria-label: null")).toBeInTheDocument()})}},d={parameters:i({description:{story:"Observes attribute changes on a custom element instead of the document root."},source:{code:p`
                ...
                // cleanup
                observer.disconnect()
            `}}),decorators:[h(),v({placement:"before"})],render:()=>{const[e,t]=c.useState([]),n=c.useRef(null);return c.useEffect(()=>{if(!n.current)return;const s=y({"data-anything":r=>{t(x=>[...x,`data-anything: ${r}`])}},n.current);return()=>s.disconnect()},[n]),a.jsxs("div",{className:"font-sans",children:[a.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:a.jsx(g,{attribute:"data-anything",ref:n})}),a.jsx("div",{ref:n,className:"p-4 border border-gray-300 mb-4",children:"Custom Element to observe"}),a.jsx(f,{title:"Attribute Changes:",log:e})]})},play:async({canvas:e})=>{const t=e.getByRole("button",{name:"Toggle data-anything"}),n=e.getByText("Custom Element to observe");await l.click(t),await o(e.getByText("data-anything: test-value")).toBeInTheDocument();const s=n.getAttribute("data-anything");await o(s).toBe("test-value"),await l.click(t),await o(e.getByText("data-anything: null")).toBeInTheDocument();const r=n.getAttribute("data-anything");await o(r).toBeNull()}},g=c.forwardRef(({attribute:e},t)=>{const n=c.useCallback(s=>{const r=(t&&"current"in t?t.current:null)??document.documentElement,w=r.getAttribute(s)?null:"test-value";w===null?r.removeAttribute(s):r.setAttribute(s,w)},[t]);return a.jsxs("button",{className:"bg-cyan-700 text-white px-4 py-2 rounded-md shadow-md active:bg-cyan-800",onClick:()=>n(e),children:["Toggle ",e]},e)}),b={tags:["source"],parameters:i({source:{code:T}}),decorators:[v()]};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
