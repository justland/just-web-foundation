import{r as h,j as t,d as l,w as g,s as b,S as f}from"./iframe-y78tOg11.js";import{d as y}from"./dedent-BuYMbVyj.js";import{o as T}from"./observe-attribute-CZKLLp6I.js";import{B as n}from"./button-DtUQWtfd.js";import"./preload-helper-PPVm8Dsz.js";function x(e,a=typeof document<"u"?document.documentElement:void 0){const[o,u]=h.useState(()=>a?.getAttribute(e)??void 0);return h.useEffect(()=>{if(a)return u(a.getAttribute(e)??void 0),T({[e]:i=>{u(i??void 0)}},a)},[a,e]),[o,h.useCallback(i=>{a&&(i==null?a.removeAttribute(e):a.setAttribute(e,i))},[a,e])]}const w=`import { useCallback, useEffect, useState } from 'react'
...
}`,...p.parameters?.docs?.source}}};const R=["BasicUsage","CustomElement","SyncFromElsewhere","Source"];export{d as BasicUsage,m as CustomElement,p as Source,v as SyncFromElsewhere,R as __namedExportsOrder,C as default};
