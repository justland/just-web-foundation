import{j as t,d as l,w as g,s as h,S as Y,r as m}from"./iframe-DkcyBlqT.js";import{d as y}from"./dedent-BuYMbVyj.js";import{t as i}from"./theme-entry-D4S_RAMB.js";import{d as G}from"./dummy-theme-store-DcCfgetv.js";import{p as M}from"./parse-stored-theme-Dj4VCwi6.js";import{B as p}from"./button-r8Tj1Q96.js";import{T as v}from"./theme-result-card-DcCFdYCy.js";import{T as D}from"./theme-store-demo-DYKbBIwb.js";import"./preload-helper-PPVm8Dsz.js";function u(e,s){const{storageKey:c}=s;if(typeof window>"u"||!window.sessionStorage)return G;const a=new Set;let T=S()?.theme??void 0;function S(){const d=M(e,window.sessionStorage.getItem(c));if(d!==void 0)return i(e,d)}function x(){const d=S(),b=d?.theme??void 0;if(b!==T){T=b;for(const E of a)E(d)}}return{read:S,write(d){try{d===void 0?window.sessionStorage.removeItem(c):window.sessionStorage.setItem(c,JSON.stringify(d)),x()}catch{}},subscribe(d){a.add(d);const b=E=>{E.key===c&&E.storageArea===window.sessionStorage&&x()};return window.addEventListener("storage",b),()=>{a.delete(d),window.removeEventListener("storage",b)}}}}const W=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
