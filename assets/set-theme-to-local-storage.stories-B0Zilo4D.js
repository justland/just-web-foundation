import{j as o,d as l,w as i,s as c}from"./iframe-DMM-er1z.js";import{d}from"./dedent-BuYMbVyj.js";import{d as g}from"./try-parse-json-83P4r8LE.js";import{g as p,s as h}from"./set-theme-to-local-storage-BwgwevIK.js";import{S as u}from"./show-theme-from-local-storage-CF2JJBHG.js";import"./preload-helper-PPVm8Dsz.js";import"./theme-result-card-PyzNQYAU.js";import"./append-id-Vsg144gU.js";const y=`import type { ThemeMap, ThemeStorageOptions } from './theme.types.ts'
...
`,{expect:a}=__STORYBOOK_MODULE_TEST__,b={title:"theme/setThemeToLocalStorage",tags:["func","version:next"],parameters:l({description:{component:"Sets the theme key in localStorage. Writes only when the theme is in the themes map; removes the storage item by passing null or undefined to the theme option."}}),render:()=>o.jsx(o.Fragment,{})},n={tags:["use-case"],parameters:l({description:{story:"Writes the theme to localStorage"}}),decorators:[i(),c({source:d`
                setThemeToLocalStorage({
            ...
            `})],render:(e,{loaded:{options:t}})=>o.jsx(u,{...t}),play:async({loaded:{options:e}})=>{const t=p({...e,storageKey:"theme-array"});await a(t?.theme).toBe("default"),await a(t?.value).toEqual(["text-white","bg-white"])}},m={tags:["source"],parameters:l({source:{code:y}}),decorators:[c()]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...m.parameters?.docs?.source}}};const _=["BasicUsage","RemoveTheme","WithThemeArray","Source"];export{n as BasicUsage,r as RemoveTheme,m as Source,s as WithThemeArray,_ as __namedExportsOrder,b as default};
