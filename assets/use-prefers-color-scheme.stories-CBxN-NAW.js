...
`,x={title:"react/hooks/usePrefersColorScheme",tags:["func","version:next"],parameters:c({description:{component:"React hook that returns the current system color scheme preference and re-renders when it changes."}}),render:()=>e.jsx(e.Fragment,{})},s={parameters:c({source:{code:i`
                const scheme = usePrefersColorScheme()
