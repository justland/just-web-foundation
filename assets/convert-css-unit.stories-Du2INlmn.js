import{j as t,d as i,w as s,s as c,S as a}from"./iframe-CuGcEWf0.js";import{d as w}from"./dedent-BuYMbVyj.js";import{c as e}from"./convert-css-unit-CKvOQ19N.js";import"./preload-helper-PPVm8Dsz.js";import"./get-rem-to-px-scale-CTgj4gd8.js";import"./parse-css-value-5JGaQpWz.js";const C=`import type { Required } from 'type-plus'
...
`,{expect:n}=__STORYBOOK_MODULE_TEST__,N={title:"units/convertCssUnit",tags:["func","version:3.1"],parameters:i({description:{component:"Converts a CSS length value from one unit to another. Supports px, rem, em, vw, vh, vmin, vmax, lh, rlh, ch, %, and absolute units. Uses browser auto-detect for rootFontSize and viewport when options omitted."}}),render:()=>t.jsx(t.Fragment,{})},u={tags:["use-case"],parameters:i({description:{story:"Convert between common units. Auto-detects fromUnit from string."}}),decorators:[s(),c({source:w`
                convertCssUnit('16px', 'rem')     // 1
                convertCssUnit('1rem', 'px')      // 16
...
`)})})},play:async()=>{await n(e("16px","rem")).toBe(1),await n(e("1rem","px")).toBe(16),await n(e("96px","in")).toBe(1),await n(e("50%","px",{percentReference:200})).toBe(100)}},d={tags:["use-case"],parameters:i({description:{story:"Convert viewport units (vw, vh) with explicit viewport dimensions."}}),decorators:[s(),c({source:w`
                convertCssUnit('10vw', 'px', { viewportWidth: 375 })   // 37.5
...
convertCssUnit('10vh', 'px', { viewportHeight: 812 }) → ${r} (expected: 81.2)`})})},play:async()=>{await n(e("10vw","px",{viewportWidth:375})).toBe(37.5),await n(e("10vh","px",{viewportHeight:812})).toBe(81.2)}},m={tags:["use-case"],parameters:i({description:{story:"Direct rem↔em conversion (no px intermediate)."}}),decorators:[s(),c({source:w`
