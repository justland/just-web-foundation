import{j as t,d as l,w as h,s as m,S as D,r as u}from"./iframe-CKOu7oIT.js";import{d as g}from"./dedent-BuYMbVyj.js";import{t as i}from"./theme-entry-D4S_RAMB.js";import{d as L}from"./dummy-theme-store-DcCfgetv.js";import{r as J,w as z}from"./write-session-storage-tbbtCTD7.js";import{B as p}from"./button-D0LdEWMh.js";import{T as y}from"./theme-result-card-DK6W5yz6.js";import{T as U}from"./theme-store-demo-Dh70N_wh.js";import"./preload-helper-PPVm8Dsz.js";import"./write-web-storage-DRJlRT-M.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";function d(e,s){const{storageKey:n,parse:a,stringify:S,onError:Y}=s;if(!window?.sessionStorage)return L;const T=new Set;let x=G()?.theme??void 0;function G(){return J(e,n,{parse:a})}function W(){const v=G(),f=v?.theme??void 0;if(f!==x){x=f;for(const E of T)E(v)}}return{read:G,write(v){z(e,n,v,{stringify:S,onError:Y}),W()},subscribe(v){T.add(v);const f=E=>{E.key===n&&E.storageArea===window.sessionStorage&&W()};return window.addEventListener("storage",f),()=>{T.delete(v),window.removeEventListener("storage",f)}}}}const V=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
