...
`,P=`import type { AnyRecord } from 'type-plus'
...
`,b=`import type { JustStyleFnProps } from '@just-web/toolkits'
...
`,q={title:"style/JustStyle",tags:["version:1.0","!test"],parameters:t({description:{component:"`JustStyle` extends the basic `style` type with a callback to invert the flow on control. This allows the consumer to fully control the resulting `style`."}}),render:()=>e.jsx(e.Fragment,{})},u={decorators:[c({content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("code",{children:"JustStyle"})," extends the basic ",e.jsx("code",{children:"style"})," type with a callback to invert the flow on control. This allows you to fully control the resulting"," ",e.jsx("code",{children:"style"})," value."]}),e.jsxs("p",{children:["The behavior when using ",e.jsx("code",{children:"JustStyle"})," should be consistent among all components that use it. This provides a consistent API for the consumer."]}),e.jsxs("ul",{className:"list-disc list-inside",children:[e.jsxs("li",{children:["When ",e.jsx("code",{children:"undefined"})," is passed, the default ",e.jsx("code",{children:"style"})," should be applied."]}),e.jsxs("li",{children:["When a ",e.jsx("code",{children:"CSSProperties"})," object is passed, it should be merged with the default ",e.jsx("code",{children:"style"})," (override wins)."]}),e.jsxs("li",{children:["When a ",e.jsx("code",{children:"function"})," is passed, it must receive the current render props with the default ",e.jsx("code",{children:"style"}),"."]}),e.jsxs("ul",{className:"list-disc list-inside pl-4",children:[e.jsxs("li",{children:["When the function returns ",e.jsx("code",{children:"undefined"}),", the ",e.jsx("code",{children:"style"})," should be reset to ",e.jsx("code",{children:"undefined"}),"."]}),e.jsxs("li",{children:["When the function returns ",e.jsx("code",{children:"CSSProperties"}),", that will be the"," ",e.jsx("code",{children:"style"})," to be applied."]})]})]})]})})]},r={name:"JustStyleProps",tags:["type"],parameters:t({source:{code:m}}),decorators:[c({title:"JustStyleProps",content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("code",{children:"JustStyleProps"})," defines the ",e.jsx("code",{children:"style"})," property with the type"," ",e.jsx("code",{children:"JustStyle"}),"."]}),e.jsxs("p",{children:["It is a ready-made type for the typical ",e.jsx("code",{children:"style"})," props use case."]})]})}),i()]};p(r,{availableImports:{"@just-web/toolkits":l,"@repobuddy/storybook":a,react:h},code:r.parameters?.docs?.source?.code});const o={name:"JustStyle",tags:["type"],parameters:t({source:{code:f}}),decorators:[c({title:"JustStyle",content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("code",{children:"JustStyle"})," extends the basic ",e.jsx("code",{children:"style"})," type with a callback to invert the flow on control. This allows you to fully control the resulting"," ",e.jsx("code",{children:"style"}),"."]}),e.jsxs("p",{children:["Compare to ",e.jsx("code",{children:"JustStyleProps"}),", ",e.jsx("code",{children:"JustStyle"})," allows you to use it on any props, not just the ",e.jsx("code",{children:"style"})," prop."]}),e.jsxs("p",{children:["In the callback, the function receives ",e.jsx("code",{children:"JustStyleFnProps"}),", the full render props object with the ",e.jsx("code",{children:"style"})," property, which contains the base"," ",e.jsx("code",{children:"style"})," produced by the component."]}),e.jsxs("p",{children:["The consumer can merge, amend, or override the ",e.jsx("code",{children:"style"})," based on the render props or return a completely different object."]})]})}),i()]};p(o,{availableImports:{"@just-web/toolkits":l,"@repobuddy/storybook":a},code:o.parameters?.docs?.source?.code});const s={name:"JustStyleFnProps",tags:["type"],parameters:t({source:{code:b}}),decorators:[c({title:"JustStyleFnProps",content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["The render props type for ",e.jsx("code",{children:"JustStyle"})," resolver functions."]}),e.jsx("p",{children:"It is useful when you want to create a composable function."})]})}),i()]};p(s,{availableImports:{"@just-web/toolkits":l,"@repobuddy/storybook":a},code:s.parameters?.docs?.source?.code});const n={tags:["use-case","editor","!test"],parameters:t({description:{story:"Using `JustStyle` without a type parameter: render props is `AnyRecord & { style?: CSSProperties }`. Accepts object, function, or undefined."},source:{code:m}}),decorators:[c({content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["For non-interactive component, you can use ",e.jsx("code",{children:"JustStyle"})," without specifying the type parameter."]}),e.jsxs("p",{children:["The function form receives"," ",e.jsx("code",{children:"renderProps: AnyRecord & { style?: CSSProperties | undefined }"})]}),e.jsxs("p",{children:["The ",e.jsx("code",{children:"style"})," contains the base style produced by the component."]}),e.jsxs("p",{children:["You can merge or amend the ",e.jsx("code",{children:"style"})," by returning an object based off of it."]}),e.jsx("p",{children:"You can also return a completely new style by returning a different value."})]})}),i()]};p(n,{availableImports:{"@just-web/toolkits":l,"@repobuddy/storybook":a,react:h},defaultEditorOptions:{},code:n.parameters?.docs?.source?.code});const d={tags:["use-case","editor","!test"],parameters:t({description:{story:"Using `JustStyle<RenderProps>` with a type parameter: the function receives typed render props (`RenderProps & { style?: CSSProperties }`), enabling autocomplete and type checking for custom render props fields."},source:{code:S}}),decorators:[c({content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["When using ",e.jsx("code",{children:"JustStyle<RenderProps>"})," with a type parameter, the function form receives"," ",e.jsxs("code",{children:["renderProps: RenderProps & ","{ style?: CSSProperties | undefined }"]})]}),e.jsx("p",{children:"You can use it to customize the style based on the render props."})]})}),i()],play(){}};p(d,{availableImports:{"@repobuddy/storybook":a,"@just-web/toolkits":l,react:h},code:d.parameters?.docs?.source?.code});const y={tags:["source"],parameters:t({source:{code:P}}),decorators:[i()]};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
...
}`,...y.parameters?.docs?.source}}};const G=["Specification","JustStylePropsStory","JustStyleStory","JustStyleFnPropsStory","NonInteractiveComponent","InteractiveComponent","Source"];export{d as InteractiveComponent,s as JustStyleFnPropsStory,r as JustStylePropsStory,o as JustStyleStory,n as NonInteractiveComponent,y as Source,u as Specification,G as __namedExportsOrder,q as default};
