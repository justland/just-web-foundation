import{r as l,j as t,d as h,w as T,s as g,S as f}from"./iframe-Ds1H5bIE.js";import{d as y}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as b}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as B}from"./theme-entry-D4S_RAMB.js";import{c as C}from"./class-name-theme-store-CmBWQ_Vc.js";import{B as c}from"./button-DN0NMyAj.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";import"./write-class-name-CcTpPJCn.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-BZZwGHNT.js";function k(e,s){const a=s?.element??(typeof document<"u"?document.documentElement:void 0),n=s?.defaultTheme,m=l.useMemo(()=>C(e,{element:a}),[a,e]),[S,x]=l.useState(()=>m.read()?.theme??n);return l.useEffect(()=>{if(a)return E([m],n,x)},[a,m,n]),[S,l.useCallback(w=>{a&&b([m],B(e,w))},[a,m,e])]}const N=`import { useCallback, useEffect, useMemo, useState } from 'react'
