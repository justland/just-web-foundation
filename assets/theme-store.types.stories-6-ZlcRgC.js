import{j as e,w as m,s as r,d as f,r as d}from"./iframe-C_kByFhJ.js";import{d as l}from"./dedent-BuYMbVyj.js";import{t as u}from"./theme-entry-D4S_RAMB.js";import{T as y}from"./theme-result-card-_xtJMcHJ.js";import"./preload-helper-PPVm8Dsz.js";const b=`import type { ThemeEntry } from '../theme-entry.types.ts'
...
`,x={title:"theme/theme-store/ThemeStore",tags:["type","version:next"],render:()=>e.jsx(e.Fragment,{})},p={current:"theme-current",grayscale:"theme-grayscale"},s={tags:["props"],decorators:[m({content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["When you specify only the ",e.jsx("code",{children:"read"})," method, the store is read-only."]}),e.jsxs("p",{children:["When multiple stores have ",e.jsx("code",{children:"read"}),", the first non-empty result is returned."]})]})}),r({source:"read?: () => ThemeEntry | undefined"}),r({source:l`
                const store: ThemeStore = {
                    read: () => themeEntry(themes, 'current')
                }
                store.read()
            `})],render:()=>{const t={read:()=>u(p,"grayscale")};return e.jsx(y,{title:"store.read()","data-testid":"read-only-result",result:t.read()})}},o={tags:["props"],decorators:[m({content:e.jsxs("p",{children:["When you specify only the ",e.jsx("code",{children:"write"})," method, the store is write-only."]})}),r({source:"write?: (entry: ThemeEntry | undefined) => void"}),r({source:l`
                const store: ThemeStore = {
                    write: (entry) => { /* persist */ }
                }
                store.write(themeEntry(themes, 'grayscale'))
            `})],render:()=>{const[t,c]=d.useState(void 0),i={write:h=>{c(h)}};return d.useEffect(()=>{i.write(u(p,"grayscale"))},[]),e.jsx(y,{title:"store.write() receives","data-testid":"write-only-result",result:t})}},n={tags:["props"],decorators:[m({content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["When you specify only the ",e.jsx("code",{children:"subscribe"})," method, the store is subscribe-only.",e.jsx("code",{children:"subscribe"})," is used to observe external changes (e.g. system preference, remote sync)."]}),e.jsxs("p",{children:["The ",e.jsx("code",{children:"handler"})," is called only when the theme changes."]})]})}),r({source:"subscribe?: (handler: (theme: ThemeEntry<Themes> | undefined | null) => void) => () => void"}),r({source:l`
                const store: ThemeStore = {
                    subscribe: (handler) => {
...
}`,...a.parameters?.docs?.source}}};const v=["ReadOnly","WriteOnly","SubscribeOnly","Source"];export{s as ReadOnly,a as Source,n as SubscribeOnly,o as WriteOnly,v as __namedExportsOrder,x as default};
