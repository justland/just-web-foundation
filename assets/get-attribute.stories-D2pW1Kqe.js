import{j as t,d as r,w as c,s as i,S as m}from"./iframe-DQH8TUqG.js";import{d}from"./dedent-BuYMbVyj.js";import{g as l}from"./get-attribute-BI4biMNS.js";import"./preload-helper-PPVm8Dsz.js";const f=`/**
...
`,N={title:"attributes/getAttribute",tags:["func","version:1.0"],parameters:r({description:{component:"A utility function to get attribute values from DOM element"}}),argTypes:{qualifiedName:{control:"text"},element:{control:!1}},args:{qualifiedName:"data-subject"},render:()=>t.jsx(t.Fragment,{})},a={parameters:r({description:{story:"By default, gets the value of an attribute from document root"},source:{code:d`
            ...
            `}}),decorators:[c(),i()],render(e){const n=l(e.qualifiedName);return t.jsx(m,{appearance:"output",children:t.jsx("pre",{children:JSON.stringify(n,null,2)})})}},u={tags:["source"],parameters:r({source:{code:f}}),decorators:[i()]};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
