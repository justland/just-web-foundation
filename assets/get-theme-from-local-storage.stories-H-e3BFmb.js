import{j as n,d as y,w as r,s as a}from"./iframe-DMM-er1z.js";import{d as s}from"./dedent-BuYMbVyj.js";import{d as m}from"./try-parse-json-83P4r8LE.js";import{g as i,s as S}from"./set-theme-to-local-storage-BwgwevIK.js";import{S as h}from"./show-theme-from-local-storage-CF2JJBHG.js";import"./preload-helper-PPVm8Dsz.js";import"./theme-result-card-PyzNQYAU.js";import"./append-id-Vsg144gU.js";const f=`import { tryParseJSON } from '../_internal/utils/try-parse-json.ts'
...
`,{expect:o}=__STORYBOOK_MODULE_TEST__,B={title:"theme/getThemeFromLocalStorage",tags:["func","version:next"],parameters:y({description:{component:"Gets the theme key stored in localStorage, validated against a themes map. Returns defaultTheme when the key is missing, empty, or the stored value is not in the themes map."}}),render:()=>n.jsx(n.Fragment,{})},w={default:"text-white",grayscale:"text-gray-100"},d={tags:["use-case"],parameters:y({description:{story:"Gets theme from localStorage when a valid theme key is stored."}}),decorators:[r(),a({source:s`
            ...
            `})],render:(e,{loaded:{options:t}})=>n.jsx(h,{...t}),play:async({loaded:{options:e}})=>{const t=i(e);await o(t?.theme).toBe("default"),await o(t?.value).toEqual(["text-white","bg-white"])}},g={name:"Invalid stored value without theme",tags:["unit"],parameters:y({description:{story:"Returns undefined when the stored value is invalid and no defaultTheme is provided."}}),loaders:[()=>(window.localStorage.setItem("theme-no-default","invalid-theme"),{options:m({themes:w,storageKey:"theme-no-default"})})],decorators:[r({content:n.jsx(n.Fragment,{children:n.jsxs("p",{children:["Returns ",n.jsx("code",{children:"undefined"})," when storage is invalid and ",n.jsx("code",{children:"theme"})," is not provided"]})})}),a({source:s`
                getThemeFromLocalStorage({
                    themes: { default: 'text-white', grayscale: 'text-gray-100' },
                    storageKey: 'theme-no-default',
                })
            `})],render:(e,{loaded:{options:t}})=>n.jsx(h,{...t}),play:async({loaded:{options:e}})=>{const t=i(e);await o(t).toBeUndefined()}},p={tags:["source"],parameters:y({source:{code:f}}),decorators:[a()]};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...p.parameters?.docs?.source}}};const _=["BasicUsage","ThemeNotExists","InvalidStoredValue","WithThemeArray","InvalidStoredValueNoTheme","Source"];export{d as BasicUsage,c as InvalidStoredValue,g as InvalidStoredValueNoTheme,p as Source,l as ThemeNotExists,u as WithThemeArray,_ as __namedExportsOrder,B as default};
