import{j as o,s as p,d as t}from"./iframe-bxlfbbSl.js";import{d as s}from"./dedent-BuYMbVyj.js";import{d as c}from"./css-properties-Dh8E5HRZ.js";import"./preload-helper-PPVm8Dsz.js";const{expect:i}=__STORYBOOK_MODULE_TEST__,l={title:"Properties/Properties",tags:["autodocs","code-only","new","version:next"],decorators:[p()],render:()=>o.jsx(o.Fragment,{})},e={tags:["!test"],parameters:t({description:{story:"Extends CSS properties to support custom properties."},source:{code:s`let style: Properties = {
                color: 'red',
