import{r as d,j as t,d as m,w as l,s as i,S as u}from"./iframe-Bqt7DtID.js";import{d as p}from"./dedent-BuYMbVyj.js";import{t as E}from"./theme-entry-D4S_RAMB.js";import{c as j}from"./class-name-theme-store-zY3kyFfI.js";import{l as P}from"./local-storage-theme-store-rbrBwh0T.js";import{c as H}from"./create-theme-hook-Dgc18Ee0.js";import{i as S}from"./in-memory-theme-store-fTg_sUo_.js";import{B as n}from"./button-CtNGpc_v.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-theme-map-value-6BKppRxh.js";import"./findKey-D_Zca1Sl.js";import"./parse-stored-theme-CqNOdFO7.js";import"./compose-theme-stores-CD86eyKP.js";import"./set-theme-to-stores-C1AbMsOJ.js";import"./resolve-class-name-CW-7B7MA.js";function T(e,r,o){const h=d.useMemo(()=>typeof r=="function"?r():r,[]);return H(e,h,o)(o?.defaultTheme)}const M=`import { useMemo } from 'react'
import type {
...
`,{expect:a,userEvent:y,waitFor:c}=__STORYBOOK_MODULE_TEST__,s={light:"theme-light",dark:"theme-dark",system:"theme-system"},X={title:"react/hooks/useThemeStores",tags:["func","version:1.0"],parameters:m({description:{component:"React hook that returns the current theme and a setter for composed theme stores. Delegates to createThemeHook internally. Simpler API than createThemeHook—pass themes, stores, and options once.\n\n**stores** can be a factory `() => [store1, ...]` (recommended, no memoization needed) or an array `[store1, ...]` (must be memoized or ref-stable; recreating the array each render breaks subscriptions)."}}),render:()=>t.jsx(t.Fragment,{})},f={tags:["use-case"],parameters:m({description:{story:"With an in-memory store and defaultTheme, useThemeStores returns [theme, setTheme]. setTheme updates the store and the returned theme stays in sync. Uses the factory form so no memoization is needed."},source:{code:p`
                ...
                setTheme('dark')
            `}}),decorators:[l(),i()],render:()=>{const[e,r]=T(s,()=>[S(s)],{defaultTheme:"light"});return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:()=>r("light"),children:"Set light"}),t.jsx(n,{onPress:()=>r("dark"),children:"Set dark"}),t.jsx(n,{onPress:()=>r("system"),children:"Set system"})]}),t.jsx(u,{title:"Current theme",appearance:"output",children:t.jsx("pre",{"data-testid":"current-theme",className:"font-mono",children:e??"(none)"})})]})},play:async({canvas:e,step:r})=>{await r("Initial state is defaultTheme",async()=>{await a(e.getByTestId("current-theme")).toHaveTextContent("light")}),await r("Set dark",async()=>{await y.click(e.getByRole("button",{name:"Set dark"})),await c(()=>a(e.getByTestId("current-theme")).toHaveTextContent("dark"),{timeout:2e3})}),await r("Set system",async()=>{await y.click(e.getByRole("button",{name:"Set system"})),await c(()=>a(e.getByTestId("current-theme")).toHaveTextContent("system"),{timeout:2e3})})}},F=d.createContext(null);function I({children:e,initialTheme:r}){const o=d.useMemo(()=>{const h=S(s);return r!==void 0&&h.write?.(E(s,r)),h},[r]);return t.jsx(F.Provider,{value:o,children:e})}function N(){const e=d.useContext(F);if(!e)throw new Error("ThemeProvider required");const[r,o]=T(s,()=>[e],{defaultTheme:"light"}),h=d.useCallback(()=>o("light"),[o]),b=d.useCallback(()=>o("dark"),[o]);return t.jsxs(u,{title:"Theme from store in Context","data-testid":"store-from-context-demo",appearance:"output",children:[t.jsxs("p",{children:["theme:"," ",t.jsx("span",{"data-testid":"store-from-context-theme",children:r===void 0?"(undefined)":String(r)})]}),t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:h,"data-testid":"store-from-context-btn-light",children:"Set light"}),t.jsx(n,{onPress:b,"data-testid":"store-from-context-btn-dark",children:"Set dark"})]})]})}const g={name:"React Context theme store",tags:["use-case"],parameters:m({description:{story:"Context provides the store instance (e.g. inMemoryThemeStore) for subtree scoping. Each ThemeProvider creates its own store; descendants get it via useContext and pass to useThemeStores. Simpler than implementing a ThemeStore with Context as the storage backend."},source:{code:p`
