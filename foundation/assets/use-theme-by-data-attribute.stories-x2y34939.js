import{r as m,j as t,d as h,w as f,s as b,S as y}from"./iframe-CL66i86X.js";import{d as v}from"./dedent-BuYMbVyj.js";import{g as B}from"./get-data-attribute-Bl9c_7h4.js";import{o as N}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as C}from"./set-theme-to-stores-C1AbMsOJ.js";import{d as A,r as D}from"./data-attribute-theme-store-ChMUdK3L.js";import{t as j}from"./theme-entry-D4S_RAMB.js";import{B as i}from"./button-BG3LR6CN.js";import"./preload-helper-PPVm8Dsz.js";import"./get-attribute-BI4biMNS.js";import"./observe-data-attribute-CrIGpGqK.js";import"./observe-attribute-DJMrXwPX.js";import"./dummy-theme-store-DcCfgetv.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-CNcK3jLA.js";function k(e,a){const r=a.element??(typeof document<"u"?document.documentElement:void 0),n=a.defaultTheme,T=a.attributeName,u=m.useMemo(()=>A(e,{attributeName:T,element:r}),[r,e,T]),[x,w]=m.useState(()=>{if(r){const d=B(T,r);return D(e,d)??n}return n});m.useEffect(()=>r?N([u],n,w):void 0,[r,u,n]);const E=m.useCallback(d=>{r&&C([u],j(e,d))},[r,u,e]);return[x,E]}const H=`import { useCallback, useEffect, useMemo, useState } from 'react'
