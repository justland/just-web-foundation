import{r as h,j as t,d,w as T,s as g,S as b}from"./iframe-BRf7Axb3.js";import{d as f}from"./dedent-BuYMbVyj.js";import{o as B}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as N}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as C}from"./theme-entry-D4S_RAMB.js";import{d as D}from"./data-attribute-theme-store-F4Jep4za.js";import{B as i}from"./button-CkgYDtEi.js";import"./preload-helper-PPVm8Dsz.js";import"./write-data-attribute-CvKrtAyE.js";import"./get-data-attribute-Bl9c_7h4.js";import"./get-attribute-BI4biMNS.js";import"./observe-data-attribute-CrIGpGqK.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-Bq_FyHcK.js";function y(e,a){const n=a.element??(typeof document<"u"?document.documentElement:void 0),r=a.defaultTheme,v=a.attributeName,m=h.useMemo(()=>D(e,{attributeName:v,element:n}),[n,e,v]),[x,w]=h.useState(()=>m.read()?.theme??r);h.useEffect(()=>n?B([m],r,w):void 0,[n,m,r]);const E=h.useCallback(S=>{n&&N([m],C(e,S))},[n,m,e]);return[x,E]}const A=`import { useCallback, useEffect, useMemo, useState } from 'react'
