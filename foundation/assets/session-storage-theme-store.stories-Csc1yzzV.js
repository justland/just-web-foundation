import{j as t,d as l,w as g,s as h,S as Y,r as m}from"./iframe-BvUeje02.js";import{d as y}from"./dedent-BuYMbVyj.js";import{t as i}from"./theme-entry-D4S_RAMB.js";import{d as G}from"./dummy-theme-store-DcCfgetv.js";import{p as M}from"./parse-stored-theme-Dj4VCwi6.js";import{B as w}from"./button-A39wmDsa.js";import{T}from"./theme-result-card-CmvBHoDv.js";import{T as D}from"./theme-store-demo-DL889U6j.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-class-name-Bjyp5yMi.js";import"./append-id-Vsg144gU.js";function d(e,s){const{storageKey:c}=s;if(typeof window>"u"||!window.sessionStorage)return G;const a=new Set;let S=b()?.theme??void 0;function b(){const u=window.sessionStorage.getItem(c),p=M(e,u);if(p!==void 0)return i(e,p)}function x(){const u=b(),p=u?.theme??void 0;if(p!==S){S=p;for(const E of a)E(u)}}return{read:b,write(u){try{u===void 0?window.sessionStorage.removeItem(c):window.sessionStorage.setItem(c,JSON.stringify(u)),x()}catch{}},subscribe(u){a.add(u);const p=E=>{E.key===c&&E.storageArea===window.sessionStorage&&x()};return window.addEventListener("storage",p),()=>{a.delete(u),window.removeEventListener("storage",p)}}}}const W=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
