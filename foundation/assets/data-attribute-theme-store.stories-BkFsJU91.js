import{j as t,d as h,w as i,s as u,S as g,r as y}from"./iframe-D_6mvhRd.js";import{d as l}from"./dedent-BuYMbVyj.js";import{t as d}from"./theme-entry-D4S_RAMB.js";import{d as H,s as M,p as F}from"./data-attribute-theme-store-BgARxre3.js";import{B as L}from"./button-BvxDy0Ld.js";import{T as p}from"./theme-result-card-rXyXLGwz.js";import{T as P}from"./theme-store-demo-DiN5wMI7.js";import"./preload-helper-PPVm8Dsz.js";import"./get-data-attribute-Bl9c_7h4.js";import"./get-attribute-BI4biMNS.js";import"./observe-data-attribute-CrIGpGqK.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-theme-map-value-6BKppRxh.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-1fsVhyj2.js";import"./append-id-Vsg144gU.js";const W=`import type { Required } from 'type-plus'
...
`,{expect:s,userEvent:V,waitFor:R}=__STORYBOOK_MODULE_TEST__,oe={title:"theme/theme-store/dataAttributeThemeStore",tags:["func","version:1.0"],parameters:h({description:{component:"Theme store that reads and writes theme via a data attribute. Bakes themes at creation; read/write/subscribe use theme keys only."}}),render:()=>t.jsx(t.Fragment,{})},a={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},m="data-theme";function n(e){return H(a,{attributeName:m,...e})}const f={tags:["playground"],parameters:h({description:{story:"Interactive demo: Read theme, write themes via buttons, and observe subscribe updates."}}),decorators:[i(),u({source:l`
            ...
            `})],loaders:[()=>(n().write(d(a,"current")),{})],render:()=>{const r=n().read();return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsx(g,{title:"html[data-theme]",appearance:"output",children:t.jsx("code",{children:typeof document<"u"?document.documentElement.getAttribute("data-theme")??"(none)":""})}),t.jsx(p,{title:"store.read() result","data-testid":"store-read-result",result:r??{theme:"current",value:a.current}})]})},play:async({canvas:e})=>{await s(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await s(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},I={current:"theme-current",grayscale:["theme-grayscale","app:bg-gray-100"],"high-contrast":"theme-high-contrast"};function k(e){return H(I,{attributeName:m,...e})}const A={name:"themes: array values",tags:["use-case","props"],parameters:h({description:{story:"themes values can be string[]. dataAttributeThemeStore uses only the first value for the attribute."}}),decorators:[i({content:t.jsxs("p",{children:["With ",t.jsx("code",{children:"string[]"})," values, only the first value is used for the data attribute."," ",t.jsx("code",{children:"ThemeResult.value"})," remains the full array."]})}),u({source:l`
                ...
                const store = dataAttributeThemeStore(themes, { attributeName: 'data-theme' })
            `})],loaders:[()=>(k().write(d(I,"grayscale")),{})],render:()=>{const r=k().read();return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsx(g,{title:"html[data-theme]",appearance:"output",children:t.jsx("code",{children:typeof document<"u"?document.documentElement.getAttribute("data-theme")??"(none)":""})}),t.jsx(p,{title:"store.read() result","data-testid":"store-read-result",result:r??{theme:"grayscale",value:I.grayscale}})]})},play:async({canvas:e})=>{await s(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await s(e.getByTestId("store-read-result")).toHaveTextContent("value: [theme-grayscale, app:bg-gray-100]")}},C={name:"read",tags:["props"],parameters:h({description:{story:"store.read() reads the current theme from the element data attribute."}}),decorators:[i(),u({source:l`
                const store = dataAttributeThemeStore(themes, { attributeName: 'data-theme' })
            ...
            `})],render:()=>{const[e,r]=y.useState(null);return y.useLayoutEffect(()=>{const c=document.getElementById("comma-target");if(!c)return;c.setAttribute(m,"theme-current");const o=_(a,m,c);r(o)},[]),t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsx("div",{id:"comma-target","data-testid":"comma-target",className:"rounded border border-gray-300 p-4",children:"Target element (data-theme uses comma-separated values)"}),e&&t.jsxs(t.Fragment,{children:[t.jsx(g,{title:"target[data-theme]",appearance:"output",children:t.jsx("code",{"data-testid":"comma-attr-value",children:typeof document<"u"?document.getElementById("comma-target")?.getAttribute(m)??"(empty)":""})}),t.jsx(P,{store:e,themes:a,setThemeKeys:["current","grayscale","high-contrast"],"data-testid":"comma-demo"})]})]})},play:async({canvas:e})=>{const r=document.getElementById("comma-target");if(!r)return;const c=_(a,m,r);r.setAttribute(m,"theme-current"),c.write(d(a,"grayscale")),await R(()=>{const o=r.getAttribute(m)??"";s(o).toContain("theme-grayscale")}),await s(e.getByTestId("comma-demo-observe")).toHaveTextContent("grayscale")}},D={tags:["source"],parameters:h({source:{code:W}}),decorators:[u()]};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  tags: ['playground'],
