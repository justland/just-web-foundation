import{j as r,w as u,s as n,d as p,r as c}from"./iframe-CL66i86X.js";import{d as S}from"./dedent-BuYMbVyj.js";import{c as b}from"./compose-theme-stores-CD86eyKP.js";import{t as g}from"./theme-entry-D4S_RAMB.js";import{g as k}from"./get-prefers-color-scheme-BGoLu2Q0.js";import{o as C}from"./observe-prefers-color-scheme-DjdBdD7G.js";import{T as f}from"./theme-result-card-DH1s2_4l.js";import{T as v}from"./theme-store-demo-DgfLnZJE.js";import"./preload-helper-PPVm8Dsz.js";import"./set-theme-to-stores-C1AbMsOJ.js";import"./append-id-Vsg144gU.js";import"./button-BG3LR6CN.js";import"./resolve-class-name-CNcK3jLA.js";function y(e){return{read(){return g(e,k())},subscribe(s){return C(o=>s(g(e,o)))}}}const w=`import type { RequiredPick } from 'type-plus'
...
`,{expect:T,userEvent:x}=__STORYBOOK_MODULE_TEST__,U={title:"theme/theme-store/prefersColorSchemeThemeStore",tags:["func","version:next"],render:()=>r.jsx(r.Fragment,{})},t={light:"theme-light",dark:"theme-dark"},h={tags:["playground"],decorators:[u({content:r.jsxs("p",{children:[r.jsx("code",{children:"prefersColorSchemeThemeStore"})," is a read-only theme store for color-scheme only. Themes must include only ",r.jsx("code",{children:"light"})," and ",r.jsx("code",{children:"dark"})," keys—mirrors"," ",r.jsx("code",{children:"prefers-color-scheme"}),". Returns ",r.jsx("code",{children:"ThemeEntry"})," for ",r.jsx("code",{children:"light"})," ","or ",r.jsx("code",{children:"dark"})," based on system preference. No write method."]})}),n({source:S`
