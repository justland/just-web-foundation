import{j as t,d as i,w as h,s as d,S as g,r as n}from"./iframe-Bqt7DtID.js";import{d as u}from"./dedent-BuYMbVyj.js";import{t as l}from"./theme-entry-D4S_RAMB.js";import{c as o}from"./class-name-theme-store-zY3kyFfI.js";import{B as T}from"./button-CtNGpc_v.js";import{T as p}from"./theme-result-card-Bwy4icy_.js";import{T as M}from"./theme-store-demo-CmVnqmJ0.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-theme-map-value-6BKppRxh.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-CW-7B7MA.js";import"./append-id-Vsg144gU.js";const F=`import type { Required } from 'type-plus'
...
`,{expect:a,userEvent:k,waitFor:D}=__STORYBOOK_MODULE_TEST__,Z={title:"theme/theme-store/classNameThemeStore",tags:["func","version:1.0"],parameters:i({description:{component:"Theme store that reads and writes theme via element class names. Bakes themes at creation; read/write/subscribe use theme keys only."}}),render:()=>t.jsx(t.Fragment,{})},s={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},x={tags:["playground"],parameters:i({description:{story:"Interactive demo: Read theme, write themes via buttons, and observe subscribe updates."}}),decorators:[h(),d({source:u`
            ...
            `})],render:()=>{const e=n.useRef(null),[r,y]=n.useState(null);n.useLayoutEffect(()=>{const m=e.current;if(!m)return;const f=o(s,{element:m});f.write(l(s,"grayscale")),y(f)},[]);const c=r?.read();return t.jsxs("div",{className:"flex flex-col gap-2",children:[t.jsx("div",{ref:e,id:"target","data-testid":"target-element",className:"rounded border border-gray-300 p-4",children:"Target element (theme class is observed here)"}),r?t.jsxs(t.Fragment,{children:[t.jsx(g,{title:"target.className",appearance:"output",children:t.jsx("code",{children:e.current?.className})}),t.jsx(p,{title:"store.read() result","data-testid":"store-read-result",result:c??{theme:"grayscale",value:s.grayscale}})]}):t.jsx("p",{children:"Loading…"})]})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-grayscale")}},C={name:"themes: string value",tags:["use-case","props"],parameters:i({description:{story:"themes values can be a single string per theme."}}),decorators:[h({content:t.jsx("p",{children:"Each theme maps to one string value (one class name)."})}),d({source:u`
                ...
                const store = classNameThemeStore(themes)
            `})],loaders:[()=>(o(s).write(l(s,"current")),{})],render:()=>{const r=o(s).read();return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsx(g,{title:"html.className",appearance:"output",children:t.jsx("code",{children:typeof document<"u"?document.documentElement.className:""})}),t.jsx(p,{title:"store.read() result","data-testid":"store-read-result",result:r??{theme:"current",value:s.current}})]})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},N={current:"theme-current",grayscale:["theme-grayscale","app:bg-gray-100"],"high-contrast":"theme-high-contrast"},E={name:"themes: array values",tags:["use-case","props"],parameters:i({description:{story:"themes values can be string[] for multiple CSS classes. All classes are applied to the element."}}),decorators:[h({content:t.jsxs("p",{children:["Each theme can map to multiple class names. Setting ",t.jsx("code",{children:"grayscale"})," adds both"," ",t.jsx("code",{children:"theme-grayscale"})," and ",t.jsx("code",{children:"app:bg-gray-100"})," to the element."]})}),d({source:u`
                const themes = {
                    current: 'theme-current',
...
}`,...H.parameters?.docs?.source}}};const ee=["Playground","ElementDefault","ElementBody","ElementCustom","ThemeMapStringValue","ThemeMapArrayValues","Read","WriteStory","Subscribe","SubscribeOnlyWhenThemeChanges","Source"];export{b as ElementBody,S as ElementCustom,w as ElementDefault,x as Playground,B as Read,H as Source,R as Subscribe,I as SubscribeOnlyWhenThemeChanges,E as ThemeMapArrayValues,C as ThemeMapStringValue,j as WriteStory,ee as __namedExportsOrder,Z as default};
