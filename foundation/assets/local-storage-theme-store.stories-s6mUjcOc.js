import{j as t,d,w as m,s as u,S as A,r as g}from"./iframe-D_6mvhRd.js";import{d as h}from"./dedent-BuYMbVyj.js";import{t as i}from"./theme-entry-D4S_RAMB.js";import{l}from"./local-storage-theme-store-rbrBwh0T.js";import{B as p}from"./button-BvxDy0Ld.js";import{T as y}from"./theme-result-card-rXyXLGwz.js";import{T as J}from"./theme-store-demo-DiN5wMI7.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-theme-map-value-6BKppRxh.js";import"./parse-stored-theme-CqNOdFO7.js";import"./resolve-class-name-1fsVhyj2.js";import"./append-id-Vsg144gU.js";const L=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
...
`,{expect:a,userEvent:v,waitFor:T}=__STORYBOOK_MODULE_TEST__,ae={title:"theme/theme-store/localStorageThemeStore",tags:["func","version:1.0"],parameters:d({description:{component:"Theme store backed by localStorage. Persists across sessions; cross-tab sync via StorageEvent. Bakes themes at creation."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},c="theme-ls-demo",S={tags:["playground"],parameters:d({description:{story:"Interactive demo: Read theme, write themes via buttons, and observe subscribe updates."}}),decorators:[m(),u({source:h`
            ...
            `})],loaders:[()=>{window.localStorage.removeItem(w);const e=l(r,{storageKey:w});return e.write(i(r,"current")),{store:e}}],render:(e,{loaded:{store:s}})=>{const n=s.read();return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(y,{title:"store.read() result","data-testid":"store-read-result",result:n??{theme:"current",value:r.current}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: current"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: theme-current")}},P={current:"theme-current",grayscale:["theme-grayscale","app:bg-gray-100"],"high-contrast":"theme-high-contrast"},K={name:"themes: array values",tags:["props"],parameters:d({description:{story:"themes values can be string[]. Stored and retrieved value is the full array."}}),decorators:[m({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"string[]"}),". ",t.jsx("code",{children:"ThemeResult.value"})," persists the full array."]})}),u({source:h`
                ...
                const store = localStorageThemeStore(themes, { storageKey: 'theme' })
            `})],loaders:[()=>{window.localStorage.removeItem(w);const e=l(P,{storageKey:w});return e.write(i(P,"grayscale")),{store:e}}],render:(e,{loaded:{store:s}})=>{const n=s.read();return t.jsx("div",{className:"flex flex-col gap-4",children:t.jsx(y,{title:"store.read() result","data-testid":"store-read-result",result:n??{theme:"grayscale",value:P.grayscale}})})},play:async({canvas:e})=>{await a(e.getByTestId("store-read-result")).toHaveTextContent("theme: grayscale"),await a(e.getByTestId("store-read-result")).toHaveTextContent("value: [theme-grayscale, app:bg-gray-100]")}},G={light:"theme-light",dark:{themeValue:"theme-dark",contrast:"high"}},I={name:"themes: object value",tags:["props"],parameters:d({description:{story:"themes values can be { themeValue: string | string[] }. Extra props (e.g. contrast) are preserved when read from storage."}}),decorators:[m({content:t.jsxs("p",{children:["Each theme can map to ",t.jsx("code",{children:"{ themeValue, ...extra }"}),". Stored and retrieved value preserves extra props for user metadata."]})}),u({source:h`
                const themes = {
                    light: 'theme-light',
...
}`,...k.parameters?.docs?.source}}};const oe=["Playground","StoredValidationShapeMismatch","ParseOption","StorageKey","ThemeMapStringValue","ThemeMapArrayValues","ThemeMapObjectValue","Read","ReadWhenEmpty","Write","Subscribe","SubscribeOnlyWhenThemeChanges","SubscribeUnsubscribe","Source"];export{x as ParseOption,S as Playground,C as Read,B as ReadWhenEmpty,k as Source,b as StorageKey,f as StoredValidationShapeMismatch,O as Subscribe,j as SubscribeOnlyWhenThemeChanges,H as SubscribeUnsubscribe,K as ThemeMapArrayValues,I as ThemeMapObjectValue,E as ThemeMapStringValue,R as Write,oe as __namedExportsOrder,ae as default};
