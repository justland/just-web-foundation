import{r as m,j as t,d as i,w as y,s as T,S as p}from"./iframe-BvUeje02.js";import{d as f}from"./dedent-BuYMbVyj.js";import{o as b}from"./observe-theme-from-stores-D5IPs1nT.js";import{p as B}from"./parse-stored-theme-Dj4VCwi6.js";import{s as K}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as C}from"./theme-entry-D4S_RAMB.js";import{l as j}from"./local-storage-theme-store-BxhG8YWn.js";import{B as d}from"./button-A39wmDsa.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";import"./resolve-class-name-Bjyp5yMi.js";function k(e,r){const{storageKey:u,defaultTheme:s}=r,a=m.useMemo(()=>j(e,{storageKey:u}),[e,u]),[w,x]=m.useState(()=>{if(typeof window<"u"&&window.localStorage){const n=window.localStorage.getItem(u);return B(e,n)??s}return s});m.useEffect(()=>b([a],s,x),[a,s]);const E=m.useCallback(n=>{K([a],C(e,n))},[a,e]);return[w,E]}const R=`import { useCallback, useEffect, useMemo, useState } from 'react'
