import{j as e,d as u,w as p,s as h,S as y,r as c}from"./iframe-BwCvR-Rn.js";import{d as g}from"./dedent-BuYMbVyj.js";import{s as x}from"./set-theme-by-class-name-BC2y_ikC.js";import{u as v}from"./use-attribute-CYkqfL2Z.js";import{B as k}from"./button-CTG5KGTe.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-class-name-CEwuZh68.js";const w=`import type { ThemeMap } from './theme.types.ts'
...
`,{expect:r,userEvent:o}=__STORYBOOK_MODULE_TEST__,W={title:"theme/setThemeByClassName",tags:["func","version:next"],parameters:u({description:{component:"A utility that sets the theme by applying the theme's class name(s) to an element, removing other theme classes first."}}),render:()=>e.jsx(e.Fragment,{})},l={tags:["use-case"],decorators:[p({content:e.jsxs("p",{children:[e.jsx("code",{children:"setThemeByClassName"})," by default sets the theme on"," ",e.jsx("code",{children:"document.documentElement"}),"."]})}),h({source:g`
                setThemeByClassName({
                    themes: { light: 'your-light-class', dark: 'your-dark-class' },
                    theme: ${"<value>"}
                })
            `})],render:()=>{const[t]=v("class");return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex gap-2",children:["light","dark"].map(s=>e.jsx(k,{onPress:()=>{x({themes:{light:"your-light-class",dark:"your-dark-class"},theme:s})},children:s},s))}),e.jsx(y,{title:"document.documentElement.className",appearance:"output",children:e.jsx("code",{"data-testid":"class-name",children:t})})]})},play:async({canvas:t,step:s})=>{await s("light",async()=>{const a=t.getByRole("button",{name:"light"});await o.click(a),await r(t.getByTestId("class-name")).toHaveTextContent("your-light-class")}),await s("dark",async()=>{const a=t.getByRole("button",{name:"dark"});await o.click(a),await r(t.getByTestId("class-name")).toHaveTextContent("your-dark-class")})}},m={tags:["use-case"],decorators:[p({content:e.jsx(e.Fragment,{children:e.jsxs("p",{children:["When a theme value is an array, ",e.jsx("strong",{children:"all"})," values are applied as class names."]})})}),h({source:g`
                setThemeByClassName({
                    themes: {
            ...
            `})],render:()=>{const[t]=v("class"),s={light:["your-light-class","app:text-gray-100","app:bg-gray-800"],dark:["your-dark-class","app:text-gray-800","app:bg-gray-100"]};return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex gap-2",children:Object.keys(s).map(a=>e.jsx(k,{onPress:()=>{x({themes:s,theme:a})},children:a},a))}),e.jsx(y,{title:"document.documentElement.className",appearance:"output",children:e.jsx("code",{"data-testid":"class-name",children:t})})]})},play:async({canvas:t,step:s})=>{await s("light",async()=>{const a=t.getByRole("button",{name:"light"});await o.click(a),await r(t.getByTestId("class-name")).toHaveTextContent("your-light-class app:text-gray-100 app:bg-gray-800")}),await s("dark",async()=>{const a=t.getByRole("button",{name:"dark"});await o.click(a),await r(t.getByTestId("class-name")).toHaveTextContent("your-dark-class app:text-gray-800 app:bg-gray-100")})}},i={tags:["use-case"],parameters:{...u({description:{story:"Set theme on a specific element via the element option."}})},decorators:[p({content:e.jsxs("p",{children:["Theme classes are applied to the target div below instead of"," ",e.jsx("code",{children:"document.documentElement"}),"."]})}),h({source:g`setThemeByClassName({
                themes: { light: 'your-light-class', dark: 'your-dark-class' },
                theme: ${"<value>"},
                element: myElement,
            })`})],render:()=>{const t=c.useRef(null),[s,a]=c.useState(null),[T,b]=c.useState(null),C=c.useCallback(n=>{t.current=n,a(n)},[]),[B]=v("class",s??void 0);return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex gap-2",children:["light","dark"].map(n=>e.jsx(k,{onPress:()=>{const f=t.current;f&&(x({themes:{light:"your-light-class",dark:"your-dark-class"},theme:n,element:f}),b(n))},children:n},n))}),e.jsx("div",{ref:C,className:"min-h-8 rounded border border-gray-300 p-2",children:T!==null&&e.jsxs("span",{children:["Current theme: ",e.jsx("span",{"data-testid":"current-theme",children:T})]})}),e.jsx(y,{title:"customElement.className",appearance:"output",children:e.jsx("code",{children:B})})]})},play:async({canvas:t,step:s})=>{await s("light",async()=>{const a=t.getByRole("button",{name:"light"});await o.click(a),await r(t.getByTestId("current-theme")).toHaveTextContent("light")}),await s("dark",async()=>{const a=t.getByRole("button",{name:"dark"});await o.click(a),await r(t.getByTestId("current-theme")).toHaveTextContent("dark")})}},d={tags:["source"],parameters:u({source:{code:w}}),decorators:[h()]};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...d.parameters?.docs?.source}}};const P=["BasicUsage","WithThemeArray","WithCustomElement","Source"];export{l as BasicUsage,d as Source,i as WithCustomElement,m as WithThemeArray,P as __namedExportsOrder,W as default};
