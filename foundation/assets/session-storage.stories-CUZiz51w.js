import{j as t,d as n,w as i,s as c,r as _,S as A}from"./iframe-BjeGB4gq.js";import{d}from"./dedent-BuYMbVyj.js";import{t as y}from"./theme-entry-D4S_RAMB.js";import{r as m,w as h}from"./write-session-storage-BbUQMduQ.js";import{B}from"./button-CQx9rulV.js";import{T as l}from"./theme-result-card-B77JIzzb.js";import{T as H}from"./theme-store-demo-D52GwEh5.js";import"./preload-helper-PPVm8Dsz.js";import"./write-web-storage-55ynkFOs.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-B8ntG9L-.js";import"./append-id-Vsg144gU.js";const{expect:s,userEvent:C}=__STORYBOOK_MODULE_TEST__,$={title:"theme/session-storage",tags:["func","version:1.0"],parameters:n({description:{component:"Low-level functions for reading and writing theme via sessionStorage: readSessionStorage, writeSessionStorage. Persists per tab. No subscribe at function level."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},o="theme-ss-func-demo";function O(e){return{read:()=>m(r,e),write:u=>h(r,e,u),subscribe:void 0}}const S={tags:["playground"],parameters:n({description:{story:"Interactive demo: readSessionStorage, writeSessionStorage. No subscribe at function level."}}),decorators:[i(),c({source:d`
                const store = {
