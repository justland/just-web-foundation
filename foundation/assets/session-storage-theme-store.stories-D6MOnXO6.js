import{j as t,d as l,w as h,s as m,S as D,r as u}from"./iframe-vyhya85z.js";import{d as g}from"./dedent-BuYMbVyj.js";import{t as c}from"./theme-entry-D4S_RAMB.js";import{d as L}from"./dummy-theme-store-DcCfgetv.js";import{r as J,w as z}from"./write-web-storage-55ynkFOs.js";import{B as p}from"./button-DPJpH6iE.js";import{T as y}from"./theme-result-card-CS-Rwz0h.js";import{T as U}from"./theme-store-demo-CG6-9jNM.js";import"./preload-helper-PPVm8Dsz.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-CwYNgRAK.js";import"./append-id-Vsg144gU.js";function V(e,s,a){if(window?.sessionStorage)return J(e,s,{storage:window.sessionStorage,parse:a?.parse})}function $(e,s,a,o){window?.sessionStorage&&z(e,s,a,{storage:window.sessionStorage,stringify:o?.stringify,onError:o?.onError})}function d(e,s){const{storageKey:a,parse:o,stringify:v,onError:Y}=s;if(!window?.sessionStorage)return L;const T=new Set;let x=G()?.theme??void 0;function G(){return V(e,a,{parse:o})}function W(){const S=G(),f=S?.theme??void 0;if(f!==x){x=f;for(const E of T)E(S)}}return{read:G,write(S){$(e,a,S,{stringify:v,onError:Y}),W()},subscribe(S){T.add(S);const f=E=>{E.key===a&&E.storageArea===window.sessionStorage&&W()};return window.addEventListener("storage",f),()=>{T.delete(S),window.removeEventListener("storage",f)}}}}const q=`import { dummyThemeStore } from '../../../testing/theme/dummy-theme-store.ts'
...
`,{expect:n,userEvent:w,waitFor:b}=__STORYBOOK_MODULE_TEST__,me={title:"theme/theme-store/sessionStorageThemeStore",tags:["func","version:1.0"],parameters:l({description:{component:"Theme store backed by sessionStorage. Persists per tab. Bakes themes at creation."}}),render:()=>t.jsx(t.Fragment,{})},r={current:"theme-current",next:"theme-next",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},i="theme-ss-demo",K={tags:["playground"],parameters:l({description:{story:"Interactive demo: Read theme, write themes via buttons, and observe subscribe updates."}}),decorators:[h(),m({source:g`
                const store = sessionStorageThemeStore(themes, { storageKey: 'app-theme' })
                <ThemeStoreDemo2 store={store} themes={themes} />
            `})],loaders:[()=>(window.sessionStorage.removeItem(i),{})],render:()=>{const e=d(r,{storageKey:i});return t.jsx(U,{store:e,themes:r})},play:async({canvas:e})=>{await w.click(e.getByTestId("theme-store-demo-btn-write-grayscale")),await b(()=>n(e.getByTestId("theme-store-demo-observe")).toHaveTextContent("grayscale")),await n(e.getByTestId("theme-store-demo-observe")).toHaveTextContent("theme-grayscale")}},F="theme-ss-parse";function Q(e,s){let a;try{a=s?JSON.parse(s):void 0}catch{return}if(!a?.theme||typeof a.theme!="string"||!(a.theme in e))return;const o=a.theme;return{theme:o,value:e[o]}}const C={name:"options.parse",tags:["props","use-case"],decorators:[h({content:t.jsxs(t.Fragment,{children:[t.jsxs("p",{children:["The ",t.jsx("code",{children:"options.parse"})," allows you to provide a custom parse function to parse the stored value to a specific structure you wanted. Use it when migrating from legacy formats, supporting custom serialization, or relaxing validation."]}),t.jsxs("p",{children:["The example below pre-seeds the sessionStorage with legacy format"," ",t.jsx("code",{children:'{ theme: "grayscale" }'})," (no value)."]})]})}),m({source:g`
            ...
            `})],loaders:[()=>(window.sessionStorage.removeItem(i),{})],render:()=>{const e=u.useMemo(()=>d(r,{storageKey:i}),[]),[s,a]=u.useState(0),[o,v]=u.useState(null);u.useEffect(()=>e.subscribe(T=>{a(x=>x+1),v(T)}),[e]);const Y=o?.theme??"(none)";return t.jsxs("div",{className:"flex flex-col gap-4","data-testid":"subscribe-only-when-theme-changes",children:[t.jsx(D,{title:"Handler invocations",appearance:"output",children:t.jsx("pre",{"data-testid":"invocation-count",className:"font-mono",children:s})}),t.jsx(D,{title:"Observed theme",appearance:"output",children:t.jsx("pre",{"data-testid":"observed-theme",className:"font-mono",children:Y})}),t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(p,{"data-testid":"write-grayscale-twice",onPress:()=>{e.write(c(r,"grayscale")),e.write(c(r,"grayscale"))},children:"write(grayscale) twice"}),t.jsx(p,{"data-testid":"write-high-contrast",onPress:()=>e.write(c(r,"high-contrast")),children:"write(high-contrast)"})]})]})},play:async({canvas:e})=>{await n(e.getByTestId("invocation-count")).toHaveTextContent("0"),await w.click(e.getByTestId("write-grayscale-twice")),await b(()=>n(e.getByTestId("invocation-count")).toHaveTextContent("1")),await n(e.getByTestId("observed-theme")).toHaveTextContent("grayscale")}},k={name:"subscribe: unsubscribe",tags:["props"],parameters:l({description:{story:"After calling the function returned by subscribe(), further write() calls do not invoke the handler."}}),decorators:[h(),m({source:g`
                const store = sessionStorageThemeStore(themes, { storageKey: 'theme' })
                const unsubscribe = store.subscribe((theme) => console.log(theme))
                store.write(themeEntry(themes, 'grayscale'))
                unsubscribe()
                store.write(themeEntry(themes, 'current')) // handler not called
            `})],loaders:[()=>(window.sessionStorage.removeItem(i),{})],render:()=>{const e=u.useMemo(()=>d(r,{storageKey:i}),[]),[s,a]=u.useState(void 0),o=u.useRef(null);u.useEffect(()=>{if(!o.current)return o.current=e.subscribe(a),()=>{o.current?.(),o.current=null}},[e]);const v=s?.theme??"current";return t.jsxs("div",{className:"flex flex-col gap-4",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(p,{"data-testid":"write-grayscale",onPress:()=>e.write(c(r,"grayscale")),children:"write('grayscale')"}),t.jsx(p,{"data-testid":"write-current",onPress:()=>e.write(c(r,"current")),children:"write('current')"}),t.jsx(p,{"data-testid":"unsubscribe",onPress:()=>{o.current?.(),o.current=null},children:"unsubscribe()"})]}),t.jsx(y,{title:"store.subscribe() receives (frozen after unsubscribe)","data-testid":"store-subscribe-result",result:c(r,v)})]})},play:async({canvas:e})=>{await w.click(e.getByTestId("write-grayscale")),await b(()=>n(e.getByTestId("store-subscribe-result")).toHaveTextContent("grayscale")),await w.click(e.getByTestId("unsubscribe")),await w.click(e.getByTestId("write-current")),await n(e.getByTestId("store-subscribe-result")).toHaveTextContent("grayscale")}},A={tags:["source"],parameters:l({source:{code:q}}),decorators:[m()]};K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  tags: ['playground'],
