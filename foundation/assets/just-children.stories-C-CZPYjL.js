...
`,C=`import type { JustChildrenProps } from '@just-web/toolkits'
import { resolveChildren } from '@just-web/toolkits'
import { StoryCard } from '@repobuddy/storybook'
...
`,$={title:"children/JustChildren",tags:["version:1.0","!test"],parameters:t({description:{component:"`JustChildren` extends the basic `children` type with a callback to invert the flow on control. This allows the consumer to fully control the resulting `children` value."}}),render:()=>e.jsx(e.Fragment,{})},s={decorators:[c({content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("code",{children:"JustChildren"})," extends the basic ",e.jsx("code",{children:"children"})," type with a callback to invert the flow on control. This allows you to fully control the resulting"," ",e.jsx("code",{children:"children"})," value."]}),e.jsxs("p",{children:["The behavior when using ",e.jsx("code",{children:"JustChildren"})," should be consistent among all components that use it. This provides a consistent API for the consumer."]}),e.jsxs("ul",{className:"list-disc list-inside",children:[e.jsxs("li",{children:["When ",e.jsx("code",{children:"undefined"})," is passed, the default ",e.jsx("code",{children:"children"})," from render props should be applied."]}),e.jsxs("li",{children:["When a ",e.jsx("code",{children:"ReactNode"})," is passed, it is used as the children (replaces default)."]}),e.jsxs("li",{children:["When a ",e.jsx("code",{children:"function"})," is passed, it must receive the current render props with the default ",e.jsx("code",{children:"children"}),"."]}),e.jsxs("ul",{className:"list-disc list-inside pl-4",children:[e.jsxs("li",{children:["When the function returns ",e.jsx("code",{children:"undefined"}),", the ",e.jsx("code",{children:"children"})," should be ",e.jsx("code",{children:"undefined"}),"."]}),e.jsxs("li",{children:["When the function returns a ",e.jsx("code",{children:"ReactNode"}),", that will be the"," ",e.jsx("code",{children:"children"})," to be rendered."]})]})]})]})})]},r={name:"JustChildren",tags:["type"],parameters:t({source:{code:u}}),decorators:[c({title:"JustChildren",content:e.jsx(e.Fragment,{children:e.jsxs("p",{children:["Compare to ",e.jsx("code",{children:"JustChildrenProps"}),", ",e.jsx("code",{children:"JustChildren"})," allows you to use it on its own (e.g. for a variable or parameter that can be static or a resolver)."]})})}),i()]};a(r,{availableImports:{"@just-web/toolkits":h,"@repobuddy/storybook":p,react:l},code:r.parameters?.docs?.source?.code});const n={name:"JustChildrenProps",tags:["type"],parameters:t({source:{code:C}}),decorators:[c({title:"JustChildrenProps",content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("code",{children:"JustChildrenProps"})," defines the ",e.jsx("code",{children:"children"})," property with the type"," ",e.jsx("code",{children:"JustChildren"}),"."]}),e.jsxs("p",{children:["It is a ready-made type for the typical ",e.jsx("code",{children:"children"})," props use case."]})]})}),i()]};a(n,{availableImports:{"@just-web/toolkits":h,"@repobuddy/storybook":p,react:l},code:n.parameters?.docs?.source?.code});const o={name:"JustChildrenFnProps",tags:["type"],parameters:t({source:{code:f}}),decorators:[c({title:"JustChildrenFnProps",content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("code",{children:"JustChildrenFnProps"})," is the argument type for ",e.jsx("code",{children:"JustChildren"})," ","resolver functions. It is ",e.jsx("code",{children:"RenderProps"})," merged with"," ",e.jsx("code",{children:"{ children?: ReactNode }"}),"."]}),e.jsxs("p",{children:["Use it to type the parameter when writing a ",e.jsx("code",{children:"children"})," function so you get access to render props and the current default ",e.jsx("code",{children:"children"}),"."]})]})}),i()]};a(o,{availableImports:{"@just-web/toolkits":h,"@repobuddy/storybook":p,react:l},code:o.parameters?.docs?.source?.code});const d={tags:["source"],parameters:t({source:{code:m}}),decorators:[i()]};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
}`,...d.parameters?.docs?.source}}};const E=["Specification","JustChildrenStory","JustChildrenPropsStory","JustChildrenFnPropsStory","Source"];export{o as JustChildrenFnPropsStory,n as JustChildrenPropsStory,r as JustChildrenStory,d as Source,s as Specification,E as __namedExportsOrder,$ as default};
