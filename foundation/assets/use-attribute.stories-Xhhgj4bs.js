import{r as h,j as t,d as l,w as g,s as b,S as y}from"./iframe-CL66i86X.js";import{d as x}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-attribute-DJMrXwPX.js";import{B as n}from"./button-BG3LR6CN.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-class-name-CNcK3jLA.js";function f(e,a=typeof document<"u"?document.documentElement:void 0){const[o,u]=h.useState(()=>a?.getAttribute(e)??null);h.useEffect(()=>{if(!a)return;u(a.getAttribute(e));const i=E({[e]:w=>{u(w)}},a);return()=>i.disconnect()},[a,e]);const T=h.useCallback(i=>{a&&(i===null?a.removeAttribute(e):a.setAttribute(e,i))},[a,e]);return[o,T]}const S=`import { useCallback, useEffect, useState } from 'react'
