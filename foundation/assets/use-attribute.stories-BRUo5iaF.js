import{r as h,j as t,d as l,w as g,s as b,S as f}from"./iframe-BRf7Axb3.js";import{d as y}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-attribute-DJMrXwPX.js";import{B as n}from"./button-CkgYDtEi.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-class-name-Bq_FyHcK.js";function x(e,a=typeof document<"u"?document.documentElement:void 0){const[o,u]=h.useState(()=>a?.getAttribute(e)??void 0);h.useEffect(()=>{if(!a)return;u(a.getAttribute(e)??void 0);const i=E({[e]:w=>{u(w??void 0)}},a);return()=>i.disconnect()},[a,e]);const T=h.useCallback(i=>{a&&(i==null?a.removeAttribute(e):a.setAttribute(e,i))},[a,e]);return[o,T]}const S=`import { useCallback, useEffect, useState } from 'react'
...
`,{expect:s,userEvent:r}=__STORYBOOK_MODULE_TEST__,j={title:"react/hooks/useAttribute",tags:["func","version:1.0"],parameters:l({description:{component:"React hook that returns the current value of an attribute on a target element and a setter to update it. Stays in sync when the attribute changes elsewhere."}}),render:()=>t.jsx(t.Fragment,{})},c="data-theme",d={parameters:l({description:{story:"Observe and set an attribute on document.documentElement. Pass null to setValue to remove the attribute."},source:{code:y`
                const [value, setValue] = useAttribute('data-theme')
                setValue('dark')
                setValue(null) // removes attribute
            `}}),decorators:[g(),b()],render:()=>{const[e,a]=x(c);return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:()=>a("light"),children:"Set light"}),t.jsx(n,{onPress:()=>a("dark"),children:"Set dark"}),t.jsx(n,{onPress:()=>a(null),children:"Remove"})]}),t.jsx(f,{title:t.jsxs(t.Fragment,{children:["Current ",t.jsx("code",{children:c})]}),appearance:"output",children:t.jsx("pre",{"data-testid":"current-value",className:"font-mono",children:e??"(not set)"})})]})},play:async({canvas:e,step:a})=>{await a("Set light",async()=>{await r.click(e.getByRole("button",{name:"Set light"})),await s(e.getByTestId("current-value")).toHaveTextContent("light")}),await a("Set dark",async()=>{await r.click(e.getByRole("button",{name:"Set dark"})),await s(e.getByTestId("current-value")).toHaveTextContent("dark")}),await a("Remove",async()=>{await r.click(e.getByRole("button",{name:"Remove"})),await s(e.getByTestId("current-value")).toHaveTextContent("(not set)")})}},m={parameters:l({description:{story:"Observe and set an attribute on a specific element by passing it as the second argument."},source:{code:y`
                const [element, setElement] = useState<HTMLDivElement | null>(null)
                const [value, setValue] = useAttribute('data-foo', element ?? undefined)
                return <div ref={setElement}>...</div>
            `}}),decorators:[g(),b()],render:()=>{const[e,a]=h.useState(null),[o,u]=x("data-foo",e??void 0);return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsx("div",{ref:a,className:"rounded border border-gray-300 p-4","data-testid":"target-element",children:"Target element (data-foo is observed here)"}),t.jsxs("div",{className:"flex flex-wrap gap-2",children:[t.jsx(n,{onPress:()=>u("a"),children:'Set to "a"'}),t.jsx(n,{onPress:()=>u("b"),children:'Set to "b"'}),t.jsx(n,{onPress:()=>u(null),children:"Remove"})]}),t.jsx(f,{title:t.jsxs(t.Fragment,{children:["Current ",t.jsx("code",{children:"data-foo"})," on target"]}),appearance:"output",children:t.jsx("pre",{"data-testid":"current-value",className:"font-mono",children:o??"(not set)"})})]})},play:async({canvas:e,step:a})=>{await a("Set to a",async()=>{await r.click(e.getByRole("button",{name:'Set to "a"'})),await s(e.getByTestId("current-value")).toHaveTextContent("a")}),await a("Remove",async()=>{await r.click(e.getByRole("button",{name:"Remove"})),await s(e.getByTestId("current-value")).toHaveTextContent("(not set)")})}},v={parameters:l({description:{story:"The hook stays in sync when the attribute is changed outside of setValue (e.g. by another component or direct DOM mutation)."},source:{code:y`
            ...
            `}}),decorators:[g(),b()],render:()=>{const[e]=x(c),a=()=>{const o=document.documentElement.getAttribute(c)==="synced"?null:"synced";o===null?document.documentElement.removeAttribute(c):document.documentElement.setAttribute(c,o)};return t.jsxs("div",{className:"flex flex-col gap-4 font-sans",children:[t.jsx(n,{onPress:a,children:"Toggle via setAttribute (external)"}),t.jsxs(f,{appearance:"output",children:[t.jsx("p",{className:"mb-2",children:"Hook value (updates when attribute changes elsewhere):"}),t.jsx("pre",{"data-testid":"current-value",className:"font-mono",children:e??"(not set)"})]})]})},play:async({canvas:e})=>{const a=e.getByRole("button",{name:/Toggle via setAttribute/});await r.click(a),await s(e.getByTestId("current-value")).toHaveTextContent("synced"),await r.click(a),await s(e.getByTestId("current-value")).toHaveTextContent("(not set)")}},p={tags:["source"],parameters:l({source:{code:S}}),decorators:[b()]};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
}`,...p.parameters?.docs?.source}}};const D=["BasicUsage","CustomElement","SyncFromElsewhere","Source"];export{d as BasicUsage,m as CustomElement,p as Source,v as SyncFromElsewhere,D as __namedExportsOrder,j as default};
