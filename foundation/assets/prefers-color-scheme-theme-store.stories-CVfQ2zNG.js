import{j as r,w as u,s as n,d as p,r as m}from"./iframe-BRf7Axb3.js";import{d as S}from"./dedent-BuYMbVyj.js";import{t as y}from"./theme-entry-D4S_RAMB.js";import{c as b}from"./compose-theme-stores-CD86eyKP.js";import{g as C}from"./get-prefers-color-scheme-C16oSBYU.js";import{o as k}from"./observe-prefers-color-scheme-DjdBdD7G.js";import{T as g}from"./theme-result-card-DEniDmnf.js";import{T as v}from"./theme-store-demo-De_vsOVS.js";import"./preload-helper-PPVm8Dsz.js";import"./set-theme-to-stores-C1AbMsOJ.js";import"./append-id-Vsg144gU.js";import"./button-CkgYDtEi.js";import"./resolve-class-name-Bq_FyHcK.js";function w(e,t){const c=C("light");return y(e,c)}function x(e,t){return k(o=>t(y(e,o)))}function T(e){return{read(){return w(e)},subscribe(t){return x(e,t)}}}const P=`import type { RequiredPick } from 'type-plus'
...
`,{expect:f,userEvent:R}=__STORYBOOK_MODULE_TEST__,W={title:"theme/theme-store/prefersColorSchemeThemeStore",tags:["func","version:1.0"],render:()=>r.jsx(r.Fragment,{})},s={light:"theme-light",dark:"theme-dark"},h={tags:["playground"],decorators:[u({content:r.jsxs("p",{children:[r.jsx("code",{children:"prefersColorSchemeThemeStore"})," is a read-only theme store for color-scheme only. Themes must include only ",r.jsx("code",{children:"light"})," and ",r.jsx("code",{children:"dark"})," keys—mirrors"," ",r.jsx("code",{children:"prefers-color-scheme"}),". Returns ",r.jsx("code",{children:"ThemeEntry"})," for ",r.jsx("code",{children:"light"})," ","or ",r.jsx("code",{children:"dark"})," based on system preference. No write method."]})}),n({source:S`
