import{j as o,d as i,w as l,s as d,r}from"./iframe-vyhya85z.js";import{d as b}from"./dedent-BuYMbVyj.js";import{t as S}from"./theme-entry-D4S_RAMB.js";import{c as h}from"./compose-theme-stores-CD86eyKP.js";import{c as A}from"./class-name-theme-store-DJi-9jas.js";import{d as j}from"./data-attribute-theme-store-Ds1TSRI6.js";import{i as n}from"./in-memory-theme-store-fTg_sUo_.js";import{l as _}from"./local-storage-theme-store-DtSaA4JP.js";import{B as P}from"./button-DPJpH6iE.js";import{T as y}from"./theme-result-card-CS-Rwz0h.js";import{T as H}from"./theme-store-demo-CG6-9jNM.js";import"./preload-helper-PPVm8Dsz.js";import"./set-theme-to-stores-C1AbMsOJ.js";import"./dummy-theme-store-DcCfgetv.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./findKey-D_Zca1Sl.js";import"./observe-attribute-DJMrXwPX.js";import"./get-data-attribute-Bl9c_7h4.js";import"./get-attribute-BI4biMNS.js";import"./observe-data-attribute-CrIGpGqK.js";import"./write-web-storage-55ynkFOs.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-class-name-CwYNgRAK.js";import"./append-id-Vsg144gU.js";const O=`import type { Required, RequiredPick } from 'type-plus'
...
`,{expect:u,userEvent:f,waitFor:p}=__STORYBOOK_MODULE_TEST__,le={title:"theme/composeThemeStores",tags:["func","version:1.0"],parameters:i({description:{component:"Composes multiple theme stores into one. Waterfall read (first non-empty), write-to-all, aggregated subscribe. No initial notify."}}),render:()=>o.jsx(o.Fragment,{})},t={current:"theme-current",grayscale:"theme-grayscale","high-contrast":"theme-high-contrast"},g={tags:["playground"],parameters:i({description:{story:"Interactive demo with ThemeStoreDemo2. Composed store from 2 in-memory stores, defaultTheme current."},source:{code:b`
            ...
            `}}),decorators:[l(),d()],render:()=>{const e=r.useMemo(()=>h(t,[[A,{element:document.body}],[j,{attributeName:"data-theme",element:document.body}],[_,{storageKey:"my-theme-key"}]],{defaultTheme:"current"}),[]);return o.jsx(H,{store:e,themes:t})}};function z(e,s){const a=n(e);return s.initialTheme!==void 0&&a.write?.(S(e,s.initialTheme)),a}const F={tags:["props"],parameters:i({description:{story:"Custom store factory with options. The F generic infers the factory type, enabling options autocomplete for user-defined factories."},source:{code:b`
            ...
            `}}),decorators:[l(),d()],render:()=>{const e=r.useMemo(()=>h(t,[[z,{initialTheme:"grayscale"}]],{defaultTheme:"current"}),[]);return o.jsx(H,{store:e,themes:t})},play:async({canvas:e})=>{await p(()=>u(e.getByTestId("theme-store-demo-observe")).toHaveTextContent("grayscale"))}},W={tags:["source"],parameters:i({source:{code:O}}),decorators:[d()]};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  tags: ['playground'],
