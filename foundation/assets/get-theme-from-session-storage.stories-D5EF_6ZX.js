import{j as n,d as y,w as a,s}from"./iframe-BwCvR-Rn.js";import{d as r}from"./dedent-BuYMbVyj.js";import{d as i}from"./try-parse-json-83P4r8LE.js";import{g as m,s as w}from"./set-theme-to-session-storage-Cr54TX08.js";import{S as d}from"./show-theme-from-session-storage-Dw-G9CEC.js";import"./preload-helper-PPVm8Dsz.js";import"./theme-result-card-BVwVUOcQ.js";import"./append-id-Vsg144gU.js";const f=`import { tryParseJSON } from '../_internal/utils/try-parse-json.ts'
...
`,{expect:o}=__STORYBOOK_MODULE_TEST__,_={title:"theme/getThemeFromSessionStorage",tags:["func","version:next"],parameters:y({description:{component:"Gets the theme key stored in sessionStorage, validated against a themes map. Returns defaultTheme when the key is missing, empty, or the stored value is not in the themes map."}}),render:()=>n.jsx(n.Fragment,{})},S={default:"text-white",grayscale:"text-gray-100"},h={tags:["use-case"],parameters:y({description:{story:"Gets theme from sessionStorage when a valid theme key is stored."}}),decorators:[a(),s({source:r`
            ...
            `})],render:(e,{loaded:{options:t}})=>n.jsx(d,{...t}),play:async({loaded:{options:e}})=>{const t=m(e);await o(t?.theme).toBe("default"),await o(t?.value).toEqual(["text-white","bg-white"])}},g={name:"Invalid stored value without theme",tags:["unit"],parameters:y({description:{story:"Returns undefined when the stored value is invalid and no defaultTheme is provided."}}),loaders:[()=>(window.sessionStorage.setItem("theme-no-default","invalid-theme"),{options:i({themes:S,storageKey:"theme-no-default"})})],decorators:[a({content:n.jsx(n.Fragment,{children:n.jsxs("p",{children:["Returns ",n.jsx("code",{children:"undefined"})," when storage is invalid and ",n.jsx("code",{children:"theme"})," is not provided"]})})}),s({source:r`
                getThemeFromSessionStorage({
                    themes: { default: 'text-white', grayscale: 'text-gray-100' },
                    storageKey: 'theme-no-default',
                })
            `})],render:(e,{loaded:{options:t}})=>n.jsx(d,{...t}),play:async({loaded:{options:e}})=>{const t=m(e);await o(t).toBeUndefined()}},p={tags:["source"],parameters:y({source:{code:f}}),decorators:[s()]};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...p.parameters?.docs?.source}}};const O=["BasicUsage","ThemeNotExists","InvalidStoredValue","WithThemeArray","InvalidStoredValueNoTheme","Source"];export{h as BasicUsage,c as InvalidStoredValue,g as InvalidStoredValueNoTheme,p as Source,l as ThemeNotExists,u as WithThemeArray,O as __namedExportsOrder,_ as default};
