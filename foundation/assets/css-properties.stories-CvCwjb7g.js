import{j as e,w as s,s as n,d as p}from"./iframe-BRf7Axb3.js";import{d as a}from"./dedent-BuYMbVyj.js";import"./preload-helper-PPVm8Dsz.js";const c=new Proxy({},{get(i,m,l){return d=>d}}),S=`import type { Properties } from 'csstype'
...
export interface CSSProperties<TLength = string | number, TTime = string & {}>
	extends Properties<TLength, TTime>,
		CustomProperties {}
`,{expect:u}=__STORYBOOK_MODULE_TEST__,P={title:"style/CSSProperties",tags:["type","version:1.0","!test"],render:()=>e.jsx(e.Fragment,{})},r={tags:["source"],parameters:p({source:{code:S}}),decorators:[s({content:e.jsxs("p",{children:[e.jsx("code",{children:"CSSProperties"})," extends CSS properties to support custom properties (",e.jsx("code",{children:"--*"}),")."]})}),n()]},t={tags:["use-case"],parameters:p({source:{code:a`let style: CSSProperties = {
                color: 'red',
