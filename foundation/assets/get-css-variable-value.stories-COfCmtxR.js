import{j as r,d as n,w as s,s as c,S as m,r as y}from"./iframe-BjeGB4gq.js";import{d as S}from"./dedent-BuYMbVyj.js";import{d as f}from"./define-css-properties-Dh8E5HRZ.js";import{g as a}from"./get-css-variable-value-B4-Axp-e.js";import"./preload-helper-PPVm8Dsz.js";const h=`import type { CreateTuple } from 'type-plus'
...
`,{expect:o}=__STORYBOOK_MODULE_TEST__,j={title:"style/getCSSVariableValue",tags:["func","version:1.0"],parameters:n({description:{component:"A utility function to retrieve CSS custom property values from an element or document body."}}),render:()=>r.jsx(r.Fragment,{})},i={tags:["source"],parameters:n({source:{code:h}}),decorators:[s({content:r.jsxs("p",{children:[r.jsx("code",{children:"getCSSVariableValue"})," retrieves CSS custom property values from an element or"," ",r.jsx("code",{children:"document.body"}),"."]})}),c()]},l={name:"single variable",tags:["use-case"],parameters:n({description:{story:"Gets a single CSS variable value from document body when given one property name."}}),decorators:[s(),c({source:S`getCSSVariableValue('--color-gray-100')`})],render(){const[e]=a("--color-gray-100");return r.jsx(m,{appearance:"output",children:r.jsx("pre",{children:JSON.stringify([e])})})},play:async()=>{const[e]=a("--color-gray-100");await o(e).toBe("oklch(96.7% 0.003 264.542)")}},p={name:"multiple variables",tags:["use-case"],parameters:n({description:{story:"Gets multiple CSS variable values from document body."}}),decorators:[s(),c({source:S`getCSSVariableValue('--color-white', '--color-gray-100')`})],render(){const[e,t]=a("--color-white","--color-gray-100");return r.jsx(m,{appearance:"output",children:r.jsx("pre",{children:JSON.stringify([e,t])})})},play:async()=>{const[e,t]=a("--color-white","--color-gray-100");await o(e).toBe("#fff"),await o(t).toBe("oklch(96.7% 0.003 264.542)")}};function b(){const e=y.useRef(null),[t,g]=y.useState(null);return y.useEffect(()=>{e.current&&g(a(e.current,"--text-red-100"))},[]),r.jsxs(r.Fragment,{children:[r.jsx("div",{ref:e,"data-testid":"subject",style:f({"--text-red-100":"red"})}),r.jsx(m,{appearance:"output",children:r.jsx("pre",{children:t===null?"...":JSON.stringify(t)})})]})}const u={name:"from element",tags:["use-case"],parameters:n({description:{story:"Gets CSS variable values from a specific element when passed as the first argument."}}),decorators:[s(),c({source:S`const element = canvas.getByTestId('subject')
getCSSVariableValue(element, '--text-red-100')`})],render:()=>r.jsx(b,{}),play:async({canvas:e})=>{const t=e.getByTestId("subject");await o(a(t,"--text-red-100")).toEqual(["red"])}},d={name:"when variable does not exist",tags:["unit"],parameters:n({description:{story:"Returns empty string for each requested variable that is not defined."}}),decorators:[s(),c({source:S`getCSSVariableValue('--nonexistent-var')`})],render(){const[e]=a("--nonexistent-var");return r.jsx(m,{appearance:"output",children:r.jsx("pre",{children:JSON.stringify([e])})})},play:async()=>{const[e]=a("--nonexistent-var");await o(e).toBe("")}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ['source'],
...
}`,...d.parameters?.docs?.source}}};const E=["Specification","SingleVariable","MultipleVariables","FromElement","VariableDoesNotExist"];export{u as FromElement,p as MultipleVariables,l as SingleVariable,i as Specification,d as VariableDoesNotExist,E as __namedExportsOrder,j as default};
