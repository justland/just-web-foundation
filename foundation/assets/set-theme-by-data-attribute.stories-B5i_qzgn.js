import{j as e,d as y,w as g,s as p,S as b,r as c}from"./iframe-BwCvR-Rn.js";import{d as T}from"./dedent-BuYMbVyj.js";import{s as x}from"./set-theme-by-data-attribute-DXwUN9Hp.js";import{u as v}from"./use-attribute-CYkqfL2Z.js";import{B as f}from"./button-CTG5KGTe.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-DJMrXwPX.js";import"./resolve-class-name-CEwuZh68.js";const N=`import type { ThemeMap } from './theme.types.ts'
...
`,{expect:r,userEvent:o}=__STORYBOOK_MODULE_TEST__,M={title:"theme/setThemeByDataAttribute",tags:["func","version:next"],parameters:y({description:{component:"A utility that sets the theme by applying the theme's value to a data attribute on an element."}}),render:()=>e.jsx(e.Fragment,{})},h={light:"light",dark:"dark"},m="data-theme",i={tags:["use-case"],decorators:[g({content:e.jsxs("p",{children:[e.jsx("code",{children:"setThemeByDataAttribute"})," by default sets the theme on"," ",e.jsx("code",{children:"document.documentElement"}),"."]})}),p({source:T`
            ...
            `})],render:()=>{const[t]=v(m),a={light:["light","app:text-gray-100","app:bg-gray-800"],dark:["dark","app:text-gray-800","app:bg-gray-100"]};return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex gap-2",children:Object.keys(a).map(n=>e.jsx(f,{onPress:()=>{x({themes:a,theme:n,attributeName:m})},children:n},n))}),e.jsxs("span",{children:["Current theme: ",e.jsx("span",{"data-testid":"current-theme",children:t??"(none)"})]}),e.jsx(b,{title:"document.documentElement.getAttribute('data-theme')",appearance:"output",children:e.jsx("code",{children:t??"(not set)"})})]})},play:async({canvas:t,step:a})=>{await a("light",async()=>{const n=t.getByRole("button",{name:"light"});await o.click(n),await r(t.getByTestId("current-theme")).toHaveTextContent("light")}),await a("dark",async()=>{const n=t.getByRole("button",{name:"dark"});await o.click(n),await r(t.getByTestId("current-theme")).toHaveTextContent("dark")})}},l={tags:["use-case"],parameters:{...y({description:{story:"Set theme on a specific element via the element option."}})},decorators:[g({content:e.jsxs("p",{children:["The data attribute is set on the target div below instead of"," ",e.jsx("code",{children:"document.documentElement"}),"."]})}),p({source:T`setThemeByDataAttribute({
                attributeName: 'data-theme',
                element: myElement,
                themes: { light: 'light', dark: 'dark' },
                theme: ${"<value>"}
            })`})],render:()=>{const t=c.useRef(null),[a,n]=c.useState(null),[k,B]=c.useState(null),A=c.useCallback(s=>{t.current=s,n(s)},[]),[w]=v(m,a??void 0);return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex gap-2",children:Object.keys(h).map(s=>e.jsx(f,{onPress:()=>{const E=t.current;E&&(x({themes:h,theme:s,attributeName:m,element:E}),B(s))},children:s},s))}),e.jsx("div",{ref:A,className:"min-h-8 rounded border border-gray-300 p-2",children:k!==null&&e.jsxs("span",{children:["Current theme: ",e.jsx("span",{"data-testid":"current-theme",children:k})]})}),e.jsx(b,{title:"customElement.getAttribute('data-theme')",appearance:"output",children:e.jsx("code",{children:w??"(not set)"})})]})},play:async({canvas:t,step:a})=>{await a("light",async()=>{const n=t.getByRole("button",{name:"light"});await o.click(n),await r(t.getByTestId("current-theme")).toHaveTextContent("light")}),await a("dark",async()=>{const n=t.getByRole("button",{name:"dark"});await o.click(n),await r(t.getByTestId("current-theme")).toHaveTextContent("dark")})}},u={tags:["source"],parameters:y({source:{code:N}}),decorators:[p()]};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
...
}`,...u.parameters?.docs?.source}}};const O=["BasicUsage","WithThemeArray","WithCustomElement","Source"];export{i as BasicUsage,u as Source,l as WithCustomElement,d as WithThemeArray,O as __namedExportsOrder,M as default};
