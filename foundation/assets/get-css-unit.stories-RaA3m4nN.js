import{j as t,d as i,w as o,s as u,S as p}from"./iframe-CWQnDVRD.js";import{d as c}from"./dedent-BuYMbVyj.js";import{g as e}from"./get-css-unit-DteVD2Hc.js";import"./preload-helper-PPVm8Dsz.js";import"./parse-css-value-DyiR79PK.js";const g=`import { parseCssValue } from './parse-css-value.ts'
...
getCssUnit(undefined) → ${e(void 0)}`})})},play:async()=>{await n(e(null)).toBe(null),await n(e(void 0)).toBe(void 0)}},a={tags:["source"],parameters:i({source:{code:g}}),decorators:[u()]};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  tags: ['use-case'],
