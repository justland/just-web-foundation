import{r as o,j as t,d as l,w as S,s as g,S as d}from"./iframe-BjeGB4gq.js";import{d as f}from"./dedent-BuYMbVyj.js";import{o as b}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as B}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as K}from"./theme-entry-D4S_RAMB.js";import{l as C}from"./local-storage-theme-store-BtAeD3BK.js";import{B as h}from"./button-CQx9rulV.js";import"./preload-helper-PPVm8Dsz.js";import"./dummy-theme-store-DcCfgetv.js";import"./write-local-storage-DiwOWV9e.js";import"./write-web-storage-55ynkFOs.js";import"./parse-stored-theme-Dsx2RsUi.js";import"./resolve-theme-map-value-CsrxdXA7.js";import"./resolve-class-name-B8ntG9L-.js";function k(e,r){const{storageKey:y,defaultTheme:i}=r,a=o.useMemo(()=>C(e,{storageKey:y}),[e,y]),[v,w]=o.useState(()=>a.read()?.theme??i);o.useEffect(()=>b([a],i,w),[a,i]);const E=o.useCallback(T=>{B([a],K(e,T))},[a,e]);return[v,E]}const j=`import { useCallback, useEffect, useMemo, useState } from 'react'
