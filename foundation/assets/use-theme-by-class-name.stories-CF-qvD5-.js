import{r as m,j as t,d as c,w as f,s as g,S as y}from"./iframe-B5WlOR2G.js";import{d as v}from"./dedent-BuYMbVyj.js";import{o as E}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as C}from"./set-theme-to-stores-C1AbMsOJ.js";import{c as B,r as N}from"./class-name-theme-store-Dfg_JKgY.js";import{t as j}from"./theme-entry-D4S_RAMB.js";import{B as l}from"./button-CsZyzj2i.js";import"./preload-helper-PPVm8Dsz.js";import"./observe-attribute-DJMrXwPX.js";import"./dummy-theme-store-DcCfgetv.js";import"./findKey-D_Zca1Sl.js";import"./resolve-class-name-Bomprtp8.js";function k(e,s){const a=s?.element??(typeof document<"u"?document.documentElement:void 0),n=s?.defaultTheme,h=m.useMemo(()=>B(e,{element:a}),[a,e]),[x,w]=m.useState(()=>a?N(e,a.className)??n:n);m.useEffect(()=>a?E([h],n,w):void 0,[a,h,n]);const b=m.useCallback(T=>{a&&C([h],j(e,T))},[a,h,e]);return[x,b]}const H=`import { useCallback, useEffect, useMemo, useState } from 'react'
