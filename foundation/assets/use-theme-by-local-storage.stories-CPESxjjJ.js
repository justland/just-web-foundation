import{r as o,j as t,d as l,w as S,s as g,S as d}from"./iframe-D_6mvhRd.js";import{d as f}from"./dedent-BuYMbVyj.js";import{o as b}from"./observe-theme-from-stores-D5IPs1nT.js";import{s as B}from"./set-theme-to-stores-C1AbMsOJ.js";import{t as K}from"./theme-entry-D4S_RAMB.js";import{l as C}from"./local-storage-theme-store-rbrBwh0T.js";import{B as h}from"./button-BvxDy0Ld.js";import"./preload-helper-PPVm8Dsz.js";import"./resolve-theme-map-value-6BKppRxh.js";import"./parse-stored-theme-CqNOdFO7.js";import"./resolve-class-name-1fsVhyj2.js";function k(e,r){const{storageKey:y,defaultTheme:i}=r,a=o.useMemo(()=>C(e,{storageKey:y}),[e,y]),[v,w]=o.useState(()=>a.read()?.theme??i);o.useEffect(()=>b([a],i,w),[a,i]);const E=o.useCallback(T=>{B([a],K(e,T))},[a,e]);return[v,E]}const j=`import { useCallback, useEffect, useMemo, useState } from 'react'
